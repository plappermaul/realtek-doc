...
{
       puts(CAMEO_SHOW_BOOT_PROCEDURE);
#ifdef CONFIG_INTERRUPT_SUPPORT
	...
	CAMEO_SIMPLE_DISPLAY_PRINTF(("Loading %dB env. variables from offset 0x%x\n",
...
#if defined(CONFIG_CMD_NET)
#ifndef CAMEO_SIMPLE_DISPLAY_PRINTF
	puts("Net:   ");
#endif
