...
#define CONFIG_ENV_OFFSET     flash_partition_addr_ret(FLASH_INDEX_LOADER_ENV)
#define CONFIG_ENV_SIZE       UNIT_SIZE     /* size of environment */
#define CONFIG_ENV2_OFFSET    flash_partition_addr_ret(FLASH_INDEX_LOADER_ENV2)
#define CONFIG_ENV_SECT_SIZE  UNIT_SIZE     /* size of one complete sector */
#endif
...
#ifdef CONFIG_RTK_USB_EHCI_HCD
#define CONFIG_CMD_USB 			    1
#define CONFIG_USB_EHCI			    1
#define CONFIG_USB_EHCI_RTL9300 	1
