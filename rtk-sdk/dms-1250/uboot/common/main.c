...
#define RTK_ABOUT_AUTOBOOT_CHAR     0x0E/* key to abort the auto boot process, 0x20 - space, 0x1B - ESC, 0x0E - CTRL+N */
...
#else
	CAMEO_SIMPLE_DISPLAY_PRINTF(("Hit CTRL+N key to stop autoboot: %2d ", bootdelay));
#endif
...
# endif
		...
		CAMEO_SIMPLE_DISPLAY_PRINTF(("\b\b\b%2d ", bootdelay));
	}
