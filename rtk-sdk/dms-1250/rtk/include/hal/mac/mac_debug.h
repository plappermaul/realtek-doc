...
/* private statistic encap counter */
typedef struct rtk_dbg_encap_cntr_s
{
    uint32 encapOpenFlow;
    uint32 encapEACL;
    uint32 encapEVC;
    uint32 encapTTL;
} rtk_dbg_encap_cntr_t;
 ...
 *      RT_ERR_UNIT_ID - invalid unit id
 */
extern int32 hal_getDbgEncapCntr(uint32 unit, rtk_dbg_encap_cntr_t *pEncapCntr);
#endif
