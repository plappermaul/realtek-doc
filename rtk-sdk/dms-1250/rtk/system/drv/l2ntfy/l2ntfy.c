...
#define L2NTFY_TOP_SEM_LOCK(unit)           osal_isr_disable_interrupt()
#define L2NTFY_TOP_SEM_UNLOCK(unit)         osal_isr_enable_interrupt()
...
void _l2ntfy_runoutHandle_bhWQ(osal_work_struct_arg_t *data)
{
    ...
    osal_list_for_each_entry_safe(pEntry, n, &runOutListHead.list, list)
    {
        ...
        L2NTFY_TOP_SEM_LOCK(pEntry->unit);
        osal_list_del(&pEntry->list);
        L2NTFY_TOP_SEM_UNLOCK(pEntry->unit);
