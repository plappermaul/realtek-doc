...
void __init prom_mem_zone2(void){
    ...
    {
        BSP_REG32(RTL9300_O0DOR2) = RTL9300_ZONE2_OFF;
        BSP_REG32(RTL9300_O0DMAR2) = RTL9300_ZONE2_MAX;    //1G
        __sync();
        bsp_zone2_phy = RTL9300_ZONE2_PHY;
        bsp_zone2_base = RTL9300_ZONE2_BASE;
        PROM_DEBUG_PRINT("mem zone2: OFF=0x%x,MAX=0x%x\n",BSP_REG32(RTL9300_O0DOR2) ,  BSP_REG32(RTL9300_O0DMAR2));
    }
...
void __init prom_sram_disable(void){
    if(bsp_chip_family_id == RTL9300_FAMILY_ID)
    {
        BSP_REG32(RTL9300_UMSAR0) = 0;
        BSP_REG32(RTL9300_UMSAR1) = 0;
        BSP_REG32(RTL9300_UMSAR2) = 0;
        BSP_REG32(RTL9300_UMSAR3) = 0;
        BSP_REG32(RTL9300_SRAMSAR0) = 0;
        BSP_REG32(RTL9300_SRAMSAR1) = 0;
        BSP_REG32(RTL9300_SRAMSAR2) = 0;
        BSP_REG32(RTL9300_SRAMSAR3) = 0;
    }
}
#endif
