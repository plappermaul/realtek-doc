...
--- | --- | --- | --- | ---
**Page** | **Register** | **Bits** | **INER** |  **Interrupt enable register**
0xa42 | 0x12 | 04:04 | LINK_CHANGE_INT
...
**Page** | **Register** | **Bits** | **SDS Indirect** | **SerDes Indirect Access**
0xa43 | 0x1B | 15:00 | PATCH_ADDRESS | patch step 3, 5, 7, .. write address
0xa43 | 0x1C | 15:00 | PATCH_VALUE | patch step 4, 6, 8, ... read/write value
**Page** | **Register** | **Bits** | **PHYCR3** | **PHY specific control register 3**
0xa44 | 0x11 | 09:09 | RETRY_DOWN_SPEED_500
0xa44 | 0x11 | 05:05 | THR_RETRY_SPDN | 0 = 7 times, 1 = 3 times
0xa44 | 0x11 | 03:03 | EN_RETRY_SPEED_DOW
0xa44 | 0x11 | 02:02 | 2PAIR_AUTO_DOWNSPEED
**Page** | **Register** | **Bits** | **unknown** | 
0xb80 | 0x10 | 04:04 | PATCH_READY | patch step 2: wait until SerDEs acces ready (=1), go over to 0xa43:0x1b
**Page** | **Register** | **Bits** | **unknown** | 
0xb82 | 0x10 | 04:04 | ENABLE_PATCH | patch step 1: set to 1 to gain SerDEs access, go over to 0xb80:0x10
...
Page | Register | Bits | Feature | Documentation
--- | --- | --- | --- | ---
**Page** | **Register** | **Bits** | **Unknown Fiber** | **Absolute 0x1303**
0x260 | 0x13 | 12:08 | PHY_ADDRESS | Start PHY address. Do not modified it!
...
**Page** | **Register** | **Bits** | **MAC SerDes 0 - register unknown** | **Absolute 0x2060**
0x40c | 0x11 | 15:15 | RING_PLL_EN | ring PLL 0 = disable, 1 = enable
...
**Page** | **Register** | **Bits** | **MAC SerDes 1 - register unknown** | **Absolute 0x2161**
0x42c | 0x11 | 15:15 | RING_PLL_EN | ring PLL 0 = disable, 1 = enable
...
**Page** | **Register** | **Bits** | **Unknown SerDes - page unknown** | **Absolute 0x2269**
0x44d | 0x11 | 15:00 | | 
**Page** | **Register** | **Bits** | **Unknown SerDes - page unknown** | **Absolute 0x2271**
...
0x464 | 0x12 | 07:00 | EQ_IN
**Page** | **Register** | **Bits** | **Analog register** | **Absolute 0x2323**
0x464 | 0x13 | 15:15 | RX_EQ_BOOST_DC
0x464 | 0x13 | 14:10 | FILTER_OUT3
0x464 | 0x13 | 09:05 | FILTER_OUT2
0x464 | 0x13 | 04:00 | FILTER_OUT1
**Page** | **Register** | **Bits** | **Analog register** | **Absolute 0x2325**
0x464 | 0x15 | 15:15 | S0_REG_CLKLA_EN
0x464 | 0x15 | 14:13 | S0_REG_RSEL
0x464 | 0x15 | 12:10 | S0_REG_KI
0x464 | 0x15 | 09:09 | S0_REG_KD
0x464 | 0x15 | 08:06 | S0_REG_KP2
0x464 | 0x15 | 05:04 | S0_REG_KP1
0x464 | 0x15 | 03:00 | S0_REG_KP1_1
