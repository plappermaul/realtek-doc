...
#ifndef __DAL_RT_CA8279_GPON_H__
#define __DAL_RT_CA8279_GPON_H__
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_init(void);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_serialNumber_set(rt_gpon_serialNumber_t *pSN);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_registrationId_set(rt_gpon_registrationId_t *pRegId);
 ...
 */
extern int32 dal_rt_ca8279_gpon_activate(rt_gpon_initialState_t initState);
...
*/
extern int32 dal_rt_ca8279_gpon_deactivate(void);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_onuState_get(rt_gpon_onuState_t  *pOnuState);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_omci_tx(uint32 msgLen, uint8 *pMsg);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_omci_rx_callback_register(rt_gpon_omci_rx_callback omciRx);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_tcont_set(uint32 *pTcontId, uint32 allocId);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_tcont_get(uint32 tcontId, uint32 *pAllocId);
 ...
 * Note:
 */
extern int dal_rt_ca8279_gpon_tcont_del(uint32 tcontId);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_usFlow_set(uint32 usFlowId, const rt_gpon_usFlow_t *pUsFlow);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_usFlow_get(uint32 usFlowId, rt_gpon_usFlow_t *pUsFlow);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_usFlow_del(uint32 usFlowId);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_usFlow_delAll(void);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_dsFlow_set(uint32 dsFlowId, const rt_gpon_dsFlow_t *pDsFlow);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_dsFlow_get(uint32 dsFlowId, rt_gpon_dsFlow_t *pDsFlow);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_dsFlow_del(uint32 dsFlowId);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_dsFlow_delAll(void);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_ponQueue_set(
    uint32 tcontId, 
    uint32 tcQueueId,  
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_ponQueue_del(    
    uint32 tcontId, 
    uint32 tcQueueId);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_scheInfo_get(rt_gpon_schedule_info_t *pScheInfo);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_flowCounter_get(uint32 flowId, rt_gpon_flow_counter_type_t flowCntType, rt_gpon_flow_counter_t *pFlowCnt);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_pmCounter_get(rt_gpon_pm_type_t pmCntType, rt_gpon_pm_counter_t *pPmCnt);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_ponTag_get(rt_gpon_ponTag_t *pPonTag);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_msk_set(rt_gpon_msk_t *pMsk);
 ...
 * Note:
 */
extern int32 dal_rt_ca8279_gpon_mcKey_set(rt_gpon_mc_key_t *pMcKey);
...
/* Function Name:
 *      dal_rt_ca8279_gpon_omci_mirror_set
 * Description:
...
#endif /* __DAL_RT_CA8279_GPON_H__ */
