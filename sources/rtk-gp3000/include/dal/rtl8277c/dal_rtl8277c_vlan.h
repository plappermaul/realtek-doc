 ...
 *
 */
#ifndef __DAL_RTL8277C_VLAN_H__
#define __DAL_RTL8277C_VLAN_H__
 ...
 * Symbol Definition
 */
#define DAL_RTL8277C_DEFAULT_VLAN_ID  (1)
 ...
 */
extern int32
dal_rtl8277c_vlan_create(rtk_vlan_t vid);

/* Function Name:
 *      dal_rtl8277c_vlan_destroy
 * Description:
 *      Destroy the vlan.
 * Input:
 ...
 */
extern int32
dal_rtl8277c_vlan_destroy(rtk_vlan_t vid);


/* Function Name:
 *      dal_rtl8277c_vlan_destroyAll
 * Description:
 ...
 */
extern int32
dal_rtl8277c_vlan_destroyAll(uint32 restoreDefaultVlan);

/* Module Name    : Vlan                               */
/* Sub-module Name: Port based and protocol based vlan */

/* Function Name:
 *      dal_rtl8277c_vlan_portPvid_get
 * Description:
 ...
 */
extern int32
dal_rtl8277c_vlan_portPvid_get(rtk_port_t port, uint32 *pPvid);


/* Function Name:
 *      dal_rtl8277c_vlan_portPvid_set
 * Description:
 ...
 */
extern int32
dal_rtl8277c_vlan_portPvid_set(rtk_port_t port, uint32 pvid);


/* Function Name:
 *      dal_rtl8277c_vlan_port_get
 * Description:
 ...
 */
extern int32
dal_rtl8277c_vlan_port_get(rtk_vlan_t vid,rtk_portmask_t *pMemberPortmask,rtk_portmask_t *pUntagPortmask);


/* Function Name:
 *      dal_rtl8277c_vlan_port_set
 * Description:
 ...
 */
extern int32
dal_rtl8277c_vlan_port_set(rtk_vlan_t vid,rtk_portmask_t *pMember_portmask,rtk_portmask_t *pUntag_portmask);

/* Function Name:
 *      dal_rtl8277c_vlan_vlanFunctionEnable_get
 * Description:
 ...
 */
extern int32
dal_rtl8277c_vlan_vlanFunctionEnable_get(rtk_enable_t *pEnable);


/* Function Name:
 *      dal_rtl8277c_vlan_vlanFunctionEnable_set
 * Description:
 ...
 */
extern int32
dal_rtl8277c_vlan_vlanFunctionEnable_set(rtk_enable_t enable);

/* Function Name:
 *      dal_rtl8277c_vlan_fidMode_get
 * Description:
 ...
 */
extern int32
dal_rtl8277c_vlan_fidMode_get(rtk_vlan_t vid, rtk_fidMode_t *pMode);

/* Function Name:
 *      dal_rtl8277c_vlan_fidMode_set
 * Description:
 ...
 */
extern int32
dal_rtl8277c_vlan_fidMode_set(rtk_vlan_t vid, rtk_fidMode_t mode);

#endif /* __DAL_RTL8277C_VLAN_H__ */