...
#ifndef __DAL_RTL9607F_TIME_H__
#define __DAL_RTL9607F_TIME_H__
...
#define RTL9607F_TIME_SEC_MAX 0xFFFFFFFFFFFF
#define RTL9607F_TIME_NSEC_MAX 0x3B9ACA00 //1000000000 ns=1 s
#define RTL9607F_TIME_FREQUENCY_MAX 0xFFFFFFFF
 ...
 */
extern int32
dal_rtl9607f_rt_time_offsetTime_set(uint32 sign, rt_time_timeStamp_t timeStamp);
 ...
 *      RT_ERR_FAILED
 * Note:
 *      rt_time_ptp_rx_callback)(uint32 msgLen,uint8 *pMsg, rt_time_timeStamp_t *pTimeStamp), pTimeStamp is recording timestamp
 */
extern int32
