...
extern int32 dal_rt_rtl9607f_cls_extend_rule_add(rt_cls_extend_rule_t *pClsRule);
...
extern int32 dal_rt_rtl9607f_cls_extend_rule_delete(uint32 ruleIndex);
 ...
 *      None.
 */
extern int32 dal_rt_rtl9607f_cls_extend_rule_get(uint32 index, rt_cls_extend_rule_t *pClsRule);
...
extern int32 dal_rt_rtl9607f_cls_vlan_paser_set(rt_port_t port, rt_cls_vlan_attribute_t type, uint32 data);
...
extern int32 dal_rt_rtl9607f_cls_vlan_paser_get(rt_port_t port, rt_cls_vlan_attribute_t type, uint32 *pData);
