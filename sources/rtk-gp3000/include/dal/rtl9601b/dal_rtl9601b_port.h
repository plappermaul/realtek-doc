...
/* Function Name:
 *      dal_rtl9601b_port_phyPowerDown_get
 * Description:
 ...
 */
extern int32
dal_rtl9601b_port_phyPowerDown_get(rtk_port_t port, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl9601b_port_phyPowerDown_set
 * Description:
 ...
 */
extern int32
dal_rtl9601b_port_phyPowerDown_set(rtk_port_t port, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl9601b_port_phyPowerDown_tryset
 * Description:
 ...
 */
extern int32
dal_rtl9601b_port_phyPowerDown_tryset(rtk_port_t port, rtk_enable_t enable);
 ...
 * Note:
 */
extern int32 rtl9601b_raw_port_forceDmp_set(rtk_enable_t state);
 ...
 * Note:
 */
extern int32 rtl9601b_raw_port_forceDmp_get(rtk_enable_t *pState);
 ...
 * Note:
 */
extern int32 rtl9601b_raw_port_forceDmpMask_set(rtk_port_t port, rtk_portmask_t mask);
 ...
 * Note:
 */
extern int32 rtl9601b_raw_port_forceDmpMask_get(rtk_port_t port, rtk_portmask_t  *pMask);
