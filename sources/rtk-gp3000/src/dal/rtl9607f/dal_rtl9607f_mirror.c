...
dal_rtl9607f_mirror_init(void)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9607f_mirror_init */

/* Function Name:
 *      dal_rtl9607f_mirror_portBased_get
 * Description:
 ...
 */
int32
dal_rtl9607f_mirror_portBased_get(rtk_port_t *pMirroringPort, rtk_portmask_t *pMirroredRxPortmask, rtk_portmask_t *pMirroredTxPortmask)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_MIRROR),"%s",__FUNCTION__);
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9607f_mirror_portBased_get */

/* Function Name:
 *      dal_rtl9607f_mirror_portBased_set
 * Description:
 ...
 */
int32
dal_rtl9607f_mirror_portBased_set(rtk_port_t mirroringPort, rtk_portmask_t *pMirroredRxPortmask, rtk_portmask_t *pMirroredTxPortmask)
{
    ca_status_t ret = CA_E_OK;
    aal_mire_mir_rule_mask_t rule_mask;
    aal_mire_mir_rule_t mire_rule;
...
err: //disable all mirror rules
    ...
    return RT_ERR_FAILED;
} /* end of dal_rtl9607f_mirror_portBased_set */
