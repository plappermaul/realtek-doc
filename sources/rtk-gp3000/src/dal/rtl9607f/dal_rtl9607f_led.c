...
static rtk_led_force_mode_t g_led_modeForce[RTL9607F_LED_INDEX_MAX] =	{LED_FORCE_OFF, LED_FORCE_OFF, LED_FORCE_OFF, LED_FORCE_OFF,
...
dal_rtl9607f_led_init(void)
{
    ...
    for(ledIdx=0;ledIdx<RTL9607F_LED_INDEX_MAX;ledIdx++)
    {
        g_led_modeForce[ledIdx] = LED_FORCE_OFF;
    }

    return RT_ERR_OK;
} /* end of dal_rtl9607f_led_init */


/* Function Name:
 *      dal_rtl9607f_led_blinkRate_get
 * Description:
 ...
 */
int32 
dal_rtl9607f_led_blinkRate_get(rtk_led_blinkGroup_t group, rtk_led_blink_rate_t *pBlinkRate)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_LED),"%s",__FUNCTION__);
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9607f_led_blinkRate_get */

/* Function Name:
 *      dal_rtl9607f_led_blinkRate_set
 * Description:
 *      Get LED blinking rate
 * Input:
 *      group      - led blinking group
 ...
 */
int32 
dal_rtl9607f_led_blinkRate_set(rtk_led_blinkGroup_t group, rtk_led_blink_rate_t blinkRate)
{
    int32 ledIdx;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9607f_led_blinkRate_set */

/* Function Name:
 *      dal_rtl9607f_led_modeForce_get
 * Description:
 ...
 */
int32
dal_rtl9607f_led_modeForce_get(uint32 ledIdx, rtk_led_force_mode_t *pMode)
{    
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_LED),"%s",__FUNCTION__);
    ...
    /* parameter check */
    RT_PARAM_CHK((RTL9607F_LED_INDEX_MAX < ledIdx), RT_ERR_INPUT);
    ...
    *pMode = g_led_modeForce[ledIdx];
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9607f_led_modeForce_get */

/* Function Name:
 *      dal_rtl9607f_led_modeForce_set
 * Description:
 ...
 */
int32
dal_rtl9607f_led_modeForce_set(uint32 ledIdx, rtk_led_force_mode_t mode)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl9607f_led_modeForce_set */
