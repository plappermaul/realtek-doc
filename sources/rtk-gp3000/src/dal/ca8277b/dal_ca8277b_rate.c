...
dal_ca8277b_rate_portIgrBandwidthCtrlRate_set(rtk_port_t port, uint32 rate)
{
    ...
    policer.cbs = (policer.cir/1000 + 511) >> 9;
        ...
        if (1000 <= policer.cir && policer.cir < 10000) 
            policer.cbs = (policer.cir/1000) * 30;
        
        if (10000 <= policer.cir && policer.cir < 100000)
            policer.cbs = 10000/1000 * 30;
        
        if (100000 <= policer.cir && policer.cir < 1000000)
            policer.cbs = 100000/1000 * 30;

        if (1000000 <= policer.cir)
            policer.cbs = 0xFFF;    
    #endif
