...
dal_ca8277b_gpio_state_set ( uint32 gpioId, rtk_enable_t enable )
{
    ...
    /* parameter check */
    RT_PARAM_CHK((CA8277B_GPIO_PIN_NUM <= gpioId), RT_ERR_INPUT);
...
//    CA_NE_REG_WRITE(value,GLOBAL_GPIO_MUX_0+0x4*groupId);
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8277b_gpio_state_set */
...
//    value = CA_NE_REG_READ(GLOBAL_GPIO_MUX_0+0x4*groupId);
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8277b_gpio_state_get */
...
//    CA_NE_REG_WRITE(value,PER_GPIO0_CFG+0x24*groupId);
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8277b_gpio_mode_set */
...
//    value = CA_NE_REG_READ(PER_GPIO0_CFG+0x24*groupId);
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8277b_gpio_mode_get */
...
dal_ca8277b_gpio_databit_get ( uint32 gpioId, uint32* data )
{
    ...
    /* function body */
    if((ret = dal_ca8277b_gpio_mode_get(gpioId,&mode))!=CA_E_OK)
    {
...
//        value = CA_NE_REG_READ(PER_GPIO0_OUT+0x24*groupId);
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8277b_gpio_databit_get */
...
//        value = CA_NE_REG_READ(PER_GPIO0_IN+0x24*groupId);
        ...
        if(data == 1)
            ...
            value &= ~tmp;
//        CA_NE_REG_WRITE(value,PER_GPIO0_IN+0x24*groupId);
        writel(value,venus_per_gpio_iobase);
...
//        CA_NE_REG_WRITE(value,PER_GPIO0_OUT+0x24*groupId);
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8277b_gpio_databit_set */
