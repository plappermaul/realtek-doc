...
dal_ca8279_l2_init(void)
{
    ...
    if((ret = dal_ca8279_l2_aging_set(RTK_L2_DEFAULT_AGING_TIME)) != RT_ERR_OK)
    {
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_init */


/* Function Name:
 *      dal_ca8279_l2_flushLinkDownPortAddrEnable_get
 * Description:
 ...
 */
int32
dal_ca8279_l2_flushLinkDownPortAddrEnable_get(rtk_enable_t *pEnable)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_L2),"%s",__FUNCTION__);
    ...
    *pEnable = LUNA_G3_L2_FLUSH_INTR;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_flushLinkDownPortAddrEnable_get */


/* Function Name:
 *      dal_ca8279_l2_flushLinkDownPortAddrEnable_set
 * Description:
 ...
 */
int32
dal_ca8279_l2_flushLinkDownPortAddrEnable_set(rtk_enable_t enable)
{
    ca_status_t ret=CA_E_OK;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_flushLinkDownPortAddrEnable_set */

/* Function Name:
 *      dal_ca8279_l2_portLimitLearningCnt_get
 * Description:
 ...
 */
int32
dal_ca8279_l2_portLimitLearningCnt_get(rtk_port_t port, uint32 *pMacCnt)
{
    ca_status_t ret=CA_E_OK;
    ...
    *pMacCnt = number;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_portLimitLearningCnt_get */


/* Function Name:
 *      dal_ca8279_l2_portLimitLearningCnt_set
 * Description:
 ...
 */
int32
dal_ca8279_l2_portLimitLearningCnt_set(rtk_port_t port, uint32 macCnt)
{
    ca_status_t ret=CA_E_OK;
    ca_l2_mac_limit_type_t type;
    ca_port_id_t port_id;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_portLimitLearningCnt_set */

/* Function Name:
 *      dal_ca8279_l2_portLimitLearningCntAction_get
 * Description:
 ...
 */
int32
dal_ca8279_l2_portLimitLearningCntAction_get(rtk_port_t port, rtk_l2_limitLearnCntAction_t *pLearningAction)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_portLimitLearningCntAction_get */


/* Function Name:
 *      dal_ca8279_l2_portLimitLearningCntAction_set
 * Description:
 ...
 */
int32
dal_ca8279_l2_portLimitLearningCntAction_set(rtk_port_t port, rtk_l2_limitLearnCntAction_t learningAction)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ca_l2_learning_control_t control;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_portLimitLearningCntAction_set */

/* Function Name:
 *      da_ca8279_l2_aging_get
 * Description:
 ...
 */
int32
dal_ca8279_l2_aging_get(uint32 *pAgingTime)
{
    ca_status_t ret=CA_E_OK;
    ca_uint32_t time=0;
    ...
    *pAgingTime=time;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_aging_get */


/* Function Name:
 *      dal_ca8279_l2_aging_set
 * Description:
 ...
 */
int32
dal_ca8279_l2_aging_set(uint32 agingTime)
{
    ca_status_t ret=CA_E_OK;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_aging_set */

/* Function Name:
 *      dal_ca8279_l2_portAgingEnable_get
 * Description:
 ...
 */
int32
dal_ca8279_l2_portAgingEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ca_status_t ret=CA_E_OK;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_portAgingEnable_get */

/* Function Name:
 *      dal_ca8279_l2_portAgingEnable_set
 * Description:
 ...
 */
int32
dal_ca8279_l2_portAgingEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    ca_status_t ret=CA_E_OK;
    ca_l2_learning_mode_t mode;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_portAgingEnable_set */

/* Module Name    : L2      */
/* Sub-module Name: Parameter for lookup miss */
/* Function Name:
 *      dal_ca8279_l2_lookupMissAction_get
 * Description:
 ...
 */
int32
dal_ca8279_l2_lookupMissAction_get(rtk_l2_lookupMissType_t type, rtk_action_t *pAction)
{
    int32 ret;
    ...
    if((ret = dal_ca8279_l2_portLookupMissAction_get(0, type, pAction)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_L2 | MOD_DAL), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_lookupMissAction_get */

/* Function Name:
 *      dal_ca8279_l2_lookupMissAction_set
 * Description:
 ...
 */
int32
dal_ca8279_l2_lookupMissAction_set(rtk_l2_lookupMissType_t type, rtk_action_t action)
{
    int32 ret;
    rtk_port_t port;
    ...
    {
        if ((ret = dal_ca8279_l2_portLookupMissAction_set(port, type, action)) != RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_L2|MOD_DAL), "");
            return ret;
        }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_lookupMissAction_set */

/* Function Name:
 *      dal_ca8279_l2_portLookupMissAction_get
 * Description:
 ...
 */
int32
dal_ca8279_l2_portLookupMissAction_get(rtk_port_t port, rtk_l2_lookupMissType_t type, rtk_action_t *pAction)
{
    ca_status_t ret=CA_E_OK;
    ca_uint16_t lspid;
...
} /* end of dal_ca8279_l2_portLookupMissAction_get */

/* Function Name:
 *      dal_ca8279_l2_portLookupMissAction_set
 * Description:
 ...
 */
int32
dal_ca8279_l2_portLookupMissAction_set(rtk_port_t port, rtk_l2_lookupMissType_t type, rtk_action_t action)
{
    ca_status_t ret=CA_E_OK;
    ca_uint16_t lspid;
    aal_ple_nonkwn_type_t ca_type;
...
} /* end of dal_ca8279_l2_portLookupMissAction_set */

/* Function Name:
 *      dal_ca8279_l2_nextValidAddr_get
 * Description:
...
/* Function Name:
 *      dal_ca8279_l2_nextValidAddrOnPort_get
 * Description:
    ...
    rtk_l2_ucastAddr_t  *pL2UcastData)
{
    ...
    *pScanIdx= ((uint32)ca_entry.prev_handle )-1;//hit entry
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_nextValidAddrOnPort_get */

/* Function Name:
 *      dal_ca8279_l2_nextValidEntry_get
 * Description:
        ...
        rtk_l2_addr_table_t     *pL2Entry)
{
    ...
    *pScanIdx= ((uint32)ca_entry.prev_handle )-1;//hit entry
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_nextValidEntry_get */

/* Function Name:
 *      dal_ca8279_l2_addr_add
 * Description:
 ...
 */
int32
dal_ca8279_l2_addr_add(rtk_l2_ucastAddr_t *pL2Addr)
{
    ca_status_t ret=CA_E_OK;
    ca_uint32_t time=0;
    ca_l2_addr_entry_t addr;
    ...
    if(ret = aal_fdb_entry_offset_get(0,addr.mac_addr,addr.vid,&offset))
    {
    ...
    pL2Addr->index = offset;

    return RT_ERR_OK;
} /* end of dal_ca8279_l2_addr_add */

/* Function Name:
 *      dal_ca8279_l2_addr_del
 * Description:
 ...
 */
int32
dal_ca8279_l2_addr_del(rtk_l2_ucastAddr_t *pL2Addr)
{
    ca_status_t ret=CA_E_OK;
    ca_mac_addr_t mac;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_addr_del */


/* Function Name:
 *      dal_ca8279_l2_addr_get
 * Description:
 ...
 */
int32
dal_ca8279_l2_addr_get(rtk_l2_ucastAddr_t *pL2Addr)
{
    ca_status_t ret=CA_E_OK;
    ca_mac_addr_t mac;
    ca_vlan_id_t key_vid;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_addr_get */


/* Function Name:
 *      dal_ca8279_l2_addr_delAll
 * Description:
 ...
 */
int32
dal_ca8279_l2_addr_delAll(uint32 includeStatic)
{
    ca_status_t ret=CA_E_OK;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_addr_delAll */

/* Module Name    : L2        */
/* Sub-module Name: Port move */
/* Function Name:
 *      dal_ca8279_l2_illegalPortMoveAction_get
 * Description:
    ...
    rtk_action_t        *pFwdAction)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_illegalPortMoveAction_get */

/* Function Name:
 *      dal_ca8279_l2_illegalPortMoveAction_set
 * Description:
    ...
    rtk_action_t        fwdAction)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_l2_illegalPortMoveAction_set */
