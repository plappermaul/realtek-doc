...
#define DAL_CA8279_VLAN_SET(vid) \
do {\
    if ((vid) <= RTK_VLAN_ID_MAX) {vlan_valid[vid >> 5] |= (1 << (vid&31));}\
} while (0);\

#define DAL_CA8279_VLAN_CLEAR(vid) \
do {\
    if ((vid) <= RTK_VLAN_ID_MAX) {vlan_valid[vid >> 5] &= (~(1 << (vid&31)));}\
} while (0);\

#define DAL_CA8279_VLAN_IS_SET(vid) \
...
dal_ca8279_vlan_init(void)
{
    ...
    if((ret = dal_ca8279_vlan_vlanFunctionEnable_set(ENABLED)) != RT_ERR_OK)
    {
    ...
    /* Create Default VLAN */
    if((ret = dal_ca8279_vlan_destroyAll(ENABLED)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_VLAN | MOD_DAL), "");
        vlan_init = INIT_NOT_COMPLETED;
        return ret;
 ...
 */
int32
dal_ca8279_vlan_create(rtk_vlan_t vid)
{
    ...
    if(VLAN_FUNC_ENABLE == ENABLED)
    {
        ...
        DAL_CA8279_VLAN_SET(vid)

        RTK_PORTMASK_RESET(Member_portmask);
        RTK_PORTMASK_RESET(Untag_portmask);
        if((ret = dal_ca8279_vlan_port_set(vid,&Member_portmask,&Untag_portmask))!=RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL|MOD_VLAN), "");
            return RT_ERR_FAILED;
        }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_create */

/* Function Name:
 *      dal_ca8279_vlan_destroy
 * Description:
 *      Destroy the vlan.
 * Input:
 ...
 */
int32
dal_ca8279_vlan_destroy(rtk_vlan_t vid)
{
    ca_status_t ret=CA_E_OK;
    ...
    if(VLAN_FUNC_ENABLE == ENABLED)
    {
        ...
        DAL_CA8279_VLAN_CLEAR(vid);
    }
    
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_destroy */


/* Function Name:
 *      dal_ca8279_vlan_destroyAll
 * Description:
 ...
 */
int32
dal_ca8279_vlan_destroyAll(uint32 restoreDefaultVlan)
{
    ca_status_t ret=CA_E_OK;
    ...
    {    
        ...
        {
            /* Create Default VLAN */
            if((ret = dal_ca8279_vlan_create(DAL_CA8279_DEFAULT_VLAN_ID)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_VLAN | MOD_DAL), "");
                return ret;
            }

            DAL_CA8279_VLAN_SET(DAL_CA8279_DEFAULT_VLAN_ID)
            ...
            if((ret = dal_ca8279_vlan_port_set(DAL_CA8279_DEFAULT_VLAN_ID,&Member_portmask,&Untag_portmask))!=RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_VLAN), "");
                return ret;
            }
            ...
            {
                if((ret = dal_ca8279_vlan_portPvid_set(port, DAL_CA8279_DEFAULT_VLAN_ID)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_VLAN | MOD_DAL), "");
                    return ret;
                }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_destroyAll */

/* Module Name    : Vlan                               */
/* Sub-module Name: Port based and protocol based vlan */

/* Function Name:
 *      dal_ca8279_vlan_portPvid_get
 * Description:
 ...
 */
int32
dal_ca8279_vlan_portPvid_get(rtk_port_t port, uint32 *pPvid)
{
    ca_status_t ret=CA_E_OK;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_portPvid_get */


/* Function Name:
 *      dal_ca8279_vlan_portPvid_set
 * Description:
 ...
 */
int32
dal_ca8279_vlan_portPvid_set(rtk_port_t port, uint32 pvid)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ...
    if(VLAN_FUNC_ENABLE == ENABLED)
    {
        RT_PARAM_CHK((!DAL_CA8279_VLAN_IS_SET(pvid)), RT_ERR_VLAN_ENTRY_NOT_FOUND);    
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_portPvid_set */

/* Function Name:
 *      dal_ca8279_vlan_port_get
 * Description:
    ...
    rtk_portmask_t *pUntagPortmask)
{
    ...
    if(VLAN_FUNC_ENABLE == ENABLED)
    {
        RT_PARAM_CHK((!DAL_CA8279_VLAN_IS_SET(vid)), RT_ERR_VLAN_ENTRY_NOT_FOUND);
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_port_get */


/* Function Name:
 *      dal_ca8279_vlan_port_set
 * Description:
    ...
    rtk_portmask_t *pUntag_portmask)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_port_set */

/* Function Name:
 *      dal_ca8279_vlan_vlanFunctionEnable_get
 * Description:
 ...
 */
int32
dal_ca8279_vlan_vlanFunctionEnable_get(rtk_enable_t *pEnable)
{
    ca_status_t ret=CA_E_OK;
    rtk_port_t port;
    ca_port_id_t port_id;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_vlanFunctionEnable_get */


/* Function Name:
 *      dal_ca8279_vlan_vlanFunctionEnable_set
 * Description:
 ...
 */
int32
dal_ca8279_vlan_vlanFunctionEnable_set(rtk_enable_t enable)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ca_vlan_port_control_t config;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_vlanFunctionEnable_set */

/* Function Name:
 *      dal_ca8279_vlan_fidMode_get
 * Description:
 ...
 */
int32
dal_ca8279_vlan_fidMode_get(rtk_vlan_t vid, rtk_fidMode_t *pMode)
{
    ca_status_t ret=CA_E_OK;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_fidMode_get */

/* Function Name:
 *      dal_ca8279_vlan_fidMode_set
 * Description:
 ...
 */
int32
dal_ca8279_vlan_fidMode_set(rtk_vlan_t vid, rtk_fidMode_t mode)
{
    ca_status_t ret=CA_E_OK;
    ca_vlan_learning_mode_t ca_mode;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_vlan_fidMode_set */
