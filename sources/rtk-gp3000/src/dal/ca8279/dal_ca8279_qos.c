...
queueWeightCfg_t queueWeightCfg[CA8279_PRI_SEL_GROUP_INDEX_MAX];
queuePriMapCfg_t queuePriMapCfg[CA8279_PRI_SEL_GROUP_INDEX_MAX];
...
int32 _dal_ca8279_qos_weight_set(rtk_port_t port,uint32 w_dot1q,uint32 w_dscp)
{
...
int32 _dal_ca8279_qos_priMap_set(rtk_port_t port,uint32* pPri2queue)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ca_uint8_t qIdx;
 ...
 */
int32
dal_ca8279_qos_init(void)
{
    uint32 portIdx,grpIdx,qIdx;

    for(grpIdx=0;grpIdx<CA8279_PRI_SEL_GROUP_INDEX_MAX;grpIdx++)
    {
...
/* Function Name:
 *      dal_ca8279_qos_priSelGroup_get
 * Description:
 ...
 */
int32
dal_ca8279_qos_priSelGroup_get(uint32 grpIdx, rtk_qos_priSelWeight_t *pWeightOfPriSel)
{
    int32   ret;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_qos_priSelGroup_get */

/* Function Name:
 *      dal_ca8279_qos_priSelGroup_set
 * Description:
 ...
 */
int32
dal_ca8279_qos_priSelGroup_set(uint32 grpIdx, rtk_qos_priSelWeight_t *pWeightOfPriSel)
{
    int32   ret;
    rtk_port_t port;
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        ...
        {
            if((ret=_dal_ca8279_qos_weight_set(port,pWeightOfPriSel->weight_of_dot1q,pWeightOfPriSel->weight_of_dscp)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_QOS | MOD_DAL), "");
                return ret;
            }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_qos_priSelGroup_set */

/* Function Name:
 *      dal_ca8279_qos_portPriSelGroup_get
 * Description:
 ...
 */
int32
dal_ca8279_qos_portPriSelGroup_get(rtk_port_t port, uint32 *pPriSelGrpIdx)
{
    ...
    *pPriSelGrpIdx = lockPort2Weight[port];
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8279_qos_portPriSelGroup_get */

/* Function Name:
 *      dal_ca8279_qos_portPriSelGroup_set
 * Description:
 ...
 */
int32
dal_ca8279_qos_portPriSelGroup_set(rtk_port_t port, uint32 priSelGrpIdx)
{
    int32 ret=RT_ERR_OK;
    ...
    /* function body */
    if((ret=_dal_ca8279_qos_weight_set(port,queueWeightCfg[priSelGrpIdx].weight_of_dot1q,queueWeightCfg[priSelGrpIdx].weight_of_dscp)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS | MOD_DAL), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
}   /* end of dal_ca8279_qos_portPriSelGroup_set */

/*
 * Function Declaration
 */
/* Function Name:
 *      dal_ca8279_qos_priMap_get
 * Description:
 ...
 */
int32
dal_ca8279_qos_priMap_get(uint32 group, rtk_qos_pri2queue_t *pPri2qid)
{
    uint32  qIdx;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_qos_priMap_get */

/* Function Name:
 *      dal_ca8279_qos_priMap_set
 * Description:
 ...
 */
int32
dal_ca8279_qos_priMap_set(uint32 group, rtk_qos_pri2queue_t *pPri2qid)
{
    int32 ret=RT_ERR_OK;
    rtk_port_t port;
    uint32  qIdx;
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        ...
        {
            if((ret=_dal_ca8279_qos_priMap_set(port,pPri2qid)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_QOS | MOD_DAL), "");
                return ret;
            }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_qos_priMap_set */

/* Function Name:
 *      dal_ca8279_qos_portPriMap_get
 * Description:
 ...
 */
int32
dal_ca8279_qos_portPriMap_get(rtk_port_t port, uint32 *pGroup)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_QOS),"%s",__FUNCTION__);
...
} /* end of dal_ca8279_qos_portPriMap_get */

/* Function Name:
 *      dal_ca8279_qos_portPriMap_set
 * Description:
 ...
 */
int32
dal_ca8279_qos_portPriMap_set(rtk_port_t port, uint32 group)
{
    int32 ret=RT_ERR_OK;
    ...
    if((ret=_dal_ca8279_qos_priMap_set(port,queuePriMapCfg[group].pri2queue)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS | MOD_DAL), "");
        return ret;
    }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_qos_portPriMap_set */

/* Function Name:
 *      dal_ca8279_qos_schedulingQueue_get
 * Description:
 ...
 */
int32
dal_ca8279_qos_schedulingQueue_get(rtk_port_t port, rtk_qos_queue_weights_t *pQweights)
{
    ca_status_t ret=CA_E_OK;
...
/* Function Name:
 *      dal_ca8279_qos_schedulingQueue_set
 * Description:
 ...
 */
int32
dal_ca8279_qos_schedulingQueue_set(rtk_port_t port, rtk_qos_queue_weights_t *pQweights)
{
    ca_status_t ret=CA_E_OK;
    ca_queue_schedule_mode_t mode;
    ca_queue_weights_t weights;
