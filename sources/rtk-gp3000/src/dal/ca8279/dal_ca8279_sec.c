...
uint32 ICMP_FLOOD_TH_UNIT = 1;
uint32 SYN_FLOOD_TH_UNIT = 1;
uint32 FIN_FLOOD_TH_UNIT = 1;
...
int32 _dal_ca8279_synfin_deny_classification_set(rtk_port_t port,rtk_action_t rtk_action,ca_uint32_t *pIndex,ca_uint8_t flag)
{
...
//    key_mask.l4_mask.l4_valid = 1;
    ...
    else //Deleting
    {
        ...
        {
            printk(KERN_INFO "%s %d priority not match!!\n",__FUNCTION__,__LINE__);
            *pIndex = -1;
            return RT_ERR_OK;
        }
        ...
        {
            printk(KERN_INFO "%s %d key not match!!\n",__FUNCTION__,__LINE__);
            *pIndex = -1;
            return RT_ERR_OK;
        }
        ...
        {
            printk(KERN_INFO "%s %d key_mask not match!!\n",__FUNCTION__,__LINE__);
            *pIndex = -1;
            return RT_ERR_OK;
        }
        ...
        {
            printk(KERN_INFO "%s %d action not match!!\n",__FUNCTION__,__LINE__);
            *pIndex = -1;
            return RT_ERR_OK;
        }
...
int32 _dal_ca8279_calculate_threshold(uint32 thresh,uint32 unit,uint32 *value)
{
    if(thresh == 0)
    {
        *value = 0;
    ...
    switch(unit)
    {
        case 1:
            *value = (thresh*1000) / 1;
            break;
        case 256:
            *value = (thresh*1000) / 250;
            break;
        case 512:
            *value = (thresh*1000) / 500;
            break;
        default:
            return RT_ERR_INPUT;
...
int32 _dal_ca8279_icmp_flood_classification_set(rtk_port_t port,rtk_action_t rtk_action,uint32 floodThresh,ca_uint32_t *pIndex,ca_uint8_t flag)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
...
int32 _dal_ca8279_syn_flood_classification_set(rtk_port_t port,rtk_action_t rtk_action,uint32 floodThresh,ca_uint32_t *pIndex,ca_uint8_t flag)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ca_policer_t policer;
...
//printk(KERN_INFO "key.src_port=%d\n",key.src_port);
//printk(KERN_INFO "key_mask.src_port=%d\n",key_mask.src_port);
//printk(KERN_INFO "key.l4.l4_valid=%d\n",key.l4.l4_valid);
//printk(KERN_INFO "key.l4.tcp_flags=%d\n",key.l4.tcp_flags);
//printk(KERN_INFO "key_mask.l4=%d\n",key_mask.l4);
//printk(KERN_INFO "key_mask.l4_mask.tcp_flags=%d\n",key_mask.l4_mask.tcp_flags);
//
//if(HAL_IS_PON_PORT(port))
//{
//    printk(KERN_INFO "key.key_handle.flow_id=%d\n",key.key_handle.flow_id);
//    printk(KERN_INFO "key.key_handle.gem_index=%d\n",key.key_handle.gem_index);
//    printk(KERN_INFO "key.key_handle.llid_cos_index=%d\n",key.key_handle.llid_cos_index);
//    printk(KERN_INFO "key_mask.key_handle=%d\n",key_mask.key_handle);
//
//    printk(KERN_INFO "action.forward=%d\n",action.forward);
//    printk(KERN_INFO "action.dest.port=%d\n",action.dest.port);
//}
//else
//{
//    printk(KERN_INFO "action.forward=%d\n",action.forward);
...
//}
//
//printk(KERN_INFO "action.options.action_handle.flow_id=%d\n",action.options.action_handle.flow_id);
//printk(KERN_INFO "action.options.masks.action_handle=%d\n",action.options.masks.action_handle);
//
//printk(KERN_INFO "get_priority=%d\n",get_priority);
//printk(KERN_INFO "get_key.src_port=%d\n",get_key.src_port);
//printk(KERN_INFO "get_key_mask.src_port=%d\n",get_key_mask.src_port);
//printk(KERN_INFO "get_key.l4.l4_valid=%d\n",get_key.l4.l4_valid);
//printk(KERN_INFO "get_key.l4.tcp_flags=%d\n",get_key.l4.tcp_flags);
//printk(KERN_INFO "get_key_mask.l4=%d\n",get_key_mask.l4);
//printk(KERN_INFO "get_key_mask.l4_mask.tcp_flags=%d\n",get_key_mask.l4_mask.tcp_flags);
//
//if(HAL_IS_PON_PORT(port))
//{
//    printk(KERN_INFO "get_key.key_handle.flow_id=%d\n",get_key.key_handle.flow_id);
//    printk(KERN_INFO "get_key.key_handle.gem_index=%d\n",get_key.key_handle.gem_index);
//    printk(KERN_INFO "get_key.key_handle.llid_cos_index=%d\n",get_key.key_handle.llid_cos_index);
//    printk(KERN_INFO "get_key_mask.key_handle=%d\n",get_key_mask.key_handle);
//
//    printk(KERN_INFO "get_action.forward=%d\n",get_action.forward);
//    printk(KERN_INFO "get_action.dest.port=%d\n",get_action.dest.port);
//}
//else
//{
//    printk(KERN_INFO "get_action.forward=%d\n",get_action.forward);
...
//}
//
//printk(KERN_INFO "get_action.options.action_handle.flow_id=%d\n",get_action.options.action_handle.flow_id);
//printk(KERN_INFO "get_action.options.masks.action_handle=%d\n",get_action.options.masks.action_handle);
...
int32 _dal_ca8279_fin_flood_classification_set(rtk_port_t port,rtk_action_t rtk_action,uint32 floodThresh,ca_uint32_t *pIndex,ca_uint8_t flag)
{
    ca_status_t ret=CA_E_OK;
    ca_port_id_t port_id;
    ca_policer_t policer;
...
dal_ca8279_sec_init(void)
{
    ...
    ICMP_FLOOD_TH_UNIT = 1;
    SYN_FLOOD_TH_UNIT = 1;
    FIN_FLOOD_TH_UNIT = 1;

    return RT_ERR_OK;
} /* end of dal_ca8279_sec_init */

/* Function Name:
 *      dal_ca8279_sec_portAttackPreventState_get
 * Description:
 ...
 */
int32
dal_ca8279_sec_portAttackPreventState_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    *pEnable = atkPrvt[port].enable;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_sec_portAttackPreventState_get */

/* Function Name:
 *      dal_ca8279_sec_portAttackPreventState_set
 * Description:
 ...
 */
int32
dal_ca8279_sec_portAttackPreventState_set(rtk_port_t port, rtk_enable_t enable)
{
    int32 ret=RT_ERR_OK;
    uint32 realThresh;
    ...
    if((atkPrvt[port].enable == DISABLED)&&(enable == ENABLED)) //DISABLE -> ENABLE
    {
        ...
        {
            if((ret = _dal_ca8279_synfin_deny_classification_set(port,SYNFIN_DENY_ACTION,&atkPrvt[port].synfin_deny_index,0)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }

            if((ret = _dal_ca8279_synfin_deny_classification_set(port,SYNFIN_DENY_ACTION,&atkPrvt[port].synfin_deny_index,1)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
        ...
        {
            if((ret = _dal_ca8279_calculate_threshold(ICMP_FLOOD_TH,ICMP_FLOOD_TH_UNIT,&realThresh)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }

            if((ret = _dal_ca8279_icmp_flood_classification_set(port,ICMP_FLOOD_ACTION,realThresh,&atkPrvt[port].icmp_flood_index,0)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }

            if((ret = _dal_ca8279_icmp_flood_classification_set(port,ICMP_FLOOD_ACTION,realThresh,&atkPrvt[port].icmp_flood_index,1)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
        ...
        {
            if((ret = _dal_ca8279_calculate_threshold(SYN_FLOOD_TH,SYN_FLOOD_TH_UNIT,&realThresh)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }

            if((ret = _dal_ca8279_syn_flood_classification_set(port,SYN_FLOOD_ACTION,realThresh,&atkPrvt[port].syn_flood_index,0)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }

            if((ret = _dal_ca8279_syn_flood_classification_set(port,SYN_FLOOD_ACTION,realThresh,&atkPrvt[port].syn_flood_index,1)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
        ...
        {
            if((ret = _dal_ca8279_calculate_threshold(FIN_FLOOD_TH,FIN_FLOOD_TH_UNIT,&realThresh)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }

            if((ret = _dal_ca8279_fin_flood_classification_set(port,FIN_FLOOD_ACTION,realThresh,&atkPrvt[port].fin_flood_index,0)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }

            if((ret = _dal_ca8279_fin_flood_classification_set(port,FIN_FLOOD_ACTION,realThresh,&atkPrvt[port].fin_flood_index,1)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                return ret;
            }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_sec_portAttackPreventState_set */

/* Function Name:
 *      dal_ca8279_sec_attackPrevent_get
 * Description:
    ...
    rtk_action_t            *pAction)
{
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_sec_attackPrevent_get */

/* Function Name:
 *      dal_ca8279_sec_attackPrevent_set
 * Description:
    ...
    rtk_action_t            action)
{
        ...
        case SYNFIN_DENY:
            if((SYNFIN_DENY_ACTION == ACTION_FORWARD) && (action != ACTION_FORWARD))
            {
                HAL_SCAN_ALL_PORT(port)
                {
                    ...
                    {
                        if((ret = _dal_ca8279_synfin_deny_classification_set(port,action,&atkPrvt[port].synfin_deny_index,0)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }

                        if((ret = _dal_ca8279_synfin_deny_classification_set(port,action,&atkPrvt[port].synfin_deny_index,1)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
            ...
            if((ICMP_FLOOD_ACTION == ACTION_FORWARD) && (action != ACTION_FORWARD))
            {
                ...
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        ...
                        if((ret = _dal_ca8279_icmp_flood_classification_set(port,action,realThresh,&atkPrvt[port].icmp_flood_index,0)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }

                        if((ret = _dal_ca8279_icmp_flood_classification_set(port,action,ICMP_FLOOD_TH,&atkPrvt[port].icmp_flood_index,1)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
            ...
            else if((ICMP_FLOOD_ACTION != ACTION_FORWARD) && (action != ACTION_FORWARD) && (ICMP_FLOOD_ACTION != action))
            {
                ...
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        ...
                        if((ret = _dal_ca8279_icmp_flood_classification_set(port,action,realThresh,&atkPrvt[port].icmp_flood_index,1)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
        ...
        case SYNFLOOD_DENY:
            ...
            if((SYN_FLOOD_ACTION == ACTION_FORWARD) && (action != ACTION_FORWARD))
            {
                ...
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        if((ret = _dal_ca8279_syn_flood_classification_set(port,action,realThresh,&atkPrvt[port].syn_flood_index,0)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }

                        if((ret = _dal_ca8279_syn_flood_classification_set(port,action,realThresh,&atkPrvt[port].syn_flood_index,1)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
        ...
        case FINFLOOD_DENY:
            ...
            if((FIN_FLOOD_ACTION == ACTION_FORWARD) && (action != ACTION_FORWARD))
            {
                ...
                HAL_SCAN_ALL_PORT(port)
                {
                    if(atkPrvt[port].enable == ENABLED)
                    {
                        if((ret = _dal_ca8279_fin_flood_classification_set(port,action,realThresh,&atkPrvt[port].fin_flood_index,0)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
            
                        if((ret = _dal_ca8279_fin_flood_classification_set(port,action,realThresh,&atkPrvt[port].fin_flood_index,1)) != RT_ERR_OK)
                        {
                            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                            return ret;
                        }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_sec_attackPrevent_set */

/* Function Name:
 *      dal_ca8279_sec_attackFloodThresh_get
 * Description:
 ...
 */
int32
dal_ca8279_sec_attackFloodThresh_get(rtk_sec_attackFloodType_t type, uint32 *pFloodThresh)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_SEC),"%s",__FUNCTION__);
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_sec_attackFloodThresh_get */
      
/* Function Name:
 *      dal_ca8279_sec_attackFloodThresh_set
 * Description:
 ...
 */
int32
dal_ca8279_sec_attackFloodThresh_set(rtk_sec_attackFloodType_t type, uint32 floodThresh)
{
    int32 ret=RT_ERR_OK;
    uint32 port;
    uint32 realThresh;
    ...
    switch(type)
    {
        case SEC_ICMPFLOOD:
            ...
            {
                if((ret = _dal_ca8279_calculate_threshold(floodThresh,ICMP_FLOOD_TH_UNIT,&realThresh)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                    return ret;
                }
        ...
        case SEC_SYNCFLOOD:
            ...
            {
                if((ret = _dal_ca8279_calculate_threshold(floodThresh,SYN_FLOOD_TH_UNIT,&realThresh)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                    return ret;
                }
        ...
        case SEC_FINFLOOD:
            ...
            {
                if((ret = _dal_ca8279_calculate_threshold(floodThresh,FIN_FLOOD_TH_UNIT,&realThresh)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                    return ret;
                }
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_sec_attackFloodThresh_set */

/* Function Name:
 *      dal_ca8279_sec_attackFloodThreshUnit_get
 * Description:
 ...
 */
int32
dal_ca8279_sec_attackFloodThreshUnit_get(rtk_sec_attackFloodType_t type, uint32 *pFloodThreshUnit)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_SEC),"%s",__FUNCTION__);
    ...
    {
        case SEC_ICMPFLOOD:
            *pFloodThreshUnit = ICMP_FLOOD_TH_UNIT;
            break;
        case SEC_SYNCFLOOD:
            *pFloodThreshUnit = SYN_FLOOD_TH_UNIT;
            break;
        case SEC_FINFLOOD:
            *pFloodThreshUnit = FIN_FLOOD_TH_UNIT;
            break;
        default:
            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
            return RT_ERR_CHIP_NOT_SUPPORTED;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_sec_attackFloodThreshUnit_get */

/* Function Name:
 *      dal_ca8279_sec_attackFloodThreshUnit_set
 * Description:
 ...
 */
int32
dal_ca8279_sec_attackFloodThreshUnit_set(rtk_sec_attackFloodType_t type, uint32 floodThreshUnit)
{
    ...
    {
        case SEC_ICMPFLOOD:
            if((ICMP_FLOOD_ACTION != ACTION_FORWARD) && (ICMP_FLOOD_TH_UNIT != floodThreshUnit))
            {
                if((ret = _dal_ca8279_calculate_threshold(ICMP_FLOOD_TH,floodThreshUnit,&realThresh)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                    return ret;
                }
            ...
            ICMP_FLOOD_TH_UNIT = floodThreshUnit;
            break;
        case SEC_SYNCFLOOD:
            if((SYN_FLOOD_ACTION != ACTION_FORWARD) && (SYN_FLOOD_TH_UNIT != floodThreshUnit))
            {
                if((ret = _dal_ca8279_calculate_threshold(SYN_FLOOD_TH,floodThreshUnit,&realThresh)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                    return ret;
                }
            ...
            SYN_FLOOD_TH_UNIT = floodThreshUnit;
            break;
        case SEC_FINFLOOD:
            if((FIN_FLOOD_ACTION != ACTION_FORWARD) && (FIN_FLOOD_TH_UNIT != floodThreshUnit))
            {
                if((ret = _dal_ca8279_calculate_threshold(FIN_FLOOD_TH,floodThreshUnit,&realThresh)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
                    return ret;
                }
            ...
            FIN_FLOOD_TH_UNIT = floodThreshUnit;
            break;
        default:
            RT_ERR(ret, (MOD_DAL|MOD_SEC), "");
            return RT_ERR_CHIP_NOT_SUPPORTED;
    ...
    return RT_ERR_OK;
} /* end of dal_ca8279_sec_attackFloodThreshUnit_set */
