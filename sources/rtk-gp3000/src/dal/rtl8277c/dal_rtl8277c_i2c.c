    ...
    rtk_enable_t* pEnable )
{
    ...
    *pEnable = GBL_I2C_ENABLE[i2cPort];
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl8277c_i2c_enable_get */
    ...
    rtk_enable_t enable )
{
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl8277c_i2c_enable_set */
    ...
    uint32* pClock )
{
    ...
    *pClock = gbl_clock;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl8277c_i2c_clock_get */
    ...
    uint32 clock )
{
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl8277c_i2c_clock_set */
    ...
    uint32 count)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8277c_i2c_seq_read */
    ...
    uint32 count)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8277c_i2c_seq_write */
