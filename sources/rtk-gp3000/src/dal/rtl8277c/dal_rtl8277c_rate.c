...
static int32 _dal_rtl8277c_meter_cfg_get(uint32 index, meter_cfg_t *pMeter)
{
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        ...
        if (index == stormCfg[port].ethertype_flow_id)
        {
            ...
            RT_ERR_CHK((rt_error_common_t)_dal_rtl8277c_agr_flow_profile_id_get(STORM_GROUP_ETHERTYPE, &agr_pol_id), ret);
        ...
        if (index == stormCfg[port].loopdetect_flow_id)
        {
            ...
            RT_ERR_CHK((rt_error_common_t)_dal_rtl8277c_agr_flow_profile_id_get(STORM_GROUP_LOOP_DETECT, &agr_pol_id), ret);
        ...
        if (index == stormCfg[port].dot1x_flow_id)
        {
            ...
            RT_ERR_CHK((rt_error_common_t)_dal_rtl8277c_agr_flow_profile_id_get(STORM_GROUP_DOT1X, &agr_pol_id), ret);
...
int32 _dal_rtl8277c_use_ca_specpkt_ctrl_set(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_enable_t enable)
{
    ...
    if (STORM_GROUP_LOOP_DETECT == stormType)
        return dal_rtl8277c_trap_portLoopDetectPktPolicer_set(port, enable, agr_pol_id);
...
int32 _dal_rtl8277c_check_meter_change_set(uint32 meterIndex)
{
    ...
    HAL_SCAN_ALL_PORT(port)
    {
        ...
        {
            RT_ERR_CHK(_dal_rtl8277c_use_ca_agr_flow_set(STORM_GROUP_ETHERTYPE, stormCfg[port].ethertype_flow_id), ret);
            RT_ERR_CHK(_dal_rtl8277c_use_ca_specpkt_ctrl_set(port, STORM_GROUP_ETHERTYPE, stormCfg[port].ethertype_enable), ret);
            if ( CA_AAL_POLICER_TYPE_NONE == meterEntry[meterIndex].mode)
            {
        ...
        {
            RT_ERR_CHK(_dal_rtl8277c_use_ca_agr_flow_set(STORM_GROUP_LOOP_DETECT, stormCfg[port].loopdetect_flow_id), ret);
            RT_ERR_CHK(_dal_rtl8277c_use_ca_specpkt_ctrl_set(port, STORM_GROUP_LOOP_DETECT, stormCfg[port].loopdetect_enable), ret);
            if ( CA_AAL_POLICER_TYPE_NONE == meterEntry[meterIndex].mode)
            {
        ...
        {
            RT_ERR_CHK(_dal_rtl8277c_use_ca_agr_flow_set(STORM_GROUP_DOT1X, stormCfg[port].dot1x_flow_id), ret);
            RT_ERR_CHK(_dal_rtl8277c_use_ca_specpkt_ctrl_set(port, STORM_GROUP_DOT1X, stormCfg[port].dot1x_enable), ret);
            if ( CA_AAL_POLICER_TYPE_NONE == meterEntry[meterIndex].mode)
            {
...
/* Function Name:
 *      dal_rtl8277c_rate_queueEgrBandwidthCtrlRate_get
 * Description:
 ...
 */
int32
dal_rtl8277c_rate_queueEgrBandwidthCtrlRate_get(rtk_port_t port, rtk_qid_t queue, uint32 *pRate)
{
	rt_error_common_t ret = RT_ERR_OK;
    aal_l2_te_shaper_tbc_cfg_t     profile;
    aal_l3_te_shaper_tbc_cfg_t     l3_profile;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8277c_rate_queueEgrBandwidthCtrlRate_get */

/* Function Name:
 *      dal_rtl8277c_rate_queueEgrBandwidthCtrlRate_set
 * Description:
 ...
 */
int32
dal_rtl8277c_rate_queueEgrBandwidthCtrlRate_set(rtk_port_t port, rtk_qid_t queue, uint32 rate)
{
    rt_error_common_t ret = RT_ERR_OK;
    ca_port_id_t port_id;
    aal_l2_te_shaper_tbc_cfg_msk_t profile_msk;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8277c_rate_queueEgrBandwidthCtrlRate_set */
    ...
    uint32                  index)
{
    ...
    switch(stormType)
    {
        ...
        case STORM_GROUP_ETHERTYPE:
            ...
            {
                RT_ERR_CHK(_dal_rtl8277c_use_ca_agr_flow_set(stormType, index), ret);
                RT_ERR_CHK(_dal_rtl8277c_use_ca_specpkt_ctrl_set(port, stormType, stormCfg[port].ethertype_enable), ret);
            }
        ...
        case STORM_GROUP_LOOP_DETECT:
            ...
            {
                RT_ERR_CHK(_dal_rtl8277c_use_ca_agr_flow_set(stormType, index), ret);
                RT_ERR_CHK(_dal_rtl8277c_use_ca_specpkt_ctrl_set(port, stormType, stormCfg[port].loopdetect_enable), ret);
            }
        ...
        case STORM_GROUP_DOT1X:
            ...
            {
                RT_ERR_CHK(_dal_rtl8277c_use_ca_agr_flow_set(stormType, index), ret);
                RT_ERR_CHK(_dal_rtl8277c_use_ca_specpkt_ctrl_set(port, stormType, stormCfg[port].dot1x_enable), ret);
            }
...
#if defined(CONFIG_SDK_RTL8198X)
/* Function Name:
 *      dal_rtl8277c_ca_specpkt_ctrl_ldpid_update
 * Description:
 ...
 */
int32 dal_rtl8277c_ca_specpkt_ctrl_ldpid_update (rtk_port_t port)
{
	rt_error_common_t ret = RT_ERR_OK;
	aal_ilpb_cfg_t ilpb_cfg;
	...
	return RT_ERR_OK;
} /* end of dal_rtl8277c_ca_specpkt_ctrl_ldpid_update */
#endif
