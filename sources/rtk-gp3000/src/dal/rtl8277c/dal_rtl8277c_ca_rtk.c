...
static dal_mapper_t dal_rtl8277c_mapper =
{
    ...
    .port_phyTestMode_get                       = dal_rtl8277c_port_phyTestMode_get,
    .port_phyTestMode_set                       = dal_rtl8277c_port_phyTestMode_set,
    ...
    .port_rtctResult_get                        = dal_rtl8277c_port_rtctResult_get,
    .port_rtct_start                            = dal_rtl8277c_port_rtct_start,
    ...
    .port_serdesTxRxPolarity_set                = dal_rtl8277c_port_serdesTxRxPolarity_set,
    .port_serdesTxRxPolarity_get                = dal_rtl8277c_port_serdesTxRxPolarity_get,
    .port_serdesStatus_get                      = dal_rtl8277c_port_serdesStatus_get,
    ...
    .rate_egrQueueBwCtrlRate_get = dal_rtl8277c_rate_queueEgrBandwidthCtrlRate_get,
    .rate_egrQueueBwCtrlRate_set = dal_rtl8277c_rate_queueEgrBandwidthCtrlRate_set,
    ...
    .l2_mcastAddr_add                           = dal_rt_rtl8277c_l2_mcastAddr_add,
    .l2_mcastAddr_del                           = dal_rt_rtl8277c_l2_mcastAddr_del,
    .l2_mcastAddr_get                           = dal_rt_rtl8277c_l2_mcastAddr_get,
    ...
    .rt_l2_fwdGroupId_set               = dal_rt_rtl8277c_l2_fwdGroupId_set,
    .rt_l2_fwdGroupId_get               = dal_rt_rtl8277c_l2_fwdGroupId_get,
    .rt_l2_fwdGroupAction_set           = dal_rt_rtl8277c_l2_fwdGroupAction_set,
    .rt_l2_fwdGroupAction_get           = dal_rt_rtl8277c_l2_fwdGroupAction_get,
    ...
    .rt_cls_extend_rule_add             = dal_rt_rtl8277c_cls_extend_rule_add,
    .rt_cls_extend_rule_delete          = dal_rt_rtl8277c_cls_extend_rule_delete,
    .rt_cls_extend_rule_get             = dal_rt_rtl8277c_cls_extend_rule_get,
    .rt_cls_pon_sid_set                 = dal_rt_rtl8277c_cls_pon_sid_set,
    .rt_cls_fwdPort_set                 = dal_rt_rtl8277c_cls_fwdPort_set,
    .rt_cls_vlan_paser_set              = dal_rt_rtl8277c_cls_vlan_paser_set,
    .rt_cls_vlan_paser_get              = dal_rt_rtl8277c_cls_vlan_paser_get,
    ...
    .rt_trap_portLoopDetectPktAction_get = dal_rtl8277c_trap_portLoopDetectPktAction_get,
    .rt_trap_portLoopDetectPktAction_set = dal_rtl8277c_trap_portLoopDetectPktAction_set,
    .rt_trap_portDot1xPktAction_get     = dal_rtl8277c_trap_portDot1xPktAction_get,
    .rt_trap_portDot1xPktAction_set     = dal_rtl8277c_trap_portDot1xPktAction_set,
    .rt_trap_pattern_get                = dal_rtl8277c_trap_pattern_get,
    .rt_trap_pattern_set                = dal_rtl8277c_trap_pattern_set,
    .rt_trap_priority_get               = dal_rtl8277c_trap_priority_get,
    .rt_trap_priority_set               = dal_rtl8277c_trap_priority_set,
    ...
    .rt_qos_ingress_qos_set             = dal_rtl8277c_qos_ingress_qos_set,
    .rt_qos_ingress_qos_del             = dal_rtl8277c_qos_ingress_qos_del,
    .rt_qos_ingress_qos_get             = dal_rtl8277c_qos_ingress_qos_get,
    .rt_port_macLoopbackEnable_get      = dal_rtl8277c_port_macLoopbackEnable_get,
    .rt_port_macLoopbackEnable_set      = dal_rtl8277c_port_macLoopbackEnable_set,
    /*RT GPON common API*/
#if defined(CONFIG_GPON_FEATURE)
    .rt_gpon_init                       = dal_rt_rtl8277c_gpon_init,
    .rt_gpon_serialNumber_set           = dal_rt_rtl8277c_gpon_serialNumber_set,
    .rt_gpon_serialNumber_get           = dal_rt_rtl8277c_gpon_serialNumber_get,
    .rt_gpon_registrationId_set         = dal_rt_rtl8277c_gpon_registrationId_set,
    .rt_gpon_registrationId_get         = dal_rt_rtl8277c_gpon_registrationId_get,
    ...
    .rt_gpon_fttr_omci_rx_callback_register = dal_rt_rtl8277c_gpon_fttr_omci_rx_callback_register,
#endif
    ...
    .rt_epon_mpcp_dbg_log_dump             = dal_rt_rt8277c_epon_mpcp_dbg_log_dump,
    ...
    .rt_ponmisc_dying_gasp_force_trigger   = dal_rt_rtl8277c_ponmisc_dying_gasp_force_trigger,
#endif
#endif
...
static int ca_rtk_debug_read(struct seq_file *seq, void *v)
{
    ...
    seq_printf(seq, "0x00000400 : RTL8277C_LOG_DBG message\n");
