 ...
 * Data Declaration
 */
static uint32 rtl8198f_trap_init = INIT_NOT_COMPLETED;
 ...
 */
int32
dal_rtl8198f_trap_init(void)
{
    int32 ret=RT_ERR_OK;
    
    rtl8198f_trap_init = INIT_COMPLETED;

    return RT_ERR_OK;
} /* end of dal_rtl8198f_trap_init */

/* Function Name:
 *      dal_rtl8198f_trap_portIgmpMldCtrlPktAction_get
 * Description:
 ...
 */
int32
dal_rtl8198f_trap_portIgmpMldCtrlPktAction_get(rtk_port_t port, rtk_trap_igmpMld_type_t igmpMldType, rtk_action_t *pAction)
{
    ...
    /* check Init status */
    RT_INIT_CHK(rtl8198f_trap_init);
    ...
    *pAction = ((forward_to_cpu == 1) ? ACTION_TRAP2CPU : ACTION_FORWARD);
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl8198f_trap_portIgmpMldCtrlPktAction_get */

/* Function Name:
 *      dal_rtl8198f_trap_portIgmpMldCtrlPktAction_set
 * Description:
 ...
 */
int32
dal_rtl8198f_trap_portIgmpMldCtrlPktAction_set(rtk_port_t port, rtk_trap_igmpMld_type_t igmpMldType, rtk_action_t action)
{
    ca_status_t ret=CA_E_OK;
    ca_pkt_type_t packet_type;
    ca_boolean_t forward_to_cpu;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl8198f_trap_portIgmpMldCtrlPktAction_set */
