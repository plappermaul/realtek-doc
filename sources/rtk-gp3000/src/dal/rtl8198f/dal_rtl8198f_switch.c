...
uint32 switch_83xx_init = INIT_NOT_COMPLETED;
#endif
 ...
 */
int32
dal_rtl8198f_switch_init(void)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_SWITCH),"%s",__FUNCTION__);

    switch_init = INIT_COMPLETED;
#ifdef CONFIG_RTL_83XX_SUPPORT
    switch_83xx_init = INIT_COMPLETED;
#endif

    return RT_ERR_OK;
} /* end of dal_rtl8198f_switch_init */

/* Function Name:
 *      dal_rtl8198f_switch_phyPortId_get
 * Description:
 ...
 */
int32
dal_rtl8198f_switch_phyPortId_get(rtk_switch_port_name_t portName, int32 *pPortId)
{
    RT_DBG(LOG_DEBUG, (MOD_DAL|MOD_SWITCH),"%s",__FUNCTION__);
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_switch_phyPortId_get */

/* Function Name:
 *      dal_rtl8198f_switch_version_get
 * Description:
 *      Get chip version
 * Input:
 *      pChipId    - chip id
...
int32
dal_rtl8198f_switch_version_get(uint32 *pChipId, uint32 *pRev, uint32 *pSubtype)
{
    int32  ret;
    ...
    *pSubtype = chipSubtype;
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl8198f_switch_version_get */

#ifndef CONFIG_RTL_83XX_SUPPORT
/* Function Name:
