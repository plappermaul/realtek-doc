 ...
 *
 * $Revision: 46639 $
 * $Date: 2014-02-26 16:48:44 +0800 (?±ä?, 26 äºŒæ? 2014) $
 *
...
dal_rtl8198f_vlan_init(void)
{
    ...
    if((ret = dal_rtl8198f_vlan_vlanFunctionEnable_set(ENABLED)) != RT_ERR_OK)
    {
...
dal_rtl8198f_vlan_create(rtk_vlan_t vid)
{
    ...
    if(VLAN_FUNC_ENABLE == ENABLED)
    {
        ...
        if((ret = dal_rtl8198f_vlan_port_set(vid,&Member_portmask,&Untag_portmask))!=RT_ERR_OK)
        {
            RT_ERR(ret, (MOD_DAL|MOD_VLAN), "");
            return RT_ERR_FAILED;
        }
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_create */
...
dal_rtl8198f_vlan_destroy(rtk_vlan_t vid)
{
	...
	return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_destroy */
...
dal_rtl8198f_vlan_destroyAll(uint32 restoreDefaultVlan)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_destroyAll */
...
dal_rtl8198f_vlan_portPvid_get(rtk_port_t port, uint32 *pPvid)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_portPvid_get */
...
dal_rtl8198f_vlan_portPvid_set(rtk_port_t port, uint32 pvid)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_portPvid_set */
    ...
    rtk_portmask_t *pUntagPortmask)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_port_get */
    ...
    rtk_portmask_t *pUntag_portmask)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_port_set */
...
dal_rtl8198f_vlan_vlanFunctionEnable_get(rtk_enable_t *pEnable)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_vlanFunctionEnable_get */
...
dal_rtl8198f_vlan_vlanFunctionEnable_set(rtk_enable_t enable)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_vlanFunctionEnable_set */
...
dal_rtl8198f_vlan_fidMode_get(rtk_vlan_t vid, rtk_fidMode_t *pMode)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_fidMode_get */
...
dal_rtl8198f_vlan_fidMode_set(rtk_vlan_t vid, rtk_fidMode_t mode)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_vlan_fidMode_set */
