...
uint32 port_83xx_init = INIT_NOT_COMPLETED;
#endif
...
dal_rtl8198f_port_phyAutoNegoEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    *pEnable = (ca_enable==1)? ENABLED:DISABLED;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_port_phyAutoNegoEnable_get */
...
dal_rtl8198f_port_phyAutoNegoEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_port_phyAutoNegoEnable_set */
    ...
    rtk_enable_t        *pFlowControl)
{
    ...
    *pFlowControl = (pfc_enable==1)? ENABLED : DISABLED;
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_port_phyForceModeAbility_get */
    ...
    rtk_enable_t        flowControl)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_port_phyForceModeAbility_set */
...
dal_rtl8198f_port_macForceAbility_get(rtk_port_t port,rtk_port_macAbility_t *pMacAbility)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_port_macForceAbility_get */
...
dal_rtl8198f_port_isolationEntry_get(rtk_port_isoConfig_t mode, rtk_port_t port, rtk_portmask_t *pPortmask, rtk_portmask_t *pExtPortmask)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_port_isolationEntry_get */
...
dal_rtl8198f_port_isolationEntry_set(rtk_port_isoConfig_t mode, rtk_port_t port, rtk_portmask_t *pPortmask, rtk_portmask_t *pExtPortmask)
{
    ...
    return RT_ERR_OK;
} /* end of dal_rtl8198f_port_isolationEntry_set */
