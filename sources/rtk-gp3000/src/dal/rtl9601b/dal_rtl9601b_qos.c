...
static int32 _dal_rtl9601b_qos_wfqWeight_set(rtk_port_t port, uint32 qid, uint32 weight)
{
    ...
    {
        RT_PARAM_CHK((1023 < weight), RT_ERR_QOS_QUEUE_WEIGHT);
...
/* Function Name:
 *      dal_rtl9601b_qos_portDot1pRemarkSrcSel_get
 * Description:
 ...
 */
int32
dal_rtl9601b_qos_portDot1pRemarkSrcSel_get(rtk_port_t port, rtk_qos_do1pRmkSrc_t *pType)
{
    int32   ret;
    uint32  source;
    ...
    /* function body */
    if ((ret = reg_array_field_read(RTL9601B_RMK_P_1P_SELr, REG_ARRAY_INDEX_NONE, port, RTL9601B_SELf, &source)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }  
    ...
    return RT_ERR_OK;
}   /* end of dal_rtl9601b_qos_portDot1pRemarkSrcSel_get */

/* Function Name:
 *      dal_rtl9601b_qos_portDot1pRemarkSrcSel_set
 * Description:
 ...
 */
int32
dal_rtl9601b_qos_portDot1pRemarkSrcSel_set(rtk_port_t port, rtk_qos_do1pRmkSrc_t type)
{
    int32   ret;
    uint32  source;
    ...
    if ((ret = reg_array_field_write(RTL9601B_RMK_P_1P_SELr, REG_ARRAY_INDEX_NONE, port, RTL9601B_SELf, &source)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_QOS|MOD_DAL), "");
        return ret;
    }  
    return RT_ERR_OK;
}   /* end of dal_rtl9601b_qos_portDot1pRemarkSrcSel_set */
