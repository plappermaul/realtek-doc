...
ca_uint32_t ca_rtk_link_change_intr(ca_device_id_t device_id,ca_uint32_t event_id,ca_void *event,ca_uint32_t len,ca_void *cookie)
{
#ifdef CONFIG_SDK_MODULES
...
dal_luna_g3_intr_init(void)
{
    ...
    if((ret = dal_luna_g3_intr_imr_set(INTR_TYPE_LINK_CHANGE,ENABLED)) != RT_ERR_OK)
    {
...
dal_luna_g3_intr_imr_set(rtk_intr_type_t intr, rtk_enable_t enable)
{
    ...
    return RT_ERR_OK;
} /* end of dal_luna_g3_intr_imr_set */
