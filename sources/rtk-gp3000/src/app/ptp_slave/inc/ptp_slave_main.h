#ifndef PTP_SLAVE_MAIN_H
#define PTP_SLAVE_MAIN_H

#define PTP_SLAVE_MSG_KEY 1121
#define PTP_SLAVE_MAX_PKT_SIZE 256

#define MQ_SLAVE_RX_PACKET 1
#define MQ_SLAVE_PRI_MAX -2
...
typedef struct ptp_packet_s
{
    ...
    unsigned char pkt[PTP_SLAVE_MAX_PKT_SIZE];
} ptp_packet_t;
