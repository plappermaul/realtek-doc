...
DEFINE_DDR_INT_VAR_O_INT(ddr2_odt_val);
DEFINE_DDR_INT_VAR_O_INT(rtt_wr_ohm);
DEFINE_DDR_INT_VAR_O_INT(cntlr_odt);
DEFINE_DDR_INT_VAR_O_INT(cntlr_ocd);
DEFINE_DDR_INT_VAR_O_INT(cntlr_md_odt);
DEFINE_DDR_INT_VAR_O_INT(cntlr_md_ocd);
DEFINE_DDR_INT_VAR_O_INT(cntlr_dm_ocd);
DEFINE_DDR_INT_VAR_O_INT(cntlr_ck_ocd);
DEFINE_DDR_INT_VAR_O_INT(cntlr_dqs_odt);
DEFINE_DDR_INT_VAR_O_INT(cntlr_dqs_ocd);
DEFINE_DDR_INT_VAR_O_INT(cntlr_cmd_ocd);
DEFINE_DDR_INT_VAR_O_INT(cntlr_ma_ocd);
...
#ifdef mc_pupd_detection
DEFINE_DDR_INT_VAR_O_INT(pupd_en);
#endif
...
DEFINE_DDR_INT_VAR_O_INT(dbg_en);
