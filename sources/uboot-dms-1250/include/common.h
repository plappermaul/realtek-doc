...
/* CAMEOTAG:add to turn on/off system information display */
#ifndef CAMEO_SIMPLE_DISPLAY
#define CAMEO_SIMPLE_DISPLAY_PRINTF(x) printf x
#else
#define CAMEO_SIMPLE_DISPLAY_PRINTF(x) 
#endif

#define CAMEO_SHOW_BOOT_PROCEDURE 	"\033[1;1H\033[2J\033[H\n" \
									"Boot Procedure                                        "CAMEO_BOOT_VERSION"\n" \
									"-------------------------------------------------------------------\n"
