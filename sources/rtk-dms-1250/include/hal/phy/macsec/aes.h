...
/*CAMEOTAG: commented by jianan 20230323, define aes_encrypt as a static function,
 * to fix multi-defination issue that define the same function name in opensource.*/
#if 0
