...
#ifndef __TAURUS_ASIC_H
#define __TAURUS_ASIC_H
...
#	define TAURUS_APB_CLK (25000000) /* Use external clock source */
#else
#	define TAURUS_APB_CLK (125000000)
#endif
#define CORTINA_PER_IO_FREQ (TAURUS_APB_CLK)
#define CONFIG_UART_CLOCK (TAURUS_APB_CLK)
