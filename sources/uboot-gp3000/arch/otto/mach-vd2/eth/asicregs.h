...
* All rights reserved.
*
* $Header: /usr/local/dslrepos/u-boot-2011.12/arch/mips/cpu/rlx5281/rtl8676/asicregs.h,v 1.1.1.1 2012/02/01 07:50:52 yachang Exp $
*
...
#define cache_flush writeback_invalidate_dcache_all
/*
 * --------------------------------
 *      RTL865XC Platform
 * --------------------------------
...
#define TABLE_ENTRY_DISTANCE (8 * sizeof(uint32_t))
enum {
