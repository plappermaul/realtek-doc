...
static unsigned long crctablefast (const unsigned char* p, unsigned long len)
{
...
static unsigned long crctable (const unsigned char* p, unsigned long len)
{
...
static unsigned long crcbitbybit(const unsigned char* p, unsigned long len)
{
...
static unsigned long crcbitbybitfast(const unsigned char* p, unsigned long len)
{
...
unsigned long crc_tester(const unsigned char* p, unsigned long len)
{
    ...
    //crc = crcbitbybit(p, len);
    //rtl_printf("crcbitbybit : 0x%x \r\n", crc);

    crc = crcbitbybitfast(p, len);
    //rtl_printf("crcbitbybitfast : 0x%x \r\n", crc);

    // 8, 16, 24, 32
    //crc = crctable(p, len);
    //rtl_printf("crctable : 0x%x \r\n", crc);

    //crc = crctablefast(p, len);
    //rtl_printf("crctablefast : 0x%x \r\n", crc);
