...
//20180524 change for 8197G ipsec only support AES + SHA2
...
#else
	int32 modeCrypto_val[4] = {-1, 0x20, 0x22, 0x23};
	int32 modeAuth_val[5] = {-1, 0x11, 0x21, 0x15, 0x25};
#endif
