#ifndef RTK_SPI_NAND_GD_H
#define RTK_SPI_NAND_GD_H
...
/***********************************************
  ...
  ***********************************************/
#define GD_PAGE_SPARE_SIZE        (0x840)
...
void gd_2KB_page_read(void *dma_addr, u32_t blk_pge_addr); //Only 2112 Bytes
void gd_2KB_page_write(void *dma_addr, u32_t blk_pge_addr); //Only 2112 Bytes
void gd_2KB_page_write_with_ecc_encode(void *dma_addr, u32_t blk_pge_addr, void *p_eccbuf);
int gd_2KB_page_read_with_ecc_decode(void * dma_addr,u32_t blk_pge_addr, void *p_eccbuf);

#endif //#ifndef RTK_SPI_NAND_GD_H
