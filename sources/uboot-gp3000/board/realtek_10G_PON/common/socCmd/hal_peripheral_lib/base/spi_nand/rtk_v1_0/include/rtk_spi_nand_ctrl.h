#ifndef RTK_SPI_NAND_CTRL_H
#define RTK_SPI_NAND_CTRL_H
...
#if 1
#define NAND_SPI_USE_2K
#else
#define NAND_SPI_USE_4K
#endif
...
#define WAIT_SPI_NAND_CS_RDY() while(!((REG32(SNFSR)>>0)&0x1))
...
snffcn_ptr snffcn_pio_raw_cmd, snffcn_pio_write_data, snffcn_pio_read_data;
#endif
...
#endif //#ifndef RTK_SPI_NAND_CTRL_H
