...
#ifndef _DW_SPI_BASE_H_
#define _DW_SPI_BASE_H_
...
//#define SSI0_REG_BASE  0xb801c000  //0x40042000
//#define SSI1_REG_BASE  0xb801c100  //0x40042400
//#define SSI2_REG_BASE  0xb801c000  //0x40042800
#define SSI0_REG_BASE  SPI0_REG_BASE
#define SSI1_REG_BASE  SPI1_REG_BASE
...
// DFS Reset Value: 0x7
#define BIT_SHIFT_CTRLR0_DFS_32       16
#define BIT_MASK_CTRLR0_DFS_32        0x1F
#define BIT_CTRLR0_DFS_32(x)(((x) & BIT_MASK_CTRLR0_DFS_32) << BIT_SHIFT_CTRLR0_DFS_32)
#define BIT_INVC_CTRLR0_DFS_32 (~(BIT_MASK_CTRLR0_DFS_32 << BIT_SHIFT_CTRLR0_DFS_32))
...
#define SSI_NUM_SLAVES 1  // 1-16
#define BIT_SHIFT_SER_SER    0
// #define BIT_MASK_SER_SER     0x1
...
// SSI0 Master/Slave Selection
#define BIT_SHIFT_SOC_FUNC_SPI_RN    8
#define BIT_MASK_SOC_FUNC_SPI_RN     0x1
#define BIT_SOC_FUNC_SPI_RN(x)(((x) & BIT_MASK_SOC_FUNC_SPI_RN) << BIT_SHIFT_SOC_FUNC_SPI_RN)
#define BIT_INVC_SOC_FUNC_SPI_RN (~(BIT_MASK_SOC_FUNC_SPI_RN << BIT_SHIFT_SOC_FUNC_SPI_RN))
...
typedef enum _SSI0_PINMUX_SELECT_ {
    SSI0_MUX_TO_GPIOE = DW_MUX_0,
    SSI0_MUX_TO_GPIOC = DW_MUX_1,
    SSI0_MUX_TO_GPIOI = DW_MUX_2
}SSI0_PINMUX_SELECT, *PSSI0_PINMUX_SELECT;

typedef enum _SSI1_PINMUX_SELECT_ {
    SSI1_MUX_TO_GPIOA = DW_MUX_0,
    SSI1_MUX_TO_GPIOB = DW_MUX_1,
    SSI1_MUX_TO_GPIOD = DW_MUX_2
}SSI1_PINMUX_SELECT, *PSSI1_PINMUX_SELECT;

typedef enum _SSI2_PINMUX_SELECT_ {
    SSI2_MUX_TO_GPIOG = DW_MUX_0,
    SSI2_MUX_TO_GPIOE = DW_MUX_1,
    SSI2_MUX_TO_GPIOD = DW_MUX_2
}SSI2_PINMUX_SELECT, *PSSI2_PINMUX_SELECT;

typedef enum _SSI0_MULTI_CS_PINMUX_SELECT_ {
    SSI0_CS_MUX_TO_GPIOE    = DW_MUX_0,
    SSI0_CS_MUX_RSVD        = DW_MUX_1,
    SSI0_CS_MUX_TO_GPIO_IJK = DW_MUX_2
...
typedef enum _SSI_CTRLR0_DFS_32_ {
    DFS_4_BITS   = 3,
    DFS_5_BITS   = 4,
    DFS_6_BITS   = 5,
    DFS_7_BITS   = 6,
    ...
    DFS_31_BITS  = 30,
    DFS_32_BITS  = 31,
}SSI_CTRLR0_DFS_32, *PSSI_CTRLR0_DFS_32;
...
BOOL
HalSsiSetSclkPolarityDWCommon(
        IN VOID *Data
        );

BOOL
HalSsiSetSclkPhaseDWCommon(
        IN VOID *Data
        );

BOOL
HalSsiWriterDWCommon(
        IN VOID *Data
        );

u16
HalSsiReaderDWCommon(
        IN VOID *Data
        );

u32
HalSsiGetRxFifoLevelDWCommon(
        IN VOID *Data
        );

u32
HalSsiGetTxFifoLevelDWCommon(
        IN VOID *Data
        );

u32
HalSsiGetStatusDWCommon(
        IN VOID *Data
        );

u32
HalSsiGetInterruptStatusDWCommon(
        IN VOID *Data
        );
