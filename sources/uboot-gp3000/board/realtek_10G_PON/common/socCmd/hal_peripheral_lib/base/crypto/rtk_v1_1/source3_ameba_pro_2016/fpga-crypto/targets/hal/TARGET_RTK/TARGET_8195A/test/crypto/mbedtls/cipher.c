    ...
    *olen = 0;
    ...
    if( ctx->cipher_info->mode == MBEDTLS_MODE_GCM ) {
        *olen = ilen;
        ...
        mbedtls_printf("%s : return ret=0x%x \r\n", __FUNCTION__, ret);
        return ret;
    }
#endif
