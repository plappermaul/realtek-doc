...
typedef void  (nand_spi_page_read_write_t)(void *dma_addr, u32_t blk_pge_addr);
...
typedef int   (nand_spi_page_read_ecc_t)(void *dma_addr, u32_t blk_pge_addr, void *p_eccbuf);
typedef void  (nand_spi_page_write_ecc_t)(void *dma_addr, u32_t blk_pge_addr, void *p_eccbuf);
typedef void  (nand_spi_ecc_encode_t)(void *dma_addr, void *p_eccbuf);
typedef int (nand_spi_ecc_decode_t)(void *dma_addr, void *p_eccbuf);
...
struct plr_nand_spi_info_s {
	...
	nand_spi_page_read_write_t *_page_read;
	nand_spi_page_read_write_t *_page_write;
	nand_spi_dma_read_write_t   *_dma_read;
	nand_spi_dma_read_write_t   *_dma_write;
	nand_spi_page_read_ecc_t    *_page_read_ecc;
	nand_spi_page_write_ecc_t   *_page_write_ecc;
