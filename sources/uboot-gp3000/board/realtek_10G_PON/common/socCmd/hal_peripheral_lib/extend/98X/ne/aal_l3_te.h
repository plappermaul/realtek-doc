#ifndef __AAL_L3_TE_H__
#define __AAL_L3_TE_H__

#include "ca_types.h"

#if defined(CONFIG_ARCH_CORTINA_G3)
#define CA_AAL_L3_WRED_MAX_PORT_ID 48 /* 8 NI + 8 CPU_64Q + 32 CPU_256Q */
#else
#define CA_AAL_L3_WRED_MAX_PORT_ID 16 /* 8 NI + 8 CPU_64Q */
#endif

/**********************************************
**               TE_PM_CTRL
** address selection on counter memory x
** 0: entry 0-511 is for flows
**    entry 512-519 is for aggregate flows
**    entry 768-775 is for source ports
**    entry 784-791 is for packet types
**    other entries are invalid.
** 1: entry 0-127 is for VOQs
**    entry 256-511 is for CPU256Q
**    entry 512-519 is for aggregate flows
**    entry 768-783 is for destination ports
**    entry 784-791 is for packet types
**    other entries are invalid.
***********************************************/

#if defined(CONFIG_ARCH_CORTINA_G3LITE) || defined(CONFIG_ARCH_CORTINA_SATURN_SFU)
#define CA_AAL_L3_TE_PM_MEM_BLOCK_SIZE 256 /* total 512, mem0 = 256, mem1 = 256  */

#define CA_AAL_L3_TE_POL_PM_FLOW_OFFSET 0
#define CA_AAL_L3_TE_POL_PM_AGR_FLOW_OFFSET 128
#define CA_AAL_L3_TE_POL_PM_SRC_PORT_OFFSET 192
#define CA_AAL_L3_TE_POL_PM_PKT_TYPE_OFFSET 208
#else
#define CA_AAL_L3_TE_PM_MEM_BLOCK_SIZE 1024 /* total 2K, mem0 = 1K, mem1 = 1K  */

#define CA_AAL_L3_TE_POL_PM_FLOW_OFFSET 0
#define CA_AAL_L3_TE_POL_PM_AGR_FLOW_OFFSET 512
#define CA_AAL_L3_TE_POL_PM_SRC_PORT_OFFSET 768
#define CA_AAL_L3_TE_POL_PM_PKT_TYPE_OFFSET 784
#endif

#define CA_AAL_L3_TE_NI_PORT_OFFSET 8 /* CPU: 0 ~ 7, NI: 8 ~ 15 */
...
typedef union
{
    struct
    {
        ...
        ca_uint32_t l2_tail_drop_ena : 1;
...
typedef struct
{
    ...
    ca_boolean_t l2_tail_drop_ena;     /* tail drop enable in L2 to L3QM path */
}aal_l3_te_glb_cfg_t;
...
typedef enum
{
    CA_AAL_L3_SHAPER_ADMIN_STATE_FORWARD = 0,  /* always forward packets */
    CA_AAL_L3_SHAPER_ADMIN_STATE_DROP,         /* always drop packets    */
    CA_AAL_L3_SHAPER_ADMIN_STATE_SHAPER,       /* normal shaper limit    */
    CA_AAL_L3_SHAPER_ADMIN_STATE_TBC_WRITABLE,
    CA_AAL_L3_SHAPER_STATE_END,
}aal_l3_te_shaper_admin_state_t;

typedef enum
{
    CA_AAL_L3_SHAPER_MODE_BPS = 0,        /* byte(octet) mode */
    CA_AAL_L3_SHAPER_MODE_PPS,            /* packet mode      */
    CA_AAL_L3_SHAPER_MODE_END,
}aal_l3_te_shaper_counting_mode_t;

typedef enum
{
    CA_AAL_L3_SHAPER_TBC_PKT_MODE_CLASS0 = 0,
    CA_AAL_L3_SHAPER_TBC_PKT_MODE_CLASS1,
    CA_AAL_L3_SHAPER_TBC_PKT_MODE_END,
}aal_l3_te_shaper_tbc_pkt_mode_t;
...
typedef union
{
    ...
    ca_uint32_t        u32;
}aal_l3_te_shaper_tbc_cfg_msk_t;

typedef struct
{
    ca_uint16_t rate_k;                        /* VoQ          : in kbps or pps, range 0 ~ 499 */
                                               /* port & group : in unit of 500kbps or 500 pps */
    ...
    aal_l3_te_shaper_admin_state_t   state;     /* state                                        */
    aal_l3_te_shaper_counting_mode_t mode;      /* token counting mode, pps or bps              */
    ca_uint32_t tbc_count;                      /* token bucket count, MSB bit is sign bit, 1 : positive value, 0 : negative value */
    aal_l3_te_shaper_tbc_pkt_mode_t  pkt_mode;  /* 0 : packet mode class 0, 1 : packet mode class 1 */
}aal_l3_te_shaper_tbc_cfg_t;
...
#define CA_AAL_L3_TE_SHP_MAX_RATE_M     0xffff
#define CA_AAL_L3_TE_SHP_MAX_RATE_K     0x3ff   /* 999 port and group shaper, the valid value is 0 ~ 999 */
#define CA_AAL_L3_TE_SHP_MAX_RATE_K_VOQ 0x3ff   /* 499 VoQ based shaper, rate in Kilobits per second or packet per second and the valid value is 0 ~ 499 */
#define CA_AAL_L3_TE_SHP_MAX_BS         0xfff

typedef enum
{
    CA_AAL_L3_SHAPER_SRP_CLASS_A = 0,
    CA_AAL_L3_SHAPER_SRP_CLASS_B,
    CA_AAL_L3_SHAPER_SRP_CLASS_END
}aal_l3_te_shaper_srp_class_t;
...
typedef union
{
    ...
    ca_uint32_t        u32;
}aal_l3_te_shaper_srp_cfg_msk_t;

typedef struct
{
    ca_boolean_t ena;
    ca_uint16_t  cos;                        /* SRP COS, range 0 ~ 7  */
    aal_l3_te_shaper_srp_class_t class_type; /* SRP class A or B      */
}aal_l3_te_shaper_srp_cfg_t;
...
(
    ...
    CA_IN aal_l3_te_shaper_tbc_cfg_msk_t msk,
    CA_IN aal_l3_te_shaper_tbc_cfg_t     *cfg
);
...
(
    CA_IN  ca_device_id_t                device_id,
    CA_IN  ca_uint32_t                voq_id,
    CA_OUT aal_l3_te_shaper_tbc_cfg_t *cfg
);
...
#define CA_AAL_L3_TE_POL_MAX_RATE_M 0xffff
#define CA_AAL_L3_TE_POL_MAX_RATE_K 0x3ff /* 999 */
#define CA_AAL_L3_TE_POL_MAX_CBS    0xfff
#define CA_AAL_L3_TE_POL_MAX_PBS    0xfff
...
typedef enum
{
    CA_AAL_L3_POLICER_PKT_TYPE_UC = 0,
    CA_AAL_L3_POLICER_PKT_TYPE_MC,
    CA_AAL_L3_POLICER_PKT_TYPE_BC,
    CA_AAL_L3_POLICER_PKT_TYPE_UUC,
    CA_AAL_L3_POLICER_PKT_TYPE_UMC,
    CA_AAL_L3_POLICER_PKT_TYPE_UBC,
    CA_AAL_L3_POLICER_PKT_TYPE_RSV1,
    CA_AAL_L3_POLICER_PKT_TYPE_RSV2,
    CA_AAL_L3_POLICER_PKT_TYPE_END = 16,
}aal_l3_te_policer_pkt_type_t;
...
typedef enum
{
    CA_AAL_L3_POLICER_GRP_MAP_TYPE_A = 0,
    CA_AAL_L3_POLICER_GRP_MAP_TYPE_B,
    CA_AAL_L3_POLICER_GRP_MAP_TYPE_C,
    CA_AAL_L3_POLICER_GRP_MAP_TYPE_D,
    CA_AAL_L3_POLICER_GRP_MAP_TYPE_END = 4, /* CA_AAL_L3_POLICER_GRP_MAP_TYPE_D , */
}aal_l3_te_policer_grp_map_type_t;
...
typedef union
{
    ...
    ca_uint32_t        u32;
}aal_l3_te_policer_profile_msk_t;
...
typedef union
{
    ...
    ca_uint32_t        u32;
}aal_l3_tm_token_bucket_cfg_msk_t;
...
typedef enum
{
    CA_AAL_L3_POLICER_TYPE_NONE = 0,   /* disable                                                                 */
    CA_AAL_L3_POLICER_TYPE_RFC2698,    /* two rate three color marker                                             */
    CA_AAL_L3_POLICER_TYPE_RFC2697,    /* single rate three color marker                                          */
    CA_AAL_L3_POLICER_TYPE_RFC4115,    /* differentiated two rate three color marker                              */
    CA_AAL_L3_POLICER_TYPE_RFC4115_EX, /* rfc 4115 with token coupling, CIR overflow token are added to EIR token */
}aal_l3_te_policer_type_t;

typedef enum
{
    CA_AAL_L3_POLICER_UPDATE_MODE_BYTE = 0,   /* byte(octet) mode  */
    CA_AAL_L3_POLICER_UPDATE_MODE_PKT,        /* packet based mode */
}aal_l3_te_policer_update_mode_t;

typedef enum
{
    CA_AAL_L3_POLICER_PKT_LEN_INGRESS = 0,
    CA_AAL_L3_POLICER_PKT_LEN_EGRESS,
}aal_l3_te_policer_pkt_len_set_t;

typedef enum
{
    CA_AAL_L3_POLICER_RESULT_UPDATE_MODE_NESTED_LEVEL_COLOR = 0,   /* use policer result color and nested level result color */
    CA_AAL_L3_POLICER_RESULT_UPDATE_MODE_COLOR,                    /* use policer result color */
}aal_l3_te_policer_result_update_mode_t;
...
typedef union
{
    ...
    ca_uint32_t        u32;
}aal_l3_te_policer_cfg_msk_t;


typedef struct
{
    aal_l3_te_policer_type_t        type;
    ca_boolean_t                    color_blind;     /* TRUE : color blind; FALSE : color aware */
    aal_l3_te_policer_update_mode_t pol_update_mode;
    aal_l3_te_policer_pkt_len_set_t pkt_len_sel;
    ...
    aal_l3_te_policer_result_update_mode_t result_update_mode;
    ca_uint8_t                      nest_level;      /* 0 ~ 3 */
}aal_l3_te_policer_cfg_t;

ca_status_t aal_l3_te_policer_pkt_type_cfg_set
(
    CA_IN ca_device_id_t                  device_id,
    CA_IN aal_l3_te_policer_pkt_type_t pkt_type,
    CA_IN aal_l3_te_policer_cfg_msk_t  msk,
    CA_IN aal_l3_te_policer_cfg_t      *cfg
);
...
(
    CA_IN  ca_device_id_t                  device_id,
    CA_IN  aal_l3_te_policer_pkt_type_t pkt_type,
    CA_OUT aal_l3_te_policer_cfg_t      *cfg
);
...
(
    CA_IN ca_device_id_t                     device_id,
    CA_IN aal_l3_te_policer_pkt_type_t    pkt_type,
    CA_IN aal_l3_te_policer_profile_msk_t msk,
    CA_IN aal_l3_te_policer_profile_t     *cfg
);
...
(
    CA_IN  ca_device_id_t                  device_id,
    CA_IN  aal_l3_te_policer_pkt_type_t pkt_type,
    CA_OUT aal_l3_te_policer_profile_t  *cfg
);
...
(
    CA_IN  ca_device_id_t               device_id,
    CA_IN  ca_flow_id_t              flow_id,
    CA_OUT aal_l3_te_policer_stats_t *stats
);
...
(
    ...
    CA_IN aal_l3_te_policer_grp_map_type_t grp_map_type,
    CA_IN aal_l3_te_policer_profile_msk_t  msk,
    CA_IN aal_l3_te_policer_profile_t      *cfg
);
...
#define CA_AAL_L3_WRED_MAX_PROFILE_SEL_ID  0x7f
#define CA_AAL_L3_WRED_MAX_PROFILE_ID      0x1f
#define CA_AAL_L3_WRED_MAX_PROFILE_NUMS    0x20
#define CA_AAL_L3_WRED_MAX_DROP_PROBABILTY 16
...
typedef union
{
    ...
    ca_uint32_t        u32;
}aal_l3_te_wred_profile_msk_t;

typedef struct
{
    ca_uint32_t unmark_dp[CA_AAL_L3_WRED_MAX_DROP_PROBABILTY];          /* 6 bits, drop probability */
    ca_uint32_t mark_dp[CA_AAL_L3_WRED_MAX_DROP_PROBABILTY];            /* 6 bits, drop probability */
...
}aal_l3_te_wred_profile_t;

typedef struct
{
    ca_uint32_t ref_counter;
    ca_uint32_t marked_dp[CA_AAL_L3_WRED_MAX_DROP_PROBABILTY];
    ca_uint32_t unmarked_dp[CA_AAL_L3_WRED_MAX_DROP_PROBABILTY];
}aal_l3_te_wred_info_t;
...
(
    ...
    CA_IN aal_l3_te_wred_profile_msk_t msk,
    CA_IN aal_l3_te_wred_profile_t     *profile
);
...
(
    CA_IN  ca_device_id_t              device_id,
    CA_IN  ca_uint32_t              id,
    CA_OUT aal_l3_te_wred_profile_t *profile
);
...
(
    CA_IN ca_device_id_t                      device_id,
    CA_IN ca_uint32_t                      id,
    CA_IN aal_l3_te_wred_profile_sel_msk_t msk,
    CA_IN aal_l3_te_wred_profile_sel_t     *sel
);
...
(
    CA_IN  ca_device_id_t                  device_id,
    CA_IN  ca_uint32_t                  id,
    CA_OUT aal_l3_te_wred_profile_sel_t *sel
);
...
ca_boolean aal_l3_te_wred_info_empty
(/*CODEGEN_IGNORE_TAG*/
void
);
...
ca_uint32_t aal_l3_te_wred_profile_info_ref_counter_get
(/*CODEGEN_IGNORE_TAG*/
    CA_IN ca_uint32_t index
);

void aal_l3_te_wred_profile_info_ref_inc
(/*CODEGEN_IGNORE_TAG*/
    CA_IN ca_uint32_t index
);

void aal_l3_te_wred_profile_info_ref_dec
(/*CODEGEN_IGNORE_TAG*/
    CA_IN ca_uint32_t index
);
...
}aal_l3_te_pm_stats_t;

typedef struct
{
    ca_uint8_t pkt_cnt0_init_done;    /* packet counter 0/1 mem init done */
    ca_uint8_t pkt_cnt1_init_done;
    ca_uint8_t byte_cnt0_init_done;   /* byte counter 0/1 mem init done   */
    ca_uint8_t byte_cnt1_init_done;
}aal_l3_te_pm_status_t;


/*
** L3 TE policer counter
*/
typedef struct
{
...
}aal_l3_te_pm_egress_t;


#ifdef __L3_TE_PIE
#endif

#define CA_AAL_L3_PIE_MAX_VOQ 0xf               /* pie voq range is from 0 to 15 */
...
typedef union
{
    ...
    ca_uint32_t        u32;
}aal_l3_te_pie_lpid_qos_voq_msk_t;

typedef struct
{
    ca_boolean_t ena;
    ca_uint32_t  voq;   /* pie voq, range is from 0 to 15 */
}aal_l3_te_pie_lpid_qos_voq_t;

/* dp scaling configurations */
typedef union
{
    struct
    {
#ifdef CS_BIG_ENDIAN
        ca_uint32_t f_rsvd  :30;
        ca_uint32_t value_b :1;
        ca_uint32_t value_a :1;
#else
        ca_uint32_t value_a :1;
        ca_uint32_t value_b :1;
        ca_uint32_t f_rsvd  :30;
    ...
    ca_uint32_t        u32;
}aal_l3_te_pie_dp_scaling_msk_t;

typedef struct
{
    ca_uint32_t value_a;
    ca_uint32_t value_b;
}aal_l3_te_pie_dp_scaling_t;
...
typedef union
{
...
#ifdef CS_BIG_ENDIAN
        ca_uint32_t f_rsvd               :26;
        ca_uint32_t peak_rate            :1;
        ca_uint32_t max_service_rate     :1;
        ca_uint32_t latency_target       :1;
        ca_uint32_t latency_threshold_lo :1;
        ca_uint32_t latency_threshold_hi :1;
        ca_uint32_t burst_reset_timeout  :1;
#else
        ca_uint32_t burst_reset_timeout  :1;
        ca_uint32_t latency_threshold_hi :1;
        ca_uint32_t latency_threshold_lo :1;
    ...
    ca_uint32_t        u32;
}aal_l3_te_pie_dp_msk_t;

typedef struct
{
    ca_uint32_t burst_reset_timeout;   /* burst reset timeout value in terms of interval value us of timer for voq map 0 */
    ca_uint32_t latency_threshold_hi;  /* latency threshold high setting */
    ca_uint32_t latency_threshold_lo;  /* latency threshold low setting  */
    ca_uint32_t latency_target;        /* latency target to meet to active random drops */
    ca_uint32_t max_service_rate;
    ca_uint32_t peak_rate;
}aal_l3_te_pie_dp_cfg_t;
...
typedef union
{
...
#ifdef CS_BIG_ENDIAN
        ca_uint32_t f_rsvd    :29;
        ca_uint32_t burst_dec :1;
        ca_uint32_t interval  :1;
        ca_uint32_t scalar    :1;
#else
        ca_uint32_t scalar    :1;
        ca_uint32_t interval  :1;
        ca_uint32_t burst_dec :1;
    ...
    ca_uint32_t        u32;
}aal_l3_te_pie_timer_msk_t;

typedef struct
{
    ca_uint32_t scalar;     /* timer prescaler */
    ca_uint32_t interval;   /* rate = interval * (prescalar + 1) / 333.33Mhz */
    ca_uint32_t burst_dec;  /* This is the decrement value for the burst counter on each interval
                            ** should be set to the interval time, so if it fires every 10us this
                            ** should have a 10 */
}aal_l3_te_pie_timer_cfg_t;
...
typedef union
{
    struct
    {
        ...
        ca_uint32_t f_rsvd         :27;
        ca_uint32_t burst          :1;
        ca_uint32_t threshold      :1;
        ca_uint32_t random_disable :1;
        ca_uint32_t low            :1;
        ca_uint32_t high           :1;
#else
        ca_uint32_t high           :1;
    ...
    ca_uint32_t        u32;
}aal_l3_te_pie_dp_glb_msk_t;

typedef struct
{
    ca_uint32_t  high;              /* high threshold for drop probability */
    ca_uint32_t  low;               /* low threshold for drop probability  */
    ca_boolean_t random_disable;    /* turn on or off drop probability random probability, when off not random;
                                    ** for initial sanity testing we can get more determinatic returns without
                                    ** randomization; for real testing this should be set to 0.
                                    ** If set to 1, then you must set en3_drop_prob_threshold to the threshold
                                    ** to drop instead of the LFSR value.
                                    */
    ca_uint32_t  threshold;         /* drop probability threshold when random_disable is set */
    ca_uint32_t  burst;             /* max burst time allowed, Time to ignore the maximum burst when we are in ACTIVE state
                                    ** Set to 142ms in the standard but we will set the burst time small for default simulation.
                                    */
}aal_l3_te_pie_dp_glb_cfg_t;


#ifdef __TE_FUNC_DECLARATIONS
#endif
...
(
    CA_IN  ca_device_id_t           device_id,
    CA_OUT aal_l3_te_pm_status_t *status
);

ca_status_t aal_l3_te_pm_stats_get
(
    CA_IN  ca_device_id_t          device_id,
    CA_OUT aal_l3_te_pm_stats_t *stats
);

ca_status_t aal_l3_te_pie_lpid_qos_voq_set
(
    CA_IN ca_device_id_t                   device_id,
    CA_IN ca_port_id_t                     lpid,
    CA_IN ca_uint32_t                      cos,
    CA_IN aal_l3_te_pie_lpid_qos_voq_msk_t msk,
    CA_IN aal_l3_te_pie_lpid_qos_voq_t     *cfg
);
...
(
    ...
    CA_IN  ca_port_id_t                 lpid,
    CA_IN  ca_uint32_t                  cos,
    CA_OUT aal_l3_te_pie_lpid_qos_voq_t *cfg
);
...
(
    CA_IN ca_device_id_t                 device_id,
    CA_IN aal_l3_te_pie_dp_scaling_msk_t msk,
    CA_IN aal_l3_te_pie_dp_scaling_t     *value
);

ca_status_t aal_l3_te_pie_dp_scaling_get
(
    CA_IN  ca_device_id_t             device_id,
    CA_OUT aal_l3_te_pie_dp_scaling_t *value
);

ca_status_t aal_l3_te_pie_dp_ceiling_set
(
    CA_IN ca_device_id_t device_id,
    CA_IN ca_uint32_t    ceiling
);

ca_status_t aal_l3_te_pie_dp_ceiling_get
(
    CA_IN  ca_device_id_t device_id,
    CA_OUT ca_uint32_t    *ceiling
);

ca_status_t aal_l3_te_pie_dp_cfg_set
(
    CA_IN ca_device_id_t         device_id,
    CA_IN ca_uint32_t            pie_voq_id,
    CA_IN aal_l3_te_pie_dp_msk_t msk,
    CA_IN aal_l3_te_pie_dp_cfg_t *cfg
);
...
(
    CA_IN  ca_device_id_t         device_id,
    CA_IN  ca_uint32_t            pie_voq_id,
    CA_OUT aal_l3_te_pie_dp_cfg_t *cfg
);

ca_status_t aal_l3_te_pie_timer_set
(
    CA_IN ca_device_id_t            device_id,
    CA_IN aal_l3_te_pie_timer_msk_t msk,
    CA_IN aal_l3_te_pie_timer_cfg_t *cfg
);

ca_status_t aal_l3_te_pie_timer_get
(
    CA_IN  ca_device_id_t            device_id,
    CA_OUT aal_l3_te_pie_timer_cfg_t *cfg
);

ca_status_t aal_l3_te_pie_dp_qfull_set
(
    CA_IN ca_device_id_t device_id,
    CA_IN ca_uint32_t    threshold
);

ca_status_t aal_l3_te_pie_dp_qfull_get
(
    CA_IN  ca_device_id_t device_id,
    CA_OUT ca_uint32_t    *threshold
);

ca_status_t aal_l3_te_pie_dp_glb_cfg_set
(
    CA_IN ca_device_id_t             device_id,
    CA_IN aal_l3_te_pie_dp_glb_msk_t msk,
    CA_IN aal_l3_te_pie_dp_glb_cfg_t *cfg
);

ca_status_t aal_l3_te_pie_dp_glb_cfg_get
(
    CA_IN  ca_device_id_t             device_id,
    CA_OUT aal_l3_te_pie_dp_glb_cfg_t *cfg
);
