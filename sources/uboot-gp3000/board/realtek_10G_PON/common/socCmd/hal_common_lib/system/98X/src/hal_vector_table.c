...
//#ifdef CONFIG_KERNEL
    ...
    NewVectorTable[31] = (HAL_VECTOR_FUN) HalWLXXX0IntrHandle;
    NewVectorTable[32] = (HAL_VECTOR_FUN) HalWLXXX1IntrHandle;
    NewVectorTable[33] = (HAL_VECTOR_FUN) HalWLXXX2IntrHandle;
    NewVectorTable[34] = (HAL_VECTOR_FUN) HalWLXXX3IntrHandle;
    ...
    NVIC_SetVectorTable(((u32)(NewVectorTable) << 7)|0x20000000);
...
{ 
    ...
    irq_install_handler(pIrqHandle->IrqNum,pIrqHandle->IrqFun, (u32)(pIrqHandle->Data));
...
)
{
    ...
    irq_install_handler(pIrqHandle->IrqNum,NULL, NULL);
...
{    
    enable_irq_handler(pIrqHandle->IrqNum);
...
)
{
    ...
    disable_irq_handler(pIrqHandle->IrqNum);
