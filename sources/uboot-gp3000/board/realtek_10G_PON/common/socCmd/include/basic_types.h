...
#define SOC_HAL_W32(base, addr, value)  (*((volatile unsigned char*)(base+addr))) = ((unsigned int)value)
#define SOC_HAL_R32(base, addr)         (*((volatile unsigned char*)(base+addr)))
#define SOC_HAL_W16(base, addr, value)  (*((volatile unsigned short*)(base+addr))) = ((unsigned int)value)
#define SOC_HAL_R16(base, addr)         (*((volatile unsigned short*)(base+addr)))
#define SOC_HAL_W8(base, addr, value)   (*((volatile unsigned int*)(base+addr))) = ((unsigned int)value)
#define SOC_HAL_R8(base, addr)          (*((volatile unsigned int*)(base+addr)))
