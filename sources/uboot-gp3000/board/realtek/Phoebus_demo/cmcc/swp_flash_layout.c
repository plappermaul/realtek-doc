...
#else
#define SWP_FL_256MB_R_SIZE 	(24064*1024)
#define SWP_FL_256MB_K1_BASE	(SWP_FL_256MB_R0_BASE+SWP_FL_256MB_R_SIZE)
#define SWP_FL_256MB_R1_BASE	(SWP_FL_256MB_K1_BASE+SWP_FL_256MB_K_SIZE)
#define SWP_FL_256MB_OSGI_SIZE	 (48*1024*1024)
#define SWP_FL_256MB_OSGI_BASE	 (SWP_FL_256MB_R1_BASE+SWP_FL_256MB_R_SIZE)
#define SWP_FL_256MB_APP_SIZE	(128*1024*1024)
#define SWP_FL_256MB_APP_BASE	 (SWP_FL_256MB_OSGI_BASE+SWP_FL_256MB_OSGI_SIZE)
#endif
#if defined(CONFIG_RTK_USE_ONE_UBI_DEVICE)
#ifdef CONFIG_STATIC_CONFIG
...
#ifndef CONFIG_RTK_USE_ONE_UBI_DEVICE
		part_info[SWP_FL_OSGI].base = SWP_FL_256MB_OSGI_BASE;
#endif
...
addSingleUbiDeviceBoot(void)
{
	...
	/* boot */
#ifdef CONFIG_SUPPORT_BOARDID
	env_set("setmoreargs", "setenv more_args ubi.mtd=${ubi_mtd} root=${root_mtd} rootfs=squashfs boot_boardid=${bootargs_boardid}");
#else
...
void swp_otto_flash_layout_init(void)
{
...
#ifndef CONFIG_RTK_USE_ONE_UBI_DEVICE
	env_set_hex("fl_osgi", part_info[SWP_FL_OSGI].base);
	env_set_hex("fl_osgi_sz", part_info[SWP_FL_OSGI].size);
#endif
#ifdef CONFIG_LUNA_MULTI_BOOT
	...
	env_set("erase_app", "nand erase ${fl_app} ${fl_app_sz}");
#endif
#ifdef CONFIG_OTTO_FL_TO_MTDPARTS
    char str_tmp[256] = {0};
