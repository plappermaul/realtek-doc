...
extern int soc_ramtest_init(unsigned int start,unsigned int size,int flags);
...
extern u32_t uboot_size;
extern char preloader_sram_start;
extern u32_t preloader_sram_size;
extern char preloader_bss_start;
extern u32_t preloader_bss_size;
