...
typedef struct dal_mapper_s {
    ...
    int32   (*l2_addr_delByMac)(uint32, rtk_mac_t *);
    ...
    int32   (*l3_vrrp_add)(uint32, rtk_vlan_t, uint32);
    int32   (*l3_vrrp_del)(uint32, rtk_vlan_t, uint32);
    int32   (*l3_vrrp_delAll)(uint32, rtk_vlan_t);
    int32   (*l3_vrrp_get)(uint32, rtk_vlan_t, uint32, uint32 *, uint32 *);
