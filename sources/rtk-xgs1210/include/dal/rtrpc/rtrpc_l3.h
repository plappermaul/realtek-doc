...
extern int32
rtrpc_l3_vrrp_add(uint32 unit, rtk_vlan_t vid, uint32 vrId);

extern int32
rtrpc_l3_vrrp_del(uint32 unit, rtk_vlan_t vid, uint32 vrId);

extern int32
rtrpc_l3_vrrp_delAll(uint32 unit, rtk_vlan_t vid);

extern int32
rtrpc_l3_vrrp_get(uint32 unit, rtk_vlan_t vid, uint32 vrIdArraySize, uint32 *pVrIdArray, uint32 *pVrIdCount);
