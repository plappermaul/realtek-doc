 ...
 *
 * $Revision: 97780 $
 * $Date: 2019-06-17 21:37:55 +0800 (Mon, 17 Jun 2019) $
 *
 ...
 *      None
 */
int32 phy_rtl9310_serdes_mode_get(uint32 unit, uint32 sdsId, rt_serdesMode_t *mode);

/* Function Name:
 *      phy_rtl9310_serdes_mode_set
 * Description:
 *      Set 9310 serdes mode.
 * Input:
 *      unit     - unit id
 ...
 *      None
 */
int32  phy_rtl9310_serdes_mode_set(uint32 unit, uint32 sdsId, rt_serdesMode_t mode);
