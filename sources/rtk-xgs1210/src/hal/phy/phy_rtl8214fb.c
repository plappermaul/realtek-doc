...
phy_8214fb_eeeEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    ...
    phy_osal_time_usleep(1000 * 1000); /* delay 1000mS */
...
phy_8214fb_ieeeTestMode_set(uint32 unit, rtk_port_t port, rtk_port_phyTestMode_t *pTestMode)
{
    ...
    phy_osal_printf("RTL8214FB/RTL8214B/RTL8212B Test Mode (PHYID: %u)\n", port);
      ...
      case 1:
        {
            ...
            phy_osal_time_mdelay(100);	 /* delay 100mS and wait for Mirco-P completed */
            /* Adjust Amplitude */
