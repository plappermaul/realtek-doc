...
_phy_8218d_sdsSts_dump(uint32 unit, rtk_port_t port)
{
    ...
    phy_osal_printf("unit %u port %u sds sts\n", unit, port);
    phy_osal_printf("  0x407,0x15=0x%x\n", data);
    phy_osal_printf("  0x507,0x15=0x%x\n", data1);
    phy_osal_printf("  0x407,0x16=0x%x\n", data2);
    phy_osal_printf("  0x507,0x16=0x%x\n", data3);
...
_phy_8218d_tap0_dump(uint32 unit, rtk_port_t port)
{
    ...
    phy_osal_printf("unit %u port %u tap0=0x%x\n", unit, port, data);
...
_phy_8218d_vth_dump(uint32 unit, rtk_port_t port)
{
    ...
    phy_osal_printf("unit %u port %u vth=0x%x\n", unit, port, data);
...
_phy_8218d_tap1_dump(uint32 unit, rtk_port_t port)
{
    ...
    phy_osal_printf("unit %u port %u tap1=0x%X, 0x%X\n", unit, port, data, data1);
...
_phy_8218d_sdsSymErr_dump(uint32 unit, rtk_port_t port)
{
    ...
    hal_miim_read(unit, port, 0x504, 0x10, &data);
    hal_miim_read(unit, port, 0x504, 0x11, &data1);

    hal_miim_write(unit, port, 0, 30, blk);

    phy_osal_printf("unit %u port %u serdes sym-err\n", unit, port);
    phy_osal_printf("  0x504,0x10=0x%x\n", data);
    phy_osal_printf("  0x504,0x11=0x%x\n", data1);
...
_phy_8218d_sdsLeq_dump(uint32 unit, rtk_port_t port)
{
    ...
    phy_osal_printf("unit %u port %u LEQ\n", unit, port);
    phy_osal_printf("  0x47D,0x15=0x%x\n", data);
...
_phy_8218d_diag_dump(uint32 unit, uint32 port)
{
    ...
    {
        phy_osal_printf("_phy_8218d_sdsSts_dump Error:0x%x\n", ret);
    }

    if ((ret = _phy_8218d_sdsSymErr_dump(unit, port)) != RT_ERR_OK)
    {
        phy_osal_printf("_phy_8218d_sdsSymErr_dump Error:0x%x\n", ret);
    }

    if ((ret = _phy_8218d_sdsLeq_dump(unit, port)) != RT_ERR_OK)
    {
        phy_osal_printf("_phy_8218d_sdsLeq_dump Error:0x%x\n", ret);
    }

    if ((ret = _phy_8218d_tap0_dump(unit, port)) != RT_ERR_OK)
    {
        phy_osal_printf("_phy_8218d_tap0VthTap1_dump Error:0x%x\n", ret);
    }

    if ((ret = _phy_8218d_vth_dump(unit, port)) != RT_ERR_OK)
    {
        phy_osal_printf("_phy_8218d_vth_dump Error:0x%x\n", ret);
    }

    if ((ret = _phy_8218d_tap1_dump(unit, port)) != RT_ERR_OK)
    {
        phy_osal_printf("_phy_8218d_tap1_dump Error:0x%x\n", ret);
    }
    return RT_ERR_OK;
}
