 ...
 *
 * $Revision: 75608 $
 * $Date: 2017-02-06 16:13:35 +0800 (Mon, 06 Feb 2017) $
 *
 ...
 */
int32
dal_longan_ledMapper_init(dal_mapper_t *pMapper)
{
    pMapper->led_init = dal_longan_led_init;
    pMapper->led_sysEnable_get = dal_longan_led_sysEnable_get;
    pMapper->led_sysEnable_set = dal_longan_led_sysEnable_set;
    pMapper->led_portLedEntitySwCtrlEnable_get = dal_longan_led_portLedEntitySwCtrlEnable_get;
    pMapper->led_portLedEntitySwCtrlEnable_set = dal_longan_led_portLedEntitySwCtrlEnable_set;
    pMapper->led_swCtrl_start = dal_longan_led_swCtrl_start;
    pMapper->led_portLedEntitySwCtrlMode_get = dal_longan_led_portLedEntitySwCtrlMode_get;
    pMapper->led_portLedEntitySwCtrlMode_set = dal_longan_led_portLedEntitySwCtrlMode_set;
    pMapper->led_sysMode_get = dal_longan_led_sysMode_get;
    pMapper->led_sysMode_set = dal_longan_led_sysMode_set;
    pMapper->led_blinkTime_get = dal_longan_led_blinkTime_get;
    pMapper->led_blinkTime_set = dal_longan_led_blinkTime_set;
 ...
 */
int32
dal_longan_led_init(uint32 unit)
{
    ...
    return RT_ERR_OK;
} /* end of dal_longan_led_init */


/* Function Name:
 *      dal_longan_led_portLedEntitySwCtrlEnable_get
 * Description:
    ...
    rtk_enable_t    *pEnable)
{
    ...
    ret = reg_array_field_read(unit, LONGAN_LED_PORT_SW_EN_CTRLr, port, REG_ARRAY_INDEX_NONE, LONGAN_SW_CTRL_LED_ENf, &value);
    if (RT_ERR_OK != ret)
    {
        LED_SEM_UNLOCK(unit);
    ...
    return RT_ERR_OK;
} /* end of dal_longan_led_portLedEntitySwCtrlEnable_get */

/* Function Name:
 *      dal_longan_led_portLedEntitySwCtrlEnable_set
 * Description:
    ...
    rtk_enable_t    enable)
{
    ...
    ret = reg_array_field_write(unit, LONGAN_LED_PORT_SW_EN_CTRLr, port, REG_ARRAY_INDEX_NONE, LONGAN_SW_CTRL_LED_ENf, &value);
    if (RT_ERR_OK != ret)
    {
        LED_SEM_UNLOCK(unit);
        RT_ERR(ret, (MOD_DAL|MOD_LED), "");
    ...
    return RT_ERR_OK;
} /* end of dal_longan_led_portLedEntitySwCtrlEnable_set */

/* Function Name:
 *      dal_longan_led_portLedEntitySwCtrlMode_get
 * Description:
    ...
    rtk_led_swCtrl_mode_t   *pMode)
{
    ...
    ret = reg_array_field_read(unit, LONGAN_LED_PORT_SW_CTRLr, port, REG_ARRAY_INDEX_NONE, field, &value);
    if (RT_ERR_OK != ret)
    {
        LED_SEM_UNLOCK(unit);
        RT_ERR(ret, (MOD_DAL|MOD_LED), "");
    ...
    return RT_ERR_OK;
} /* end of dal_longan_led_portLedEntitySwCtrlMode_get */

/* Function Name:
 *      dal_longan_led_portLedEntitySwCtrlMode_set
 * Description:
    ...
    rtk_led_swCtrl_mode_t   mode)
{
    ...
    ret = reg_array_field_write(unit, LONGAN_LED_PORT_SW_CTRLr, port,
    ...
    return RT_ERR_OK;
} /* end of dal_longan_led_portLedEntitySwCtrlMode_set */

/* Function Name:
 *      dal_longan_led_swCtrl_start
 * Description:
 ...
 */
int32
dal_longan_led_swCtrl_start(uint32 unit)
{
    uint32  value;
    int32   ret = RT_ERR_FAILED;
    ...
    ret = reg_field_write(unit, LONGAN_SW_LED_LOADr, LONGAN_SW_LED_LOADf,
            &value);
    if (RT_ERR_OK != ret)
    {
        LED_SEM_UNLOCK(unit);
    ...
    return RT_ERR_OK;
}   /* end of dal_longan_led_swCtrl_start */

/* Function Name:
 *      dal_longan_led_sysMode_get
 * Description:
 ...
 */
int32
dal_longan_led_sysMode_get(uint32 unit, rtk_led_swCtrl_mode_t *pMode)
{
    uint32  action;
    int32   ret = RT_ERR_FAILED;
    ...
    ret = reg_field_read(unit, LONGAN_LED_GLB_CTRLr, LONGAN_SYS_LED_MODEf,
            &action);
    if (RT_ERR_OK != ret)
    {
        LED_SEM_UNLOCK(unit);
    ...
    return RT_ERR_OK;
} /* end of dal_longan_led_sysMode_get */

/* Function Name:
 *      dal_longan_led_sysMode_set
 * Description:
 ...
 */
int32
dal_longan_led_sysMode_set(uint32 unit, rtk_led_swCtrl_mode_t mode)
{
    uint32  action;
    int32   ret = RT_ERR_INPUT;
    ...
    ret = reg_field_write(unit, LONGAN_LED_GLB_CTRLr, LONGAN_SYS_LED_MODEf,
            &action);
    if (RT_ERR_OK != ret)
    {
        LED_SEM_UNLOCK(unit);
    ...
    return RT_ERR_OK;
} /* end of dal_longan_led_sysMode_set */

/* Function Name:
 *      dal_longan_led_sysEnable_get
 * Description:
 ...
 */
int32
dal_longan_led_sysEnable_get(uint32 unit, rtk_led_type_t type, rtk_enable_t *pEnable)
{
    uint32  action = 0;
    int32   ret = RT_ERR_FAILED;
    ...
    ret = reg_field_read(unit, LONGAN_LED_GLB_CTRLr, LONGAN_SYS_LED_ENf,
            &action);
    if (RT_ERR_OK != ret)
    {
        LED_SEM_UNLOCK(unit);
    ...
    return ret;
} /* end of dal_longan_led_sysEnable_get */

/* Function Name:
 *      dal_longan_led_sysEnable_set
 * Description:
 ...
 */
int32
dal_longan_led_sysEnable_set(uint32 unit, rtk_led_type_t type, rtk_enable_t enable)
{
    uint32  action = 0;
    int32   ret = RT_ERR_FAILED;
    ...
    ret = reg_field_write(unit, LONGAN_LED_GLB_CTRLr, LONGAN_SYS_LED_ENf,
            &action);
    if (RT_ERR_OK != ret)
    {
        LED_SEM_UNLOCK(unit);
    ...
    LED_SEM_UNLOCK(unit);
    return ret;
} /* end of dal_longan_led_sysEnable_set */

/* Function Name:
 *      dal_longan_led_blinkTime_get
 * Description:
 ...
 */
int32
dal_longan_led_blinkTime_get(uint32 unit, rtk_led_blinkTime_t *pTime)
{
    int32   ret = RT_ERR_OK;
    uint32  blkTime;
    ...
    ret = reg_field_read(unit, LONGAN_LED_GLB_CTRLr, LONGAN_BLINK_TIME_SELf,
            &blkTime);
    ...
    return RT_ERR_OK;
}   /* end of dal_longan_led_blinkTime_get */

/* Function Name:
 *      dal_longan_led_blinkTime_set
 * Description:
 ...
 */
int32
dal_longan_led_blinkTime_set(uint32 unit, rtk_led_blinkTime_t time)
{
    int32   ret = RT_ERR_OK;
    uint32  value;
    ...
    ret = reg_field_write(unit, LONGAN_LED_GLB_CTRLr, LONGAN_BLINK_TIME_SELf,
            &value);
    ...
    return ret;
}   /* end of dal_longan_led_blinkTime_set */
