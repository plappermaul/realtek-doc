 ...
 * Symbol Definition
 */
typedef struct dal_longan_stp_data_s
{
    rtk_stp_state_t state[64][29];
} dal_longan_stp_data_t;
...
const static uint16 mstpState_fieldidx[] = {LONGAN_MSTI_STATE_PORT0tf, LONGAN_MSTI_STATE_PORT1tf,
                                            LONGAN_MSTI_STATE_PORT2tf, LONGAN_MSTI_STATE_PORT3tf,
                                            LONGAN_MSTI_STATE_PORT4tf, LONGAN_MSTI_STATE_PORT5tf,
                                            LONGAN_MSTI_STATE_PORT6tf, LONGAN_MSTI_STATE_PORT7tf,
                                            LONGAN_MSTI_STATE_PORT8tf, LONGAN_MSTI_STATE_PORT9tf,
                                            LONGAN_MSTI_STATE_PORT10tf, LONGAN_MSTI_STATE_PORT11tf,
                                            LONGAN_MSTI_STATE_PORT12tf, LONGAN_MSTI_STATE_PORT13tf,
                                            LONGAN_MSTI_STATE_PORT14tf, LONGAN_MSTI_STATE_PORT15tf,
                                            LONGAN_MSTI_STATE_PORT16tf, LONGAN_MSTI_STATE_PORT17tf,
                                            LONGAN_MSTI_STATE_PORT18tf, LONGAN_MSTI_STATE_PORT19tf,
                                            LONGAN_MSTI_STATE_PORT20tf, LONGAN_MSTI_STATE_PORT21tf,
                                            LONGAN_MSTI_STATE_PORT22tf, LONGAN_MSTI_STATE_PORT23tf,
                                            LONGAN_MSTI_STATE_PORT24tf, LONGAN_MSTI_STATE_PORT25tf,
                                            LONGAN_MSTI_STATE_PORT26tf, LONGAN_MSTI_STATE_PORT27tf,
 ...
 */
static int32 _dal_longan_stp_init_config(uint32 unit);

/* Module Name : STP */

/* Function Name:
 *      dal_longan_stpMapper_init
 * Description:
 ...
 */
int32
dal_longan_stpMapper_init(dal_mapper_t *pMapper)
{
    pMapper->stp_init = dal_longan_stp_init;
    pMapper->stp_mstpInstance_create = dal_longan_stp_mstpInstance_create;
    pMapper->stp_mstpInstance_destroy = dal_longan_stp_mstpInstance_destroy;
    pMapper->stp_isMstpInstanceExist_get = dal_longan_stp_isMstpInstanceExist_get;
    pMapper->stp_mstpState_get = dal_longan_stp_mstpState_get;
    pMapper->stp_mstpState_set = dal_longan_stp_mstpState_set;
    pMapper->stp_mstpInstanceMode_get = dal_longan_stp_mstpInstanceMode_get;
    pMapper->stp_mstpInstanceMode_set = dal_longan_stp_mstpInstanceMode_set;
 ...
 */
int32
dal_longan_stp_init(uint32 unit)
{
    ...
    if ((ret = _dal_longan_stp_init_config(unit)) != RT_ERR_OK)
    {
        stp_init[unit] = INIT_NOT_COMPLETED;
    ...
    return RT_ERR_OK;
} /* end of dal_longan_stp_init */


/* Function Name:
 *      dal_longan_stp_mstpInstance_create
 * Description:
 ...
 */
int32
dal_longan_stp_mstpInstance_create(uint32 unit, uint32 msti)
{
    ...
    return RT_ERR_OK;
} /* end of dal_longan_stp_mstpInstance_create */


/* Function Name:
 *      dal_longan_stp_mstpInstance_destroy
 * Description:
 ...
 */
int32
dal_longan_stp_mstpInstance_destroy(uint32 unit, uint32 msti)
{
    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_STP), "unit=%d, msti=%d", unit, msti);
    ...
    return RT_ERR_OK;
} /* end of dal_longan_stp_mstpInstance_destroy */


/* Function Name:
 *      dal_longan_stp_isMstpInstanceExist_get
 * Description:
 ...
 */
int32
dal_longan_stp_isMstpInstanceExist_get(uint32 unit, uint32 msti, uint32 *pMsti_exist)
{
    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_STP), "unit=%d, msti=%d", unit, msti);
    ...
    *pMsti_exist = (MSTI_VALID_IS_SET(unit, msti))?1:0;
    ...
    return RT_ERR_OK;
} /* end of dal_longan_stp_isMstpInstanceExist_get */


/* Function Name:
 *      dal_longan_stp_mstpState_get
 * Description:
 ...
 */
int32
dal_longan_stp_mstpState_get(uint32 unit, uint32 msti, rtk_port_t port, rtk_stp_state_t *pStp_state)
{
    int32   ret = RT_ERR_FAILED;
    ...
    if((ret = table_read(unit, LONGAN_MSTIt, msti, (uint32 *) &pStpEntry)) != RT_ERR_OK)
    {
        STP_SEM_UNLOCK(unit);
    ...
    if ((ret = table_field_get(unit, LONGAN_MSTIt, (uint32)mstpState_fieldidx[port],
 ...
 */
int32
dal_longan_stp_mstpState_set(uint32 unit, uint32 msti, rtk_port_t port, rtk_stp_state_t stp_state)
{
    int32   ret = RT_ERR_FAILED;
    spt_entry_t pStpEntry;
    ...
    if ((ret = table_field_set(unit, LONGAN_MSTIt, (uint32)mstpState_fieldidx[port],
    ...
    if((ret = table_write(unit, LONGAN_MSTIt, msti, (uint32 *) &pStpEntry)) != RT_ERR_OK)
    {
        STP_SEM_UNLOCK(unit);
        RT_ERR(ret, (MOD_DAL|MOD_STP), "");
        return ret;
    ...
    return RT_ERR_OK;
} /* end of dal_longan_stp_mstpState_set */

/* Function Name:
 *      dal_longan_stp_mstpInstanceMode_get
 * Description:
 ...
 */
int32
dal_longan_stp_mstpInstanceMode_get(uint32 unit, rtk_stp_mstiMode_t *pMsti_mode)
{
    int32   ret = RT_ERR_FAILED;
    uint32  val = 0;
    ...
    STP_SEM_LOCK(unit);
    if ((ret = reg_field_read(unit, LONGAN_ST_CTRLr, LONGAN_MSTI_MODEf, &val)) != RT_ERR_OK)
    {
        STP_SEM_UNLOCK(unit);
        RT_ERR(ret, (MOD_DAL|MOD_STP), "");
        return ret;
...
/* Function Name:
 *      dal_longan_stp_mstpInstanceMode_set
 * Description:
 ...
 */
int32
dal_longan_stp_mstpInstanceMode_set(uint32 unit, rtk_stp_mstiMode_t msti_mode)
{
    int32   ret = RT_ERR_FAILED;
    uint32  val;
    ...
    STP_SEM_LOCK(unit);
    if ((ret = reg_field_write(unit, LONGAN_ST_CTRLr, LONGAN_MSTI_MODEf, &val)) != RT_ERR_OK)
    {
        STP_SEM_UNLOCK(unit);
        RT_ERR(ret, (MOD_DAL|MOD_STP), "");
        return ret;
 ...
 */
static int32
_dal_longan_stp_init_config(uint32 unit)
{
    int32   ret = RT_ERR_FAILED;
    uint32  port;

    if ((ret = dal_longan_stp_mstpInstance_create(unit, RTK_DEFAULT_MSTI)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_STP|MOD_DAL), "");
        return ret;
    }
    ...
    if (HWP_UNIT_VALID_LOCAL(unit))
    {
        ...
        {
            if ((ret = dal_longan_stp_mstpState_set(unit, RTK_DEFAULT_MSTI, port, RTK_DEFAULT_STP_PORT_STATE)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_STP|MOD_DAL), "");
                return ret;
            }
    ...
    return RT_ERR_OK;
} /* end of _dal_longan_stp_init_config */
