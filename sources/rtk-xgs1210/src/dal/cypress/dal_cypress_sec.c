...
{
    pMapper->sec_init = dal_cypress_sec_init;
    pMapper->sec_portAttackPrevent_get = dal_cypress_sec_portAttackPrevent_get;
    pMapper->sec_portAttackPrevent_set = dal_cypress_sec_portAttackPrevent_set;
    pMapper->sec_portAttackPreventEnable_get = dal_cypress_sec_portAttackPreventEnable_get;
    pMapper->sec_portAttackPreventEnable_set = dal_cypress_sec_portAttackPreventEnable_set;
    pMapper->sec_attackPreventAction_get = dal_cypress_sec_attackPreventAction_get;
    pMapper->sec_attackPreventAction_set = dal_cypress_sec_attackPreventAction_set;
    pMapper->sec_minIPv6FragLen_get = dal_cypress_sec_minIPv6FragLen_get;
    pMapper->sec_minIPv6FragLen_set = dal_cypress_sec_minIPv6FragLen_set;
    pMapper->sec_maxPingLen_get = dal_cypress_sec_maxPingLen_get;
    pMapper->sec_maxPingLen_set = dal_cypress_sec_maxPingLen_set;
    pMapper->sec_minTCPHdrLen_get = dal_cypress_sec_minTCPHdrLen_get;
    pMapper->sec_minTCPHdrLen_set = dal_cypress_sec_minTCPHdrLen_set;
    pMapper->sec_smurfNetmaskLen_get = dal_cypress_sec_smurfNetmaskLen_get;
    pMapper->sec_smurfNetmaskLen_set = dal_cypress_sec_smurfNetmaskLen_set;
