 ...
 *
 * $Revision: 73564 $
 * $Date: 2016-11-23 15:38:00 +0800 (Wed, 23 Nov 2016) $
 *
...
{
    pMapper->stp_init = dal_cypress_stp_init;
    pMapper->stp_mstpInstance_create = dal_cypress_stp_mstpInstance_create;
    pMapper->stp_mstpInstance_destroy = dal_cypress_stp_mstpInstance_destroy;
    pMapper->stp_isMstpInstanceExist_get = dal_cypress_stp_isMstpInstanceExist_get;
    pMapper->stp_mstpState_get = dal_cypress_stp_mstpState_get;
    pMapper->stp_mstpState_set = dal_cypress_stp_mstpState_set;
    pMapper->stp_mstpInstanceMode_get = dal_cypress_stp_mstpInstanceMode_get;
    pMapper->stp_mstpInstanceMode_set = dal_cypress_stp_mstpInstanceMode_set;
