 ...
 *
 * $Revision: 96311 $
 * $Date: 2019-04-15 13:47:40 +0800 (Mon, 15 Apr 2019) $
 *
...
/* Function Name:
 *      dal_cypress_acl_templateId_get
 * Description:
 ...
 */
int32
dal_cypress_acl_templateId_get(uint32 unit, rtk_acl_phase_t phase,
    rtk_acl_id_t entry_idx, uint32 *pTemplate_id)
{
    ...
    if ((ret = dal_cypress_acl_ruleEntryField_read(unit, phase, entry_idx, \
    ...
    if ((ret = dal_cypress_acl_templateSelector_get(unit, block_idx, &template_idx)) != RT_ERR_OK)
    {
        RT_ERR(ret, (MOD_DAL|MOD_ACL), "");
        return ret;
    }
    ...
    *pTemplate_id = template_idx.template_id[field_data[0]];
    ...
    return RT_ERR_OK;
}   /* end of dal_cypress_acl_templateId_get */
...
dal_cypress_aclMapper_init(dal_mapper_t *pMapper)
{
    ...
    pMapper->acl_templateId_get = dal_cypress_acl_templateId_get;
