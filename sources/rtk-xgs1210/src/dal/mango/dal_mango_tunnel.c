 ...
 *
 * $Revision: 97317 $
 * $Date: 2019-05-30 19:57:41 +0800 (Thu, 30 May 2019) $
 *
...
_dal_mango_tunnel_decapEntry_get(uint32 unit, uint32 index, dal_mango_tunnel_decapEntry_t *pEntry)
{
    ...
    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L3), "unit=%d,index=%u,pEntry=%p,flags=0x%08x", unit, index, pEntry);
...
dal_mango_tunnel_intfStats_get(uint32 unit, rtk_intf_id_t intfId, rtk_tunnel_intf_stats_t *pStats)
{
    ...
    /* found */
    TUNNEL_TABLE_READ_ERR_HDL(unit, MANGO_L3_IGR_TUNNEL_INTF_CNTRt, tunnelIntfIdx, igr_cntr, "", errHandle, ret);
    TUNNEL_TABLE_READ_ERR_HDL(unit, MANGO_L3_EGR_TUNNEL_INTF_CNTRt, tunnelIntfIdx, egr_cntr, "", errHandle, ret);
...
dal_mango_tunnel_intfStats_reset(uint32 unit, rtk_intf_id_t intfId)
{
    ...
    TUNNEL_TABLE_WRITE_ERR_HDL(unit, MANGO_L3_IGR_TUNNEL_INTF_CNTRt, tunnelIntfIdx, igr_cntr, "", errHandle, ret);
    TUNNEL_TABLE_WRITE_ERR_HDL(unit, MANGO_L3_EGR_TUNNEL_INTF_CNTRt, tunnelIntfIdx, egr_cntr, "", errHandle, ret);
...
dal_mango_tunnel_qosProfile_set(uint32 unit, uint32 idx, rtk_tunnel_qosProfile_t profile)
{
    ...
    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_TUNNEL), "unit=%d,idx=%d,profile=%d", unit, idx, profile);
