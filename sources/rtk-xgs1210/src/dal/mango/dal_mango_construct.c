 ...
 *
 * $Revision: 98685 $
 * $Date: 2019-07-12 20:00:59 +0800 (Fri, 12 Jul 2019) $
 *
...
static int32 _dal_mango_construct_mac_usxgmii_10gd(uint32 unit, uint32 sds)
{
    uint32  val = 1;
    int32   ret;
    ...
    switch (sds)
    {
        case 2:
            ...
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP0_1_CTRLr, MANGO_GROUP0_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP0_1_CTRLr, MANGO_GROUP0_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP0_1_CTRLr, MANGO_GROUP0_MAC1_5G_ENf, &val), ret);
        ...
        case 3:
            ...
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP0_1_CTRLr, MANGO_GROUP1_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP0_1_CTRLr, MANGO_GROUP1_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP0_1_CTRLr, MANGO_GROUP1_MAC1_5G_ENf, &val), ret);
        ...
        case 4:
            ...
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP2_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP2_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP2_MAC1_5G_ENf, &val), ret);
        ...
        case 5:
            ...
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP3_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP3_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP3_MAC1_5G_ENf, &val), ret);
        ...
        case 6:
            ...
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP4_CTRLr, MANGO_GROUP4_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP4_CTRLr, MANGO_GROUP4_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP4_CTRLr, MANGO_GROUP4_MAC1_5G_ENf, &val), ret);
        ...
        case 7:
            ...
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP5_CTRLr, MANGO_GROUP5_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP5_CTRLr, MANGO_GROUP5_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP5_CTRLr, MANGO_GROUP5_MAC1_5G_ENf, &val), ret);
        ...
        case 8:
            ...
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP6_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP6_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP6_MAC1_5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP6_MAC1_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP6_MAC1_1G_ENf, &val), ret);
            break;
        case 9:
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP7_MAC0_5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP7_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP7_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP7_MAC1_5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP7_MAC1_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP6_7_CTRLr, MANGO_GROUP7_MAC1_1G_ENf, &val), ret);
            break;
        default:
            return RT_ERR_FAILED;
    }
    ...
    return ret;
}   /* end of _dal_mango_construct_mac_usxgmii_10gd */
...
static int32 _dal_mango_construct_mac_usxgmii_10gq(uint32 unit, uint32 sds)
{
    ...
    switch (sds)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP0_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP0_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP0_MAC1_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP0_MAC1_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP0_MAC2_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP0_MAC2_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP0_MAC3_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP0_MAC3_1G_ENf, &val), ret);
            break;
        case 5:
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP1_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP1_MAC0_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP1_MAC1_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP1_MAC1_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP1_MAC2_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP1_MAC2_1G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP1_MAC3_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP2_3_CTRLr, MANGO_GROUP1_MAC3_1G_ENf, &val), ret);
            break;
        case 6:
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP4_CTRLr, MANGO_GROUP4_MAC0_2P5G_ENf, &val), ret);
            RT_ERR_CHK(reg_field_write(unit, MANGO_MAC_GROUP4_CTRLr, MANGO_GROUP4_MAC0_1G_ENf, &val), ret);
...
int32 dal_mango_construct_macConfig_init(uint32 unit)
{
    ...
    HWP_SDS_TRAVS(unit, sds)
    {
        ...
        switch (HWP_SDS_MODE(unit, sds))
        {
            ...
            case RTK_MII_USXGMII_10GDXGMII:
                RT_ERR_CHK(_dal_mango_construct_mac_usxgmii_10gd(unit, sds), ret);
                break;
    ...
    val = 0x2;
    RT_ERR_CHK(reg_field_write(unit, MANGO_SPI_CTRL0r,
            MANGO_SPI_CLK_SELf, &val), ret);
...
static int32 _dal_mango_construct_init_usxgmii(uint32 unit, uint32 sds, uint32 aSds)
{
    ...
    else
    {
        ...
        RT_ERR_CHK(hal_serdes_reg_set(unit, aSds, 0x6, 0x1d, 0x0480), ret);
        RT_ERR_CHK(hal_serdes_reg_set(unit, aSds, 0x6, 0xe, 0x0400), ret);
    }
...
_dal_mango_construct_sdsMode_set(uint32 unit, uint32 sds, rtk_serdesMode_t mode)
{
    ...
    uint32  board_sds_tx[] = {0x1A00, 0x1A00, 0x200, 0x200, 0x200,
...
/* Function Name:
 *      dal_mango_construct_xsgmii_cali
 * Description:
 *      XSGMII calibration
 * Input:
 *      unit    - unit id
 ...
 */
int32
_dal_mango_construct_xsgmii_cali(uint32 unit, uint32 sds, uint32 asds)
{
    rtk_sds_rxCaliConf_t    conf;
    rtk_sds_linkSts_t       sts;
    uint32                  dSds;
    ...
    /* dis xsgmii Nway */
    RT_ERR_CHK(SDS_FIELD_W(unit, dSds, 0x0, 0x2, 9, 8, 1), ret);
    RT_ERR_CHK(SDS_FIELD_W(unit, dSds + 1, 0x0, 0x2, 9, 8, 1), ret);
    ...
    for (i = 0; i < max_cali_num; ++i)
    {
        ...
        RT_ERR_CHK(phy_rtl9310_linkSts_get(unit, sds, &sts), ret);

        if (0x1FF == sts.sts && 0x1FF == sts.sts1)
            break;
    ...
    if (0x1FF != sts.sts || 0x1FF != sts.sts1)
        osal_printf("SDS %u link fail 0x%X 0x%X\n", sds, sts.sts, sts.sts1);

    RT_ERR_CHK(phy_rtl9310_pcb_adapt(unit, sds), ret);

    return RT_ERR_OK;
}   /* end of _dal_mango_construct_xsgmii_cali */
...
void dal_mango_construct_serdesConfig_init(uint32 unit)
{
    ...
    HWP_SDS_TRAVS(unit, sds)
    {
        ...
        {
            _dal_mango_construct_xsgmii_cali(unit, sds, aSds);
        }
