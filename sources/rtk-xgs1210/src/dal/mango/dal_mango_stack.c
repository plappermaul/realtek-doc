...
rtk_port_t                       idx2stackPortId[RTK_MAX_NUM_OF_UNIT][RTK_MAX_NUM_OF_DEV];
...
/* Function Name:
 *      dal_mango_stack_linkChange_handler
 * Description:
 *      reset stacking port if ever link changes
 * Input:
 *      unit           - unit id
 *      port           - port id
 * Output:
 ...
 *      None
 */
int32 dal_mango_stack_linkChange_handler(int32 unit, rtk_port_t port)
{
    int32 ret;
