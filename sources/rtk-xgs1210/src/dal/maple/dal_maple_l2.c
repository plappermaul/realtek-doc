...
_dal_maple_l2_getL2EntryfromHash(uint32 unit, uint32 hashkey, uint32 location, dal_maple_l2_entry_t *pL2_entry, uint32 *pIsValid)
{
    ...
    RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "unit=%d, hashkey=%d, location=%d, \
           ...
           pL2_entry->un.unicast.mac.octet[0], pL2_entry->un.unicast.mac.octet[1], pL2_entry->un.unicast.mac.octet[2],
           pL2_entry->un.unicast.mac.octet[3], pL2_entry->un.unicast.mac.octet[4], pL2_entry->un.unicast.mac.octet[5]);
    ...
    switch ((ip6_multi << 2) | (ip_multi << 1) | is_l2mcast)
    {
        case 0x0: /* L2 unicast */
            ...
            {
                if ((ret = table_field_get(unit, MAPLE_L2_UCt, MAPLE_L2_UC_SLPtf, &pL2_entry->un.unicast.port, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_UCt, MAPLE_L2_UC_FID_RVIDtf, &pL2_entry->un.unicast.fid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                ...
                pL2_entry->un.unicast.sablock      = sablock;
                pL2_entry->un.unicast.dablock      = dablock;
                pL2_entry->un.unicast.is_static    = is_static;
                pL2_entry->un.unicast.aging        = aging;
                pL2_entry->un.unicast.suspending   = suspending;
                pL2_entry->un.unicast.nh           = next_hop;
                if(pL2_entry->un.unicast.nh == TRUE)
                {
                    pL2_entry->un.unicast.vlan_target = vid_sel;
                    pL2_entry->un.unicast.route_idx = mac_idx;
                }
                else
                    pL2_entry->un.unicast.agg_vid      = agg_vid;
            }

            /* convert FID from hash algorithm */
            pL2_entry->un.unicast.fid = (hashkey & BITMASK_11B) | (pL2_entry->un.unicast.fid & (~BITMASK_11B));
            if ((ret = _dal_maple_l2_entryToHashKey(unit, pL2_entry, &partialkey1)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
            pL2_entry->un.unicast.fid  = (partialkey1 & BITMASK_11B) | (pL2_entry->un.unicast.fid & (~BITMASK_11B));

            break;
        case 0x1: /* l2 Multicast */
            pL2_entry->entry_type = L2_MULTICAST;

            if (table_field_get(unit, MAPLE_L2_MCt, MAPLE_L2_MC_MC_PMSK_IDXtf, &pL2_entry->un.l2mcast.index, (uint32 *)&l2_entry) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }

            if (table_field_get(unit, MAPLE_L2_MCt, MAPLE_L2_MC_VIDtf, &pL2_entry->un.l2mcast.agg_vid, (uint32 *)&l2_entry) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }

            if ((ret = table_field_get(unit, MAPLE_L2_MCt, MAPLE_L2_MC_FID_RVIDtf, &pL2_entry->un.l2mcast.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
            ...
            pL2_entry->un.l2mcast.rvid = (hashkey & BITMASK_11B) | (pL2_entry->un.l2mcast.rvid & (~BITMASK_11B));
            if ((ret = _dal_maple_l2_entryToHashKey(unit, pL2_entry, &partialkey1)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
            pL2_entry->un.l2mcast.rvid  = (partialkey1 & BITMASK_11B) | (pL2_entry->un.l2mcast.rvid & (~BITMASK_11B));
            break;
        case 0x2: /* IPv4 multicast */
            ...
            {
                if ((ret = table_field_get(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_MC_PMSK_IDXtf, &pL2_entry->un.ipmcast_ip_mc_sip.index, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_FID_RVIDtf, &pL2_entry->un.ipmcast_ip_mc_sip.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_GIPtf, &pL2_entry->un.ipmcast_ip_mc_sip.dip, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_SIPtf, &pL2_entry->un.ipmcast_ip_mc_sip.sip, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                pL2_entry->un.ipmcast_ip_mc_sip.sip = (hashkey & BITMASK_11B) | (pL2_entry->un.ipmcast_ip_mc_sip.sip & (~BITMASK_11B));
                if (( ret = _dal_maple_l2_entryToHashKey(unit, pL2_entry, &partialkey1)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                pL2_entry->un.ipmcast_ip_mc_sip.sip = (partialkey1 & BITMASK_11B) | (pL2_entry->un.ipmcast_ip_mc_sip.sip & (~BITMASK_11B));
            }
            else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
            {
                if ((ret = table_field_get(unit, MAPLE_L2_IP_MCt, MAPLE_L2_IP_MC_MC_PMSK_IDXtf, &pL2_entry->un.ipmcast_ip_mc.index, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MCt, MAPLE_L2_IP_MC_FID_RVIDtf, &pL2_entry->un.ipmcast_ip_mc.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MCt, MAPLE_L2_IP_MC_GIPtf, &pL2_entry->un.ipmcast_ip_mc.dip, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                pL2_entry->un.ipmcast_ip_mc.rvid = (hashkey & BITMASK_11B) | (pL2_entry->un.ipmcast_ip_mc.rvid & (~BITMASK_11B));
                if ((ret = _dal_maple_l2_entryToHashKey(unit, pL2_entry, &partialkey1)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                pL2_entry->un.ipmcast_ip_mc.rvid  = (partialkey1 & BITMASK_11B) | (pL2_entry->un.ipmcast_ip_mc.rvid & (~BITMASK_11B));
            }
            break;
...
_dal_maple_l2_getL2EntryfromCAM(uint32 unit, uint32 index, dal_maple_l2_entry_t *pL2_entry, uint32 *pIsValid)
{
    ...
    RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "unit=%d, index=%d, entry_type=%d, \
           Mac=%x-%x-%x-%x-%x-%x", unit, index, pL2_entry->entry_type, pL2_entry->un.unicast.mac.octet[0],
           pL2_entry->un.unicast.mac.octet[1], pL2_entry->un.unicast.mac.octet[2], pL2_entry->un.unicast.mac.octet[3],
           pL2_entry->un.unicast.mac.octet[4], pL2_entry->un.unicast.mac.octet[5]);
    ...
    switch ((ip6_multi << 2) | (ip_multi << 1) | is_l2mcast)
    {
        case 0x00: /* L2 unicast */
            pL2_entry->entry_type = L2_UNICAST;
            if ((ret = table_field_get(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_SLPtf, &pL2_entry->un.unicast.port, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_get(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_FID_RVIDtf, &pL2_entry->un.unicast.fid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
        ...
        case 0x01: /* l2 Multicast */
            pL2_entry->entry_type = L2_MULTICAST;
            if ((ret = table_field_get(unit, MAPLE_L2_CAM_MCt, MAPLE_L2_CAM_MC_MC_PMSK_IDXtf, &pL2_entry->un.l2mcast.index, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_get(unit, MAPLE_L2_CAM_MCt, MAPLE_L2_CAM_MC_VIDtf, &pL2_entry->un.l2mcast.agg_vid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_get(unit, MAPLE_L2_CAM_MCt, MAPLE_L2_CAM_MC_FID_RVIDtf, &pL2_entry->un.l2mcast.rvid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
        ...
        case 0x2: /* IPv4 multicast */
            ...
            {
                if ((ret = table_field_get(unit, MAPLE_L2_CAM_IP_MC_SIPt, MAPLE_L2_CAM_IP_MC_SIP_MC_PMSK_IDXtf, &pL2_entry->un.ipmcast_ip_mc_sip.index, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_L2_CAM_IP_MC_SIPt, MAPLE_L2_CAM_IP_MC_SIP_FID_RVIDtf, &pL2_entry->un.ipmcast_ip_mc_sip.rvid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_L2_CAM_IP_MC_SIPt, MAPLE_L2_CAM_IP_MC_SIP_SIPtf, &pL2_entry->un.ipmcast_ip_mc_sip.sip, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_L2_CAM_IP_MC_SIPt, MAPLE_L2_CAM_IP_MC_SIP_GIPtf, &pL2_entry->un.ipmcast_ip_mc_sip.dip, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                };
            ...
            {
                if ((ret = table_field_get(unit, MAPLE_L2_CAM_IP_MCt, MAPLE_L2_CAM_IP_MC_MC_PMSK_IDXtf, &pL2_entry->un.ipmcast_ip_mc.index, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_L2_CAM_IP_MCt, MAPLE_L2_CAM_IP_MC_FID_RVIDtf, &pL2_entry->un.ipmcast_ip_mc.rvid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_L2_CAM_IP_MCt, MAPLE_L2_CAM_IP_MC_GIPtf, &pL2_entry->un.ipmcast_ip_mc.dip, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
        ...
        , dal_maple_l2_index_t *pL2_index)
{
    ...
    RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "unit=%d, entry_type=%d, Mac=%x-%x-%x-%x-%x-%x\
           get_method=%d, ",
           unit, pL2_entry->entry_type, pL2_entry->un.unicast.mac.octet[0], pL2_entry->un.unicast.mac.octet[1],
           pL2_entry->un.unicast.mac.octet[2], pL2_entry->un.unicast.mac.octet[3], pL2_entry->un.unicast.mac.octet[4],
           pL2_entry->un.unicast.mac.octet[5], get_method);
    ...
    for (cam_index = 0; l2CamEbl && (cam_index < cam_size[unit]); cam_index++)
    {
        ...
        if ((TRUE == isValid)
            ...
            && (l2_entry.entry_type == pL2_entry->entry_type))
        {
            if (l2_entry.entry_type == L2_UNICAST && (l2_entry.un.unicast.nh == TRUE))
                continue;
        ...
        , dal_maple_l2_index_t *pL2_index)
{
    ...
    RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "unit=%d, entry_type=%d, Mac=%x-%x-%x-%x-%x-%x",
           unit, pL2_entry->entry_type, pL2_entry->un.unicast.mac.octet[0], pL2_entry->un.unicast.mac.octet[1],
           pL2_entry->un.unicast.mac.octet[2], pL2_entry->un.unicast.mac.octet[3], pL2_entry->un.unicast.mac.octet[4],
           pL2_entry->un.unicast.mac.octet[5]);
    ...
    for (hash_depth = 0; hash_depth < HAL_L2_HASHDEPTH(unit); hash_depth++)
    {
        ...
        {
            if (l2_entry.un.unicast.sablock == 0 && l2_entry.un.unicast.dablock == 0 &&
                l2_entry.un.unicast.is_static == 0 && l2_entry.un.unicast.nh == 0 && l2_entry.un.unicast.suspending == 0)
            {
                //found_exist = TRUE;
                pL2_index->index_type = L2_IN_HASH;
                pL2_index->index = hashkey;
    ...
    for (cam_index = 0; l2CamEbl && (cam_index < cam_size[unit]); cam_index++)
    {
        ...
        {
            if (l2_entry.un.unicast.sablock == 0 && l2_entry.un.unicast.dablock == 0 &&
                l2_entry.un.unicast.is_static == 0 && l2_entry.un.unicast.suspending == 0)
            {
                //found_exist = TRUE;
                pL2_index->index_type = L2_IN_CAM;
                pL2_index->index = cam_index;
...
_dal_maple_l2_entryToHashKey(uint32 unit, dal_maple_l2_entry_t *pL2_entry, uint32 *pKey)
{
    ...
    switch (pL2_entry->entry_type)
    {
        case L2_UNICAST:
            ...
            hashSeed = (((uint64)pL2_entry->un.unicast.mac.octet[0] << 52) |
                        ((uint64)pL2_entry->un.unicast.mac.octet[1] << 44) |
                        ((uint64)pL2_entry->un.unicast.mac.octet[2] << 36) |
                        ((uint64)pL2_entry->un.unicast.mac.octet[3] << 28) |
                        ((uint64)pL2_entry->un.unicast.mac.octet[4] << 20) |
                        ((uint64)pL2_entry->un.unicast.mac.octet[5] << 12) |
                        ((uint64)pL2_entry->un.unicast.fid));
            break;
        case L2_MULTICAST:
            /* if it is l2 multicast, key will be rvid+mac */
            hashSeed = (((uint64)pL2_entry->un.l2mcast.mac.octet[0] << 52) |
                        ((uint64)pL2_entry->un.l2mcast.mac.octet[1] << 44) |
                        ((uint64)pL2_entry->un.l2mcast.mac.octet[2] << 36) |
                        ((uint64)pL2_entry->un.l2mcast.mac.octet[3] << 28) |
                        ((uint64)pL2_entry->un.l2mcast.mac.octet[4] << 20) |
                        ((uint64)pL2_entry->un.l2mcast.mac.octet[5] << 12) |
                        ((uint64)pL2_entry->un.l2mcast.rvid));
            break;
        case IP4_MULTICAST:
            if (LOOKUP_ON_FVID_AND_MAC == ip4HashFmt[unit])
            {
                hashSeed = (((uint64)pL2_entry->un.ipmcast_mc_ip.mac.octet[0] << 52) |
                            ((uint64)pL2_entry->un.ipmcast_mc_ip.mac.octet[1] << 44) |
                            ((uint64)pL2_entry->un.ipmcast_mc_ip.mac.octet[2] << 36) |
                            ((uint64)pL2_entry->un.ipmcast_mc_ip.mac.octet[3] << 28) |
                            ((uint64)pL2_entry->un.ipmcast_mc_ip.mac.octet[4] << 20) |
                            ((uint64)pL2_entry->un.ipmcast_mc_ip.mac.octet[5] << 12) |
                            ((uint64)pL2_entry->un.ipmcast_mc_ip.rvid));
            }
            else if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
            {
                hashSeed = (((uint64)pL2_entry->un.ipmcast_ip_mc_sip.dip << 32) |
                            ((uint64)pL2_entry->un.ipmcast_ip_mc_sip.sip));
            }
            else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
            {
                hashSeed = (((uint64)pL2_entry->un.ipmcast_ip_mc.dip << 12) |
                            ((uint64)pL2_entry->un.ipmcast_ip_mc.rvid));
            }
            break;
        case IP6_MULTICAST:
            if (LOOKUP_ON_FVID_AND_MAC == ip6HashFmt[unit])
    ...
    switch (pSrcEntry->entry_type)
    {
        ...
        case L2_MULTICAST:
            RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "srcrvid=%d, dstrvid=%d, srcMac=%x-%x-%x-%x-%x-%x,\
                   dstMac=%x-%x-%x-%x-%x-%x", pSrcEntry->un.l2mcast.rvid, pDstEntry->un.l2mcast.rvid,
            ...
            if ((osal_memcmp(&pSrcEntry->un.l2mcast.mac, &pDstEntry->un.l2mcast.mac, sizeof(rtk_mac_t)))
               || (pSrcEntry->un.l2mcast.rvid != pDstEntry->un.l2mcast.rvid))
            {
                return RT_ERR_FAILED;
            }
        ...
        case IP4_MULTICAST:
            ...
            {
                RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "srcrvid=%d, dstrvid=%d, srcMac=%x-%x-%x-%x-%x-%x,\
                       dstMac=%x-%x-%x-%x-%x-%x", pSrcEntry->un.ipmcast_mc_ip.rvid, pDstEntry->un.ipmcast_mc_ip.rvid,
                       pSrcEntry->un.ipmcast_mc_ip.mac.octet[0], pSrcEntry->un.ipmcast_mc_ip.mac.octet[1], pSrcEntry->un.ipmcast_mc_ip.mac.octet[2],
                       pSrcEntry->un.ipmcast_mc_ip.mac.octet[3], pSrcEntry->un.ipmcast_mc_ip.mac.octet[4], pSrcEntry->un.ipmcast_mc_ip.mac.octet[5],
                       pDstEntry->un.ipmcast_mc_ip.mac.octet[0], pDstEntry->un.ipmcast_mc_ip.mac.octet[1], pDstEntry->un.ipmcast_mc_ip.mac.octet[2],
                       pDstEntry->un.ipmcast_mc_ip.mac.octet[3], pDstEntry->un.ipmcast_mc_ip.mac.octet[4], pDstEntry->un.ipmcast_mc_ip.mac.octet[5]);
            ...
            else if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
            {
                RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "srcdip=%d, dstdip=%d, srcsip=%d, dstsip=%d",
                       pSrcEntry->un.ipmcast_ip_mc_sip.dip, pDstEntry->un.ipmcast_ip_mc_sip.dip, pSrcEntry->un.ipmcast_ip_mc_sip.sip, pDstEntry->un.ipmcast_ip_mc_sip.sip);
                if (ipmcst_fvid_cmp && pSrcEntry->un.ipmcast_ip_mc_sip.rvid != pDstEntry->un.ipmcast_ip_mc_sip.rvid)
                    return RT_ERR_FAILED;
                if ((pSrcEntry->un.ipmcast_ip_mc_sip.dip != pDstEntry->un.ipmcast_ip_mc_sip.dip)
                    ||(pSrcEntry->un.ipmcast_ip_mc_sip.sip != pDstEntry->un.ipmcast_ip_mc_sip.sip))
                {
                    return RT_ERR_FAILED;
                }
            }
            else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
            {
                RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "srcrvid=%d, dstrvid=%d, srcdip=%d, dstdip=%d",
                        pSrcEntry->un.ipmcast_ip_mc.rvid, pDstEntry->un.ipmcast_ip_mc.rvid,
                        pSrcEntry->un.ipmcast_ip_mc.dip, pDstEntry->un.ipmcast_ip_mc.dip);
                if ((pSrcEntry->un.ipmcast_ip_mc.dip != pDstEntry->un.ipmcast_ip_mc.dip)
                    ||(pSrcEntry->un.ipmcast_ip_mc.rvid != pDstEntry->un.ipmcast_ip_mc.rvid))
                {
                    return RT_ERR_FAILED;
                }
    ...
    dal_maple_l2_entry_t  *pL2_data)
{
    ...
    for (; l2_idx < hashTable_size[unit]; l2_idx++)
    {
            ...
            && (TRUE == isValid) && (type == l2_entry.entry_type))
        {
            ...
            {
                if ((FALSE == include_static) && (1 == l2_entry.un.unicast.is_static))
                {
    ...
    switch (pL2_entry->entry_type)
    {
        case L2_UNICAST: /* L2 unicast */
            RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "da_block=%d, sa_block=%d, port=%d, is_static=%d, aging=%d, suspend=%d, nh=%d, Mac=%x-%x-%x-%x-%x-%x",
                   pL2_entry->un.unicast.dablock, pL2_entry->un.unicast.sablock, pL2_entry->un.unicast.port,
                   pL2_entry->un.unicast.is_static, pL2_entry->un.unicast.aging, pL2_entry->un.unicast.suspending, pL2_entry->un.unicast.nh, pL2_entry->un.unicast.mac.octet[0],
                   pL2_entry->un.unicast.mac.octet[1], pL2_entry->un.unicast.mac.octet[2], pL2_entry->un.unicast.mac.octet[3],
                   pL2_entry->un.unicast.mac.octet[4], pL2_entry->un.unicast.mac.octet[5]);

            {
                ...
                if ((ret = table_field_set(unit, MAPLE_L2_UCt, MAPLE_L2_UC_DA_BLKtf, &pL2_entry->un.unicast.dablock, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_set(unit, MAPLE_L2_UCt, MAPLE_L2_UC_SA_BLKtf, &pL2_entry->un.unicast.sablock, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_set(unit, MAPLE_L2_UCt, MAPLE_L2_UC_SLPtf, &pL2_entry->un.unicast.port, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_set(unit, MAPLE_L2_UCt, MAPLE_L2_UC_STATICtf, &pL2_entry->un.unicast.is_static, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_set(unit, MAPLE_L2_UCt, MAPLE_L2_UC_AGEtf, &pL2_entry->un.unicast.aging, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_set(unit, MAPLE_L2_UCt, MAPLE_L2_UC_SUSPENDtf, &pL2_entry->un.unicast.suspending, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_set(unit, MAPLE_L2_UCt, MAPLE_L2_UC_NEXT_HOPtf, &pL2_entry->un.unicast.nh, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_set(unit, MAPLE_L2_UCt, MAPLE_L2_UC_FID_RVIDtf, &pL2_entry->un.unicast.fid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                ...
                if (pL2_entry->un.unicast.nh == TRUE)
                {
                    if ((ret = table_field_set(unit, MAPLE_L2_NEXT_HOPt, MAPLE_L2_NEXT_HOP_VLAN_TARGETtf, &pL2_entry->un.unicast.vlan_target, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_set(unit, MAPLE_L2_NEXT_HOPt, MAPLE_L2_NEXT_HOP_ROUTE_IDXtf, &pL2_entry->un.unicast.route_idx, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                ...
                {
                    if ((ret = table_field_set(unit, MAPLE_L2_UCt, MAPLE_L2_UC_VIDtf, &pL2_entry->un.unicast.agg_vid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
        ...
        case L2_MULTICAST: /* l2 Multicast */
            RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "index=%d, Mac=%x-%x-%x-%x-%x-%x",
                   pL2_entry->un.l2mcast.index, pL2_entry->un.l2mcast.mac.octet[0],
                   pL2_entry->un.l2mcast.mac.octet[1], pL2_entry->un.l2mcast.mac.octet[2], pL2_entry->un.l2mcast.mac.octet[3],
                   pL2_entry->un.l2mcast.mac.octet[4], pL2_entry->un.l2mcast.mac.octet[5]);
            ...
            if ((ret = table_field_set(unit, MAPLE_L2_MCt, MAPLE_L2_MC_MC_PMSK_IDXtf, &pL2_entry->un.l2mcast.index, (uint32 *)&l2_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_MCt, MAPLE_L2_MC_VIDtf, &pL2_entry->un.l2mcast.agg_vid, (uint32 *)&l2_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_MCt, MAPLE_L2_MC_FID_RVIDtf , &pL2_entry->un.l2mcast.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
        ...
        case IP4_MULTICAST: /* IP multicast */
            ...
            {
                RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "index=%d, Mac=%x-%x-%x-%x-%x-%x",
                   pL2_entry->un.ipmcast_mc_ip.index, pL2_entry->un.ipmcast_mc_ip.mac.octet[0],
                   pL2_entry->un.ipmcast_mc_ip.mac.octet[1], pL2_entry->un.ipmcast_mc_ip.mac.octet[2], pL2_entry->un.ipmcast_mc_ip.mac.octet[3],
                   pL2_entry->un.ipmcast_mc_ip.mac.octet[4], pL2_entry->un.ipmcast_mc_ip.mac.octet[5]);
                ...
                if ((ret = table_field_set(unit, MAPLE_L2_MCt, MAPLE_L2_MC_MC_PMSK_IDXtf, &pL2_entry->un.ipmcast_mc_ip.index, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_set(unit, MAPLE_L2_MCt, MAPLE_L2_MC_VIDtf, &pL2_entry->un.ipmcast_mc_ip.agg_vid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_set(unit, MAPLE_L2_MCt, MAPLE_L2_MC_FID_RVIDtf , &pL2_entry->un.ipmcast_mc_ip.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                mac_uint32[1] = ((uint32)pL2_entry->un.ipmcast_mc_ip.mac.octet[0]) << 8;
                mac_uint32[1] |= ((uint32)pL2_entry->un.ipmcast_mc_ip.mac.octet[1]);
                mac_uint32[0] = ((uint32)pL2_entry->un.ipmcast_mc_ip.mac.octet[2]) << 24;
                mac_uint32[0] |= ((uint32)pL2_entry->un.ipmcast_mc_ip.mac.octet[3]) << 16;
                mac_uint32[0] |= ((uint32)pL2_entry->un.ipmcast_mc_ip.mac.octet[4]) << 8;
                mac_uint32[0] |= ((uint32)pL2_entry->un.ipmcast_mc_ip.mac.octet[5]);
            ...
            else if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
            {
                RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "index=%d, rvid=%d, dip=%d, sip=%d",
                        pL2_entry->un.ipmcast_ip_mc_sip.index, pL2_entry->un.ipmcast_ip_mc_sip.rvid, pL2_entry->un.ipmcast_ip_mc_sip.dip, pL2_entry->un.ipmcast_ip_mc_sip.sip);

                if (pL2_entry->un.ipmcast_ip_mc_sip.dip == 0)
                ...
                else
                {
                    ...
                    if ((ret = table_field_set(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_GIPtf, &pL2_entry->un.ipmcast_ip_mc_sip.dip, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }

                    if ((ret = table_field_set(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_SIPtf, &pL2_entry->un.ipmcast_ip_mc_sip.sip, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_set(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_FID_RVIDtf, &pL2_entry->un.ipmcast_ip_mc_sip.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_set(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_MC_PMSK_IDXtf, &pL2_entry->un.ipmcast_ip_mc_sip.index, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
            ...
            {
                RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "index=%d, dip=%d", pL2_entry->un.ipmcast_ip_mc.index, pL2_entry->un.ipmcast_ip_mc.dip);

                if (pL2_entry->un.ipmcast_ip_mc.dip == 0)
                {   /* if dip is zero, mean delete entry. So set ip_multi = 0 */
                    ip_multi = 0;
                    ip6_multi = 0;
                }
                else
                {
                    ...
                    if ((ret = table_field_set(unit, MAPLE_L2_IP_MCt, MAPLE_L2_IP_MC_GIPtf, &pL2_entry->un.ipmcast_ip_mc.dip, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_set(unit, MAPLE_L2_IP_MCt, MAPLE_L2_IP_MC_MC_PMSK_IDXtf, &pL2_entry->un.ipmcast_ip_mc.index, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }

                    if ((ret = table_field_set(unit, MAPLE_L2_IP_MCt, MAPLE_L2_IP_MC_FID_RVIDtf , &pL2_entry->un.ipmcast_ip_mc.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
    ...
    switch (pL2_entry->entry_type)
    {
        case L2_UNICAST: /* L2 unicast */
            RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "da_block=%d, sa_block=%d, port=%d, fid=%d, is_static=%d, aging=%d, suspend=%d, nh=%d, \
                   Mac=%x-%x-%x-%x-%x-%x",
                   pL2_entry->un.unicast.dablock, pL2_entry->un.unicast.sablock, pL2_entry->un.unicast.port, pL2_entry->un.unicast.fid,
                   pL2_entry->un.unicast.is_static, pL2_entry->un.unicast.aging, pL2_entry->un.unicast.suspending, pL2_entry->un.unicast.nh, pL2_entry->un.unicast.mac.octet[0],
                   pL2_entry->un.unicast.mac.octet[1], pL2_entry->un.unicast.mac.octet[2], pL2_entry->un.unicast.mac.octet[3],
                   pL2_entry->un.unicast.mac.octet[4], pL2_entry->un.unicast.mac.octet[5]);
            ip_multi = 0;
            ...
            if ((ret = table_field_set(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_DA_BLKtf, &pL2_entry->un.unicast.dablock, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_SA_BLKtf, &pL2_entry->un.unicast.sablock, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_SLPtf, &pL2_entry->un.unicast.port, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_FID_RVIDtf, &pL2_entry->un.unicast.fid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_STATICtf, &pL2_entry->un.unicast.is_static, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_AGEtf, &pL2_entry->un.unicast.aging, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_SUSPENDtf, &pL2_entry->un.unicast.suspending, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_NEXT_HOPtf, &pL2_entry->un.unicast.nh, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_UCt, MAPLE_L2_CAM_UC_VIDtf, &pL2_entry->un.unicast.agg_vid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
        ...
        case L2_MULTICAST: /* l2 Multicast */
            RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "index=%d, rvid=%d, Mac=%x-%x-%x-%x-%x-%x",
                   pL2_entry->un.l2mcast.index, pL2_entry->un.l2mcast.rvid, pL2_entry->un.l2mcast.mac.octet[0],
                   pL2_entry->un.l2mcast.mac.octet[1], pL2_entry->un.l2mcast.mac.octet[2], pL2_entry->un.l2mcast.mac.octet[3],
                   pL2_entry->un.l2mcast.mac.octet[4], pL2_entry->un.l2mcast.mac.octet[5]);
            ip_multi = 0;
            ip6_multi = 0;
            ...
            if ((ret = table_field_set(unit, MAPLE_L2_CAM_MCt, MAPLE_L2_CAM_MC_MC_PMSK_IDXtf, &pL2_entry->un.l2mcast.index, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_MCt, MAPLE_L2_CAM_MC_FID_RVIDtf, &pL2_entry->un.l2mcast.rvid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            if ((ret = table_field_set(unit, MAPLE_L2_CAM_MCt, MAPLE_L2_CAM_MC_VIDtf, &pL2_entry->un.l2mcast.agg_vid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
        ...
        case IP4_MULTICAST: /* IP multicast */
            ...
            else if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
            {
                ...
                else
                {
                    ...
                    if ((ret = table_field_set(unit, MAPLE_L2_CAM_IP_MC_SIPt, MAPLE_L2_CAM_IP_MC_SIP_GIPtf, &pL2_entry->un.ipmcast_ip_mc_sip.dip, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_set(unit, MAPLE_L2_CAM_IP_MC_SIPt, MAPLE_L2_CAM_IP_MC_SIP_SIPtf, &pL2_entry->un.ipmcast_ip_mc_sip.sip, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_set(unit, MAPLE_L2_CAM_IP_MC_SIPt, MAPLE_L2_CAM_IP_MC_SIP_FID_RVIDtf, &pL2_entry->un.ipmcast_ip_mc_sip.rvid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_set(unit, MAPLE_L2_CAM_IP_MC_SIPt, MAPLE_L2_CAM_IP_MC_SIP_MC_PMSK_IDXtf, &pL2_entry->un.ipmcast_ip_mc_sip.index, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
            ...
            {
                RT_LOG(LOG_TRACE, (MOD_DAL|MOD_L2), "index=%d, rvid=%d, dip=%d", pL2_entry->un.ipmcast_ip_mc.index, pL2_entry->un.ipmcast_ip_mc.rvid, pL2_entry->un.ipmcast_ip_mc.dip);
                ...
                else
                {
                    ...
                    if ((ret = table_field_set(unit, MAPLE_L2_CAM_IP_MCt, MAPLE_L2_CAM_IP_MC_GIPtf, &pL2_entry->un.ipmcast_ip_mc.dip, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_set(unit, MAPLE_L2_CAM_IP_MCt, MAPLE_L2_CAM_IP_MC_MC_PMSK_IDXtf, &pL2_entry->un.ipmcast_ip_mc.index, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_set(unit, MAPLE_L2_CAM_IP_MCt, MAPLE_L2_CAM_IP_MC_FID_RVIDtf, &pL2_entry->un.ipmcast_ip_mc.rvid, (uint32 *)&l2cam_entry)) != RT_ERR_OK)
                    {
                        RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
...
dal_maple_l2_addr_add(uint32 unit, rtk_l2_ucastAddr_t *pL2_addr)
{
    ...
    l2_entry.un.unicast.aging      = (pL2_addr->add_op_flags & RTK_L2_ADD_OP_FLAG_AGE_SET) ? pL2_addr->age : 3;
    ...
    l2_entry.un.unicast.nh         = (pL2_addr->flags & RTK_L2_UCAST_FLAG_NEXTHOP) ? TRUE : FALSE;
    l2_entry.un.unicast.suspending = (pL2_addr->state & RTK_L2_UCAST_STATE_SUSPEND) ? TRUE: FALSE;

    l2_entry.un.unicast.vlan_target = pL2_addr->vlan_target;
    l2_entry.un.unicast.route_idx   = pL2_addr->route_idx;
    l2_entry.un.unicast.agg_vid     = pL2_addr->agg_vid;


    if(l2_entry.un.unicast.aging==0 && l2_entry.un.unicast.is_static==0)
    {
        l2_entry.un.unicast.port       = PORT_DONT_CARE_8380;
...
dal_maple_l2_addr_get(uint32 unit, rtk_l2_ucastAddr_t *pL2_data)
{
    ...
    osal_memset(&l2_entry, 0, sizeof(dal_maple_l2_entry_t));
    l2_entry.entry_type     = L2_UNICAST;
    l2_entry.un.unicast.fid    = pL2_data->vid;
    osal_memcpy(&l2_entry.un.unicast.mac, &pL2_data->mac, sizeof(rtk_mac_t));
    ...
    /* fill content */
    osal_memcpy(&pL2_data->mac, &l2_entry.un.unicast.mac, sizeof(rtk_mac_t));
    pL2_data->vid       = l2_entry.un.unicast.fid;
    pL2_data->port      = l2_entry.un.unicast.port;
    ...
    pL2_data->vlan_target   = l2_entry.un.unicast.vlan_target;
    pL2_data->route_idx     = l2_entry.un.unicast.route_idx;
    pL2_data->agg_vid       = l2_entry.un.unicast.agg_vid;
    ...
    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "vid=%d, port=%d, sa_block=%d, da_block=%d, is_static=%d, nh=%d, suspend=%d, agg_vid=:%d",
        pL2_data->vid, pL2_data->port, l2_entry.un.unicast.sablock, l2_entry.un.unicast.dablock, l2_entry.un.unicast.is_static,
    ...
    rtk_l2_ucastAddr_t  *pL2_data)
{
    ...
    pL2_data->vid       = l2_entry.un.unicast.fid;
    pL2_data->port      = l2_entry.un.unicast.port;
    pL2_data->age       = l2_entry.un.unicast.aging;

    if(l2_entry.un.unicast.nh == TRUE)
    {
        pL2_data->vlan_target = l2_entry.un.unicast.vlan_target;
        pL2_data->route_idx = l2_entry.un.unicast.route_idx;
    }
    ...
    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "vid=%d, port=%d, sa_block=%d, da_block=%d, is_static=%d, nh=%d, suspend=%d",
        pL2_data->vid, pL2_data->port, l2_entry.un.unicast.sablock, l2_entry.un.unicast.dablock, l2_entry.un.unicast.is_static, l2_entry.un.unicast.nh, l2_entry.un.unicast.suspending);
...
dal_maple_l2_mcastAddr_get(uint32 unit, rtk_l2_mcastAddr_t *pMcast_addr)
{
    ...
    l2_entry.un.l2mcast.rvid   = pMcast_addr->rvid;
    ...
    pMcast_addr->fwdIndex = (int32)l2_entry.un.l2mcast.index;
    pMcast_addr->agg_vid = l2_entry.un.l2mcast.agg_vid;

    L2_SEM_LOCK(unit);
    if ((ret = table_read(unit, MAPLE_MC_PMSKt, l2_entry.un.l2mcast.index, (uint32 *)&mcast_entry)) != RT_ERR_OK)
    {
        L2_SEM_UNLOCK(unit);
        RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "return failed ret value = %x",ret);
        return RT_ERR_FAILED;
...
dal_maple_l2_mcastAddr_set(uint32 unit, rtk_l2_mcastAddr_t *pMcast_addr)
{
    ...
    l2_entry.entry_type = L2_MULTICAST;
    l2_entry.un.l2mcast.rvid    = pMcast_addr->rvid;
    osal_memcpy(&l2_entry.un.l2mcast.mac.octet[0], &pMcast_addr->mac.octet[0], sizeof(rtk_mac_t));
    ...
    if ((ret = table_write(unit, MAPLE_MC_PMSKt, l2_entry.un.l2mcast.index, (uint32 *)&mcast_entry)) != RT_ERR_OK)
    {
        L2_SEM_UNLOCK(unit);
        RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "return failed ret value = %x",ret);
        return RT_ERR_FAILED;
    ...
    if (l2_entry.un.l2mcast.agg_vid  !=  pMcast_addr->agg_vid)
    {
        l2_entry.un.l2mcast.agg_vid = pMcast_addr->agg_vid;
        if (L2_IN_HASH == index_entry.index_type)
        {
...
dal_maple_l2_mcastAddr_del(uint32 unit, rtk_vlan_t vid, rtk_mac_t *pMac)
{
    ...
    _dal_maple_l2_freeMcastIdx(unit, (int32)l2_entry.un.l2mcast.index);

    osal_memset(&l2_entry.un.l2mcast.mac, 0, sizeof(rtk_mac_t));
    l2_entry.un.l2mcast.rvid    = 0;
    l2_entry.un.l2mcast.index   = 0;
...
dal_maple_l2_mcastAddr_setByIndex(uint32 unit, rtk_l2_mcastAddr_t *pMcast_addr)
{
    ...
    if ((l2_entry.un.l2mcast.agg_vid != pMcast_addr->agg_vid) || (l2_entry.un.l2mcast.index != pMcast_addr->fwdIndex))
    {
        l2_entry.un.l2mcast.agg_vid = pMcast_addr->agg_vid;
        l2_entry.un.l2mcast.index = pMcast_addr->fwdIndex;
        if (L2_IN_HASH == index_entry.index_type)
        {
            /* if found entry is in HASH, programming in CAM */
            ret = _dal_maple_l2_setL2HASHEntry(unit, &l2_entry, &index_entry);
...
dal_maple_l2_mcastAddr_addByIndex(uint32 unit, rtk_l2_mcastAddr_t *pMcast_addr)
{
    ...
    osal_memcpy(&l2_entry.un.l2mcast.mac, &(pMcast_addr->mac), sizeof(rtk_mac_t));
    l2_entry.un.l2mcast.rvid    = pMcast_addr->rvid;
    l2_entry.un.l2mcast.index   = (uint32)(pMcast_addr->fwdIndex);
    l2_entry.un.l2mcast.agg_vid = pMcast_addr->agg_vid;
    ...
    rtk_l2_mcastAddr_t  *pL2_data)
{
    ...
    pL2_data->rvid = l2_entry.un.l2mcast.rvid;
    osal_memcpy(&pL2_data->mac, &l2_entry.un.l2mcast.mac, sizeof(rtk_mac_t));
    pL2_data->agg_vid = l2_entry.un.l2mcast.agg_vid;
    pL2_data->fwdIndex = l2_entry.un.l2mcast.index;
...
dal_maple_l2_ipMcastAddr_get(uint32 unit, rtk_l2_ipMcastAddr_t *pIpMcast_addr)
{
    ...
    {
        l2_entry.un.ipmcast_ip_mc_sip.rvid = pIpMcast_addr->rvid;
        l2_entry.un.ipmcast_ip_mc_sip.dip  = pIpMcast_addr->dip;
        l2_entry.un.ipmcast_ip_mc_sip.sip  = pIpMcast_addr->sip;
    }
    else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
    {
        l2_entry.un.ipmcast_ip_mc.rvid = pIpMcast_addr->rvid;
        l2_entry.un.ipmcast_ip_mc.dip  = pIpMcast_addr->dip;
    }
    ...
    {
        pIpMcast_addr->rvid = l2_entry.un.ipmcast_ip_mc_sip.rvid;
    }
    ...
    if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
        pIpMcast_addr->fwdIndex = l2_entry.un.ipmcast_ip_mc_sip.index;
    else
        pIpMcast_addr->fwdIndex = l2_entry.un.ipmcast_ip_mc.index;
...
dal_maple_l2_ipMcastAddr_set(uint32 unit, rtk_l2_ipMcastAddr_t *pIpmcast_addr)
{
    ...
    if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
        index = l2_entry.un.ipmcast_ip_mc_sip.index;
    else
        index = l2_entry.un.ipmcast_ip_mc.index;
    ...
    if (ipmcst_fvid_cmp == FALSE && LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit] && l2_entry.un.ipmcast_ip_mc_sip.rvid != pIpmcast_addr->rvid)
    {
        l2_entry.un.ipmcast_ip_mc_sip.rvid = pIpmcast_addr->rvid;
        if (L2_IN_HASH == index_entry.index_type)
        {
...
dal_maple_l2_ipMcastAddr_del(uint32 unit, ipaddr_t sip, ipaddr_t dip, rtk_vlan_t vid)
{
    ...
    {
        l2_entry.un.ipmcast_ip_mc_sip.rvid = vid;
        l2_entry.un.ipmcast_ip_mc_sip.dip  = dip;
        l2_entry.un.ipmcast_ip_mc_sip.sip  = sip;
    }
    else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
    {
        l2_entry.un.ipmcast_ip_mc.rvid = vid;
        l2_entry.un.ipmcast_ip_mc.dip  = dip;
    }
    l2_entry.entry_type   = IP4_MULTICAST;
    ...
    if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
        mcFwdIndex = l2_entry.un.ipmcast_ip_mc_sip.index;
    else
        mcFwdIndex = l2_entry.un.ipmcast_ip_mc.index;
    ...
    if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
    {
        l2_entry.un.ipmcast_ip_mc_sip.rvid = 0;
        l2_entry.un.ipmcast_ip_mc_sip.dip  = 0;
        l2_entry.un.ipmcast_ip_mc_sip.sip  = 0;
        l2_entry.un.ipmcast_ip_mc_sip.index = 0;
    }
    else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
    {
        l2_entry.un.ipmcast_ip_mc.rvid = 0;
        l2_entry.un.ipmcast_ip_mc.dip  = 0;
        l2_entry.un.ipmcast_ip_mc.index = 0;
    }
...
dal_maple_l2_ipMcastAddr_addByIndex(uint32 unit, rtk_l2_ipMcastAddr_t *pIpMcast_addr)
{
    ...
    if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
        l2_entry.un.ipmcast_ip_mc_sip.index = (uint32)(pIpMcast_addr->fwdIndex);
    else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
        l2_entry.un.ipmcast_ip_mc.index = (uint32)(pIpMcast_addr->fwdIndex);
...
dal_maple_l2_ipMcastAddr_setByIndex(uint32 unit, rtk_l2_ipMcastAddr_t *pIpmcast_addr)
{
    ...
    if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
        pIndex = &l2_entry.un.ipmcast_ip_mc_sip.index;
    else
        pIndex = &l2_entry.un.ipmcast_ip_mc.index;
    ...
    rtk_l2_ipMcastAddr_t    *pL2_data)
{
    ...
    {
        pL2_data->rvid = l2_entry.un.ipmcast_ip_mc_sip.rvid;
        pL2_data->dip  = l2_entry.un.ipmcast_ip_mc_sip.dip;
        pL2_data->sip  = l2_entry.un.ipmcast_ip_mc_sip.sip;
        index           = l2_entry.un.ipmcast_ip_mc_sip.index;
    }
    else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
    {
        pL2_data->rvid = l2_entry.un.ipmcast_ip_mc.rvid;
        pL2_data->dip  = l2_entry.un.ipmcast_ip_mc.dip;
        index           = l2_entry.un.ipmcast_ip_mc.index;
    }
...
dal_maple_l2_ip6McastAddr_get(uint32 unit, rtk_l2_ip6McastAddr_t *pIpMcast_addr)
{
    ...
    /* search exist or free entry */
    _dal_maple_l2_ip6CareByteConvertToIP(&l2_entry.un.ipmcast_ip_mc_sip.dip, &l2_entry.un.ipmcast_ip_mc_sip.sip,
    ...
    {
        pIpMcast_addr->rvid = l2_entry.un.ipmcast_ip_mc.rvid;
        pIpMcast_addr->fwdIndex = l2_entry.un.ipmcast_ip_mc.index;
    }
...
dal_maple_l2_ip6McastAddr_set(uint32 unit, rtk_l2_ip6McastAddr_t *pIpmcast_addr)
{
    ...
    /* Update fvid if needs */
    if (ipmcst_fvid_cmp == FALSE && LOOKUP_ON_DIP_AND_SIP == ip6HashFmt[unit] && l2_entry.un.ipmcast_ip_mc_sip.rvid != pIpmcast_addr->rvid)
    {
        l2_entry.un.ipmcast_ip_mc_sip.rvid = pIpmcast_addr->rvid;
        if (L2_IN_HASH == index_entry.index_type)
        {
...
dal_maple_l2_ip6McastAddr_del(uint32 unit, rtk_ipv6_addr_t sip, rtk_ipv6_addr_t dip, rtk_vlan_t vid)
{
    ...
    /* search exist or free entry */
    _dal_maple_l2_ip6CareByteConvertToIP(&l2_entry.un.ipmcast_ip_mc_sip.dip, &l2_entry.un.ipmcast_ip_mc_sip.sip, (rtk_ipv6_addr_t *)&dip, (rtk_ipv6_addr_t *)&sip);
    if (LOOKUP_ON_FVID_AND_MAC == ip6HashFmt[unit])
    {
        return RT_ERR_CHIP_NOT_SUPPORTED;
    }
...
dal_maple_l2_nextValidIp6McastAddr_get(uint32 unit, int32 *pScan_idx, rtk_l2_ip6McastAddr_t *pL2_data)
{
    ...
    if (LOOKUP_ON_DIP_AND_SIP == ip6HashFmt[unit])
    {
        pL2_data->rvid = l2_entry.un.ipmcast_ip_mc_sip.rvid;
        index          = l2_entry.un.ipmcast_ip_mc_sip.index;
        //_dal_maple_l2_ip6CareByteConvertToIP6Addr(&pL2_data->dip, &pL2_data->sip, &l2_entry.un.ipmcast_ip_mc_sip.dip, &l2_entry.un.ipmcast_ip_mc_sip.sip);
    }
    else if (LOOKUP_ON_DIP_AND_FVID == ip6HashFmt[unit])
    {
        pL2_data->rvid = l2_entry.un.ipmcast_ip_mc.rvid;
        index          = l2_entry.un.ipmcast_ip_mc.index;
        //_dal_maple_l2_ip6CareByteConvertToIP6Addr(&pL2_data->dip, &pL2_data->sip, &l2_entry.un.ipmcast_ip_mc.dip, &invalid_ipv4_addr);
    ...
    if (pL2_entry->valid)
    {
        ...
        switch (pL2_entry->entry_type)
        {
            case FLOW_TYPE_UNICAST:
                ...
                pL2_entry->un.unicast.flags = 0;
                pL2_entry->un.unicast.state = 0;
                if(l2_entry.un.unicast.nh)
                {
                    pL2_entry->un.unicast.vlan_target = l2_entry.un.unicast.vlan_target;
                    pL2_entry->un.unicast.route_idx = l2_entry.un.unicast.route_idx;
                }
                else
                ...
                for (trk_gid = 0; trk_gid < HAL_MAX_NUM_OF_TRUNK(unit); trk_gid++)
                {
                    if (dal_maple_trunk_port_get(unit, trk_gid, &trunk_portmask) == RT_ERR_OK)
                    {
                        ...
                        if ((RTK_PORTMASK_IS_PORT_SET(trunk_portmask, pL2_entry->un.unicast.port)) &&
                            (first_trunkMember == pL2_entry->un.unicast.port))
                        {
                            pL2_entry->un.unicast.trk_gid = trk_gid;
                ...
                pL2_entry->un.unicast.age = l2_entry.un.unicast.aging;
                break;

            case FLOW_TYPE_L2_MULTI:
                pL2_entry->un.l2mcast.rvid = l2_entry.un.l2mcast.rvid;
                ...
                if ((ret = table_field_get(unit, MAPLE_MC_PMSKt, MAPLE_MC_PMSK_PMSKtf, pL2_entry->un.l2mcast.portmask.bits, (uint32 *) &mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
            ...
            case FLOW_TYPE_IP4_MULTI:
                ...
                {
                    pL2_entry->un.ipmcast.rvid = l2_entry.un.ipmcast_ip_mc_sip.rvid;
                    pL2_entry->un.ipmcast.dip = l2_entry.un.ipmcast_ip_mc_sip.dip;
                    pL2_entry->un.ipmcast.sip = l2_entry.un.ipmcast_ip_mc_sip.sip;
                    pL2_entry->un.ipmcast.fwdIndex = l2_entry.un.ipmcast_ip_mc_sip.index;
                }
                else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
                {
                    pL2_entry->un.ipmcast.rvid = l2_entry.un.ipmcast_ip_mc.rvid;
                    pL2_entry->un.ipmcast.dip = l2_entry.un.ipmcast_ip_mc.dip;
                    pL2_entry->un.ipmcast.fwdIndex = l2_entry.un.ipmcast_ip_mc.index;
                }
                else
                {
                    L2_SEM_UNLOCK(unit);
                ...
                osal_memset(&mcast_entry, 0, sizeof(mcast_entry));
                if ((ret = table_read(unit, MAPLE_MC_PMSKt, pL2_entry->un.ipmcast.fwdIndex, (uint32 *)&mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_MC_PMSKt, MAPLE_MC_PMSK_PMSKtf, pL2_entry->un.ipmcast.portmask.bits, (uint32 *) &mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
            ...
            case FLOW_TYPE_IP6_MULTI:
                ...
                {
                    pL2_entry->un.ip6mcast.rvid = l2_entry.un.ipmcast_ip_mc_sip.rvid;
                    pL2_entry->un.ip6mcast.fwdIndex = l2_entry.un.ipmcast_ip_mc_sip.index;
                    _dal_maple_l2_ip6CareByteConvertToIP6Addr(&pL2_entry->un.ip6mcast.dip, &pL2_entry->un.ip6mcast.sip, &l2_entry.un.ipmcast_ip_mc_sip.dip, &l2_entry.un.ipmcast_ip_mc_sip.sip);
                }
                else if (LOOKUP_ON_DIP_AND_FVID == ip6HashFmt[unit])
                {
                    pL2_entry->un.ip6mcast.rvid = l2_entry.un.ipmcast_ip_mc.rvid;
                    pL2_entry->un.ip6mcast.fwdIndex = l2_entry.un.ipmcast_ip_mc.index;
                    _dal_maple_l2_ip6CareByteConvertToIP6Addr(&pL2_entry->un.ip6mcast.dip, &pL2_entry->un.ip6mcast.sip, &l2_entry.un.ipmcast_ip_mc.dip, &invalid_ipv4_addr);
                    osal_memset(&pL2_entry->un.ip6mcast.sip, 0, sizeof(rtk_ipv6_addr_t));
                }
                else
                {
                    L2_SEM_UNLOCK(unit);
                ...
                osal_memset(&mcast_entry, 0, sizeof(mcast_entry));
                if ((ret = table_read(unit, MAPLE_MC_PMSKt, pL2_entry->un.ip6mcast.fwdIndex, (uint32 *)&mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_MC_PMSKt, MAPLE_MC_PMSK_PMSKtf, pL2_entry->un.ip6mcast.portmask.bits, (uint32 *) &mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
    ...
    uint32          *pCf_retCnt)
{
    ...
    {   /* FLOW_TYPE_L2_MULTI */
        ...
        l2_entry.un.l2mcast.rvid = pL2Addr->un.l2mcast.rvid;
    ...
    {   /* FLOW_TYPE_IP4_MULTI */
        ...
        if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
        {
            l2_entry.un.ipmcast_ip_mc_sip.dip = pL2Addr->un.ipmcast.dip;
            l2_entry.un.ipmcast_ip_mc_sip.sip = pL2Addr->un.ipmcast.sip;
        }
        else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
        {
            l2_entry.un.ipmcast_ip_mc.rvid = pL2Addr->un.ipmcast.rvid;
            l2_entry.un.ipmcast_ip_mc.dip = pL2Addr->un.ipmcast.dip;
        }
        else
        {
            RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
        ...
        {   /* filled conflict address to return buffer pCfAddrList */
            ...
            switch (l2_entry.entry_type)
            {
                case FLOW_TYPE_UNICAST:
                    ...
                    (pCfAddrList + cf_num)->un.unicast.flags = 0;
                    (pCfAddrList + cf_num)->un.unicast.state = 0;
                    ...
                    for (trk_gid = 0; trk_gid < HAL_MAX_NUM_OF_TRUNK(unit); trk_gid++)
                    {
                        if (dal_maple_trunk_port_get(unit, trk_gid, &trunk_portmask) == RT_ERR_OK)
                        {
                            ...
                            if ((RTK_PORTMASK_IS_PORT_SET(trunk_portmask, (pCfAddrList + cf_num)->un.unicast.port)) &&
                                (first_trunkMember == (pCfAddrList + cf_num)->un.unicast.port))
                            {
                                (pCfAddrList + cf_num)->un.unicast.trk_gid = trk_gid;
                    ...
                    (pCfAddrList + cf_num)->un.unicast.age     = l2_entry.un.unicast.aging;
                    (pCfAddrList + cf_num)->un.unicast.l2_idx = (hash_key << 2) | hash_depth;
                    break;

                case FLOW_TYPE_L2_MULTI:
                    (pCfAddrList + cf_num)->un.l2mcast.rvid = l2_entry.un.l2mcast.rvid;
                    ...
                    (pCfAddrList + cf_num)->un.l2mcast.l2_idx      = (hash_key << 2) | hash_depth;
                    osal_memset(&mcast_entry, 0, sizeof(mcast_entry));
                    ...
                    if ((ret = table_field_get(unit, MAPLE_MC_PMSKt, MAPLE_MC_PMSK_PMSKtf, (pCfAddrList + cf_num)->un.l2mcast.portmask.bits, (uint32 *) &mcast_entry)) != RT_ERR_OK)
                    {
                        RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                ...
                case FLOW_TYPE_IP4_MULTI:
                    if (LOOKUP_ON_DIP_AND_SIP == ip4HashFmt[unit])
                    {
                        (pCfAddrList + cf_num)->un.ipmcast.rvid = l2_entry.un.ipmcast_ip_mc_sip.rvid;
                        (pCfAddrList + cf_num)->un.ipmcast.dip = l2_entry.un.ipmcast_ip_mc_sip.dip;
                        (pCfAddrList + cf_num)->un.ipmcast.sip = l2_entry.un.ipmcast_ip_mc_sip.sip;
                        (pCfAddrList + cf_num)->un.ipmcast.fwdIndex = l2_entry.un.ipmcast_ip_mc_sip.index;
                    }
                    else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
                    {
                        (pCfAddrList + cf_num)->un.ipmcast.rvid = l2_entry.un.ipmcast_ip_mc.rvid;
                        (pCfAddrList + cf_num)->un.ipmcast.dip = l2_entry.un.ipmcast_ip_mc.dip;
                        (pCfAddrList + cf_num)->un.ipmcast.fwdIndex = l2_entry.un.ipmcast_ip_mc.index;
                    }
                    (pCfAddrList + cf_num)->un.ipmcast.l2_idx = (hash_key << 2) | hash_depth;
                    osal_memset(&mcast_entry, 0, sizeof(mcast_entry));
                    if ((ret = table_read(unit, MAPLE_MC_PMSKt, l2_entry.un.ipmcast_ip_mc.index, (uint32 *)&mcast_entry)) != RT_ERR_OK)
                    {
                        RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                    if ((ret = table_field_get(unit, MAPLE_MC_PMSKt, MAPLE_MC_PMSK_PMSKtf, (pCfAddrList + cf_num)->un.ipmcast.portmask.bits, (uint32 *) &mcast_entry)) != RT_ERR_OK)
                    {
                        RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                        return ret;
                    }
                ...
                case FLOW_TYPE_IP6_MULTI:
                    ...
                    (pCfAddrList + cf_num)->un.ip6mcast.l2_idx = (hash_key << 2) | hash_depth;
                    osal_memset(&mcast_entry, 0, sizeof(mcast_entry));
                    if ((ret = table_read(unit, MAPLE_MC_PMSKt, l2_entry.un.ipmcast_ip_mc.index, (uint32 *)&mcast_entry)) != RT_ERR_OK)
                    {
                        RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
    ...
    *pScan_idx = find_index;
    ...
    switch ((ip6_multi << 2) | (ip_multi << 1) | is_l2mcast)
    {
        case 0x0: /* L2 unicast */
            ...
            {
                if ((ret = table_field_get(unit, MAPLE_L2_UCt, MAPLE_L2_UC_SLPtf, &dal_entry.un.unicast.port, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_UCt, MAPLE_L2_UC_FID_RVIDtf, &dal_entry.un.unicast.fid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                dal_entry.un.unicast.mac.octet[0] = (uint8)(mac_uint32[1] >> 8);
                dal_entry.un.unicast.mac.octet[1] = (uint8)(mac_uint32[1]);
                dal_entry.un.unicast.mac.octet[2] = (uint8)(mac_uint32[0] >> 24);
                dal_entry.un.unicast.mac.octet[3] = (uint8)(mac_uint32[0] >> 16);
                dal_entry.un.unicast.mac.octet[4] = (uint8)(mac_uint32[0] >> 8);
                dal_entry.un.unicast.mac.octet[5] = (uint8)(mac_uint32[0]);
                dal_entry.un.unicast.sablock      = sablock;
                dal_entry.un.unicast.dablock      = dablock;
                dal_entry.un.unicast.is_static    = is_static;
                dal_entry.un.unicast.aging        = aging;
                dal_entry.un.unicast.suspending   = suspending;
                dal_entry.un.unicast.nh           = next_hop;
                dal_entry.un.unicast.agg_vid      = agg_vid;
                dal_entry.un.unicast.vlan_target  = vid_sel;
                dal_entry.un.unicast.route_idx    = mac_idx;
            }

            /* convert FID from hash algorithm */
            dal_entry.un.unicast.fid = (hashkey & BITMASK_11B) | (dal_entry.un.unicast.fid & (~BITMASK_11B));
            if ((ret = _dal_maple_l2_entryToHashKey(unit, &dal_entry, &partialkey1)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
            dal_entry.un.unicast.fid  = (partialkey1 & BITMASK_11B) | (dal_entry.un.unicast.fid & (~BITMASK_11B));

            break;
        case 0x1: /* l2 Multicast */
            dal_entry.entry_type = L2_MULTICAST;

            if (table_field_get(unit, MAPLE_L2_MCt, MAPLE_L2_MC_MC_PMSK_IDXtf, &dal_entry.un.l2mcast.index, (uint32 *)&l2_entry) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }

            if (table_field_get(unit, MAPLE_L2_MCt, MAPLE_L2_MC_VIDtf, &dal_entry.un.l2mcast.agg_vid, (uint32 *)&l2_entry) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return RT_ERR_FAILED;
            }

            if ((ret = table_field_get(unit, MAPLE_L2_MCt, MAPLE_L2_MC_FID_RVIDtf, &dal_entry.un.l2mcast.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }

            dal_entry.un.l2mcast.mac.octet[0] = (uint8)(mac_uint32[1] >> 8);
            dal_entry.un.l2mcast.mac.octet[1] = (uint8)(mac_uint32[1]);
            dal_entry.un.l2mcast.mac.octet[2] = (uint8)(mac_uint32[0] >> 24);
            dal_entry.un.l2mcast.mac.octet[3] = (uint8)(mac_uint32[0] >> 16);
            dal_entry.un.l2mcast.mac.octet[4] = (uint8)(mac_uint32[0] >> 8);
            dal_entry.un.l2mcast.mac.octet[5] = (uint8)(mac_uint32[0]);

            /* convert RVID from hash algorithm */
            dal_entry.un.l2mcast.rvid = (hashkey & BITMASK_11B) | (dal_entry.un.l2mcast.rvid & (~BITMASK_11B));
            if ((ret = _dal_maple_l2_entryToHashKey(unit, &dal_entry, &partialkey1)) != RT_ERR_OK)
            {
                RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                return ret;
            }
            dal_entry.un.l2mcast.rvid  = (partialkey1 & BITMASK_11B) | (dal_entry.un.l2mcast.rvid & (~BITMASK_11B));
            break;
        case 0x2: /* IPv4 multicast */
            ...
            {
                if ((ret = table_field_get(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_MC_PMSK_IDXtf, &dal_entry.un.ipmcast_ip_mc_sip.index, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_FID_RVIDtf, &dal_entry.un.ipmcast_ip_mc_sip.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_GIPtf, &dal_entry.un.ipmcast_ip_mc_sip.dip, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MC_SIPt, MAPLE_L2_IP_MC_SIP_SIPtf, &dal_entry.un.ipmcast_ip_mc_sip.sip, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                dal_entry.un.ipmcast_ip_mc_sip.sip = (hashkey & BITMASK_11B) | (dal_entry.un.ipmcast_ip_mc_sip.sip & (~BITMASK_11B));
                if (( ret = _dal_maple_l2_entryToHashKey(unit, &dal_entry, &partialkey1)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                dal_entry.un.ipmcast_ip_mc_sip.sip = (partialkey1 & BITMASK_11B) | (dal_entry.un.ipmcast_ip_mc_sip.sip & (~BITMASK_11B));
            }
            else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
            {
                if ((ret = table_field_get(unit, MAPLE_L2_IP_MCt, MAPLE_L2_IP_MC_MC_PMSK_IDXtf, &dal_entry.un.ipmcast_ip_mc.index, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MCt, MAPLE_L2_IP_MC_FID_RVIDtf, &dal_entry.un.ipmcast_ip_mc.rvid, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                if ((ret = table_field_get(unit, MAPLE_L2_IP_MCt, MAPLE_L2_IP_MC_GIPtf, &dal_entry.un.ipmcast_ip_mc.dip, (uint32 *)&l2_entry)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }

                dal_entry.un.ipmcast_ip_mc.rvid = (hashkey & BITMASK_11B) | (dal_entry.un.ipmcast_ip_mc.rvid & (~BITMASK_11B));
                if ((ret = _dal_maple_l2_entryToHashKey(unit, &dal_entry, &partialkey1)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                dal_entry.un.ipmcast_ip_mc.rvid  = (partialkey1 & BITMASK_11B) | (dal_entry.un.ipmcast_ip_mc.rvid & (~BITMASK_11B));
            }
            break;
        case 0x6: /* IPv6 multicast */
    ...
    if (pEntry->valid == 1)
    {
        ...
        {
            case FLOW_TYPE_UNICAST:
                pEntry->un.unicast.vid = dal_entry.un.unicast.fid;
                osal_memcpy(&pEntry->un.unicast.mac, &dal_entry.un.unicast.mac, sizeof(rtk_mac_t));
                pEntry->un.unicast.port = dal_entry.un.unicast.port;
                pEntry->un.unicast.flags = 0;
                pEntry->un.unicast.state = 0;
                ...
                for (trk_gid = 0; trk_gid < HAL_MAX_NUM_OF_TRUNK(unit); trk_gid++)
                {
                    if (dal_maple_trunk_port_get(unit, trk_gid, &trunk_portmask) == RT_ERR_OK)
                    {
                        ...
                        if ((RTK_PORTMASK_IS_PORT_SET(trunk_portmask, pEntry->un.unicast.port)) &&
                            (first_trunkMember == pEntry->un.unicast.port))
                        {
                            pEntry->un.unicast.trk_gid = trk_gid;
                ...
                pEntry->un.unicast.l2_idx = find_index;

                if(dal_entry.un.unicast.sablock)
                    pEntry->un.unicast.flags |= RTK_L2_UCAST_FLAG_SA_BLOCK;
                if(dal_entry.un.unicast.dablock)
                    pEntry->un.unicast.flags |= RTK_L2_UCAST_FLAG_DA_BLOCK;
                if(dal_entry.un.unicast.is_static)
                    pEntry->un.unicast.flags |= RTK_L2_UCAST_FLAG_STATIC;
                if(dal_entry.un.unicast.nh)
                {
                    pEntry->un.unicast.vlan_target = dal_entry.un.unicast.vlan_target;
                    pEntry->un.unicast.route_idx = dal_entry.un.unicast.route_idx;
                    pEntry->un.unicast.flags |= RTK_L2_UCAST_FLAG_NEXTHOP;
                }
                else
                    pEntry->un.unicast.agg_vid = dal_entry.un.unicast.agg_vid;
                if(dal_entry.un.unicast.suspending)
                    pEntry->un.unicast.state |= RTK_L2_UCAST_STATE_SUSPEND;
                if(dal_entry.un.unicast.aging == 0)
                    pEntry->un.unicast.isAged = TRUE;
                else
                    pEntry->un.unicast.isAged = FALSE;
                break;

            case FLOW_TYPE_L2_MULTI:
                pEntry->un.l2mcast.rvid = dal_entry.un.l2mcast.rvid;
                osal_memcpy(&pEntry->un.l2mcast.mac, &dal_entry.un.l2mcast.mac, sizeof(rtk_mac_t));
                pEntry->un.l2mcast.fwdIndex = dal_entry.un.l2mcast.index;
                osal_memset(&mcast_entry, 0, sizeof(mcast_entry));
                if ((ret = table_read(unit, MAPLE_MC_PMSKt, dal_entry.un.l2mcast.index, (uint32 *)&mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_MC_PMSKt, MAPLE_MC_PMSK_PMSKtf, pEntry->un.l2mcast.portmask.bits, (uint32 *) &mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
            ...
            case FLOW_TYPE_IP4_MULTI:
                ...
                {
                    pEntry->un.ipmcast.rvid = dal_entry.un.ipmcast_ip_mc_sip.rvid;
                    pEntry->un.ipmcast.dip = dal_entry.un.ipmcast_ip_mc_sip.dip;
                    pEntry->un.ipmcast.sip = dal_entry.un.ipmcast_ip_mc_sip.sip;
                    pEntry->un.ipmcast.fwdIndex = dal_entry.un.ipmcast_ip_mc_sip.index;
                }
                else if (LOOKUP_ON_DIP_AND_FVID == ip4HashFmt[unit])
                {
                    pEntry->un.ipmcast.rvid = dal_entry.un.ipmcast_ip_mc.rvid;
                    pEntry->un.ipmcast.dip = dal_entry.un.ipmcast_ip_mc.dip;
                    pEntry->un.ipmcast.fwdIndex = dal_entry.un.ipmcast_ip_mc.index;
                }
                else
                {
                    L2_SEM_UNLOCK(unit);
                ...
                osal_memset(&mcast_entry, 0, sizeof(mcast_entry));
                if ((ret = table_read(unit, MAPLE_MC_PMSKt, pEntry->un.ipmcast.fwdIndex, (uint32 *)&mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_MC_PMSKt, MAPLE_MC_PMSK_PMSKtf, pEntry->un.ipmcast.portmask.bits, (uint32 *) &mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
            ...
            case FLOW_TYPE_IP6_MULTI:
                ...
                {
                    pEntry->un.ip6mcast.rvid = dal_entry.un.ipmcast_ip_mc_sip.rvid;
                    pEntry->un.ip6mcast.fwdIndex = dal_entry.un.ipmcast_ip_mc_sip.index;
                    _dal_maple_l2_ip6CareByteConvertToIP6Addr(&pEntry->un.ip6mcast.dip, &pEntry->un.ip6mcast.sip, &dal_entry.un.ipmcast_ip_mc_sip.dip, &dal_entry.un.ipmcast_ip_mc_sip.sip);
                }
                else if (LOOKUP_ON_DIP_AND_FVID == ip6HashFmt[unit])
                {
                    pEntry->un.ip6mcast.rvid = dal_entry.un.ipmcast_ip_mc.rvid;
                    pEntry->un.ip6mcast.fwdIndex = dal_entry.un.ipmcast_ip_mc.index;
                    _dal_maple_l2_ip6CareByteConvertToIP6Addr(&pEntry->un.ip6mcast.dip, &pEntry->un.ip6mcast.sip, &dal_entry.un.ipmcast_ip_mc.dip, &invalid_ipv4_addr);
                    osal_memset(&pEntry->un.ip6mcast.sip, 0, sizeof(rtk_ipv6_addr_t));
                }
                else
                {
                    L2_SEM_UNLOCK(unit);
                ...
                osal_memset(&mcast_entry, 0, sizeof(mcast_entry));
                if ((ret = table_read(unit, MAPLE_MC_PMSKt, pEntry->un.ip6mcast.fwdIndex, (uint32 *)&mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
                if ((ret = table_field_get(unit, MAPLE_MC_PMSKt, MAPLE_MC_PMSK_PMSKtf, pEntry->un.ip6mcast.portmask.bits, (uint32 *) &mcast_entry)) != RT_ERR_OK)
                {
                    L2_SEM_UNLOCK(unit);
                    RT_LOG(LOG_DEBUG, (MOD_DAL|MOD_L2), "");
                    return ret;
...
dal_maple_l2_macLearningCnt_get(uint32 unit, rtk_l2_macLimitType_t type, rtk_l2_macCnt_t *pLimitCnt)
{
    ...
    switch(type)
    {
        case L2_MAC_LIMIT_GLOBAL:
            return dal_maple_l2_learningCnt_get(unit, &pLimitCnt->un.glbCnt);
        case L2_MAC_LIMIT_PORT:
            return dal_maple_l2_portLearningCnt_get(unit, pLimitCnt->un.portTrkCnt.id, &pLimitCnt->un.portTrkCnt.cnt);
        case L2_MAC_LIMIT_FID:
            return dal_maple_l2_fidLearningCnt_get(unit, pLimitCnt->un.fidCnt.entryId, &pLimitCnt->un.fidCnt.cnt);
        default:
            return RT_ERR_INPUT;
    }
}
...
dal_maple_l2_limitLearningNum_get(uint32 unit, rtk_l2_macLimitType_t type, rtk_l2_macCnt_t *pLimitCnt)
{
    ...
    {
        case L2_MAC_LIMIT_GLOBAL:
            return dal_maple_l2_limitLearningCnt_get(unit, &pLimitCnt->un.glbCnt);
        case L2_MAC_LIMIT_PORT:
            return dal_maple_l2_portLimitLearningCnt_get(unit, pLimitCnt->un.portTrkCnt.id, &pLimitCnt->un.portTrkCnt.cnt);
        case L2_MAC_LIMIT_FID:
            if((ret= dal_maple_l2_fidLimitLearningEntry_get(unit, pLimitCnt->un.fidCnt.entryId, &fidMacLimitEntry)) !=RT_ERR_OK)
                return ret;
            pLimitCnt->un.fidCnt.cnt = fidMacLimitEntry.maxNum;
            return RT_ERR_OK;
        default:
            return RT_ERR_INPUT;
    }
...
dal_maple_l2_limitLearningNum_set(uint32 unit, rtk_l2_macLimitType_t type, rtk_l2_macCnt_t *pLimitCnt)
{
    ...
    switch(type)
    {
        case L2_MAC_LIMIT_GLOBAL:
            ...
            return dal_maple_l2_limitLearningCnt_set(unit, pLimitCnt->un.glbCnt);
        case L2_MAC_LIMIT_PORT:
            if (pLimitCnt->un.portTrkCnt.cnt == L2_MAC_CST_DISABLE)
                pLimitCnt->un.portTrkCnt.cnt = HAL_L2_LEARN_LIMIT_CNT_DISABLE(unit);
            return dal_maple_l2_portLimitLearningCnt_set(unit, pLimitCnt->un.portTrkCnt.id, pLimitCnt->un.portTrkCnt.cnt);
        case L2_MAC_LIMIT_FID:
            if (pLimitCnt->un.fidCnt.cnt == L2_MAC_CST_DISABLE)
                pLimitCnt->un.fidCnt.cnt = HAL_L2_LEARN_LIMIT_CNT_DISABLE(unit);
            if((ret= dal_maple_l2_fidLimitLearningEntry_get(unit, pLimitCnt->un.fidCnt.entryId, &fidMacLimitEntry)) != RT_ERR_OK)
                return ret;
            fidMacLimitEntry.maxNum = pLimitCnt->un.fidCnt.cnt;
            return dal_maple_l2_fidLimitLearningEntry_set(unit, pLimitCnt->un.fidCnt.entryId, &fidMacLimitEntry);
        default:
            return RT_ERR_INPUT;
    }
}
...
dal_maple_l2_limitLearningAction_get(uint32 unit, rtk_l2_macLimitType_t type, rtk_l2_macLimitAction_t *pAction)
{
    ...
    {
        case L2_MAC_LIMIT_GLOBAL:
            return dal_maple_l2_limitLearningCntAction_get(unit, (rtk_l2_limitLearnCntAction_t*)&pAction->un.glbAct);
        case L2_MAC_LIMIT_PORT:
            return dal_maple_l2_portLimitLearningCntAction_get(unit, pAction->un.portTrkAct.id, (rtk_l2_limitLearnCntAction_t*)&pAction->un.portTrkAct.act);
        case L2_MAC_LIMIT_FID:
            return dal_maple_l2_fidLearningCntAction_get(unit, (rtk_l2_limitLearnCntAction_t*)&pAction->un.fidAct.act);
        default:
            return RT_ERR_INPUT;
    }
}
...
dal_maple_l2_limitLearningAction_set(uint32 unit, rtk_l2_macLimitType_t type, rtk_l2_macLimitAction_t *pAction)
{
    ...
    {
        case L2_MAC_LIMIT_GLOBAL:
            return dal_maple_l2_limitLearningCntAction_set(unit, pAction->un.glbAct);
        case L2_MAC_LIMIT_PORT:
            return dal_maple_l2_portLimitLearningCntAction_set(unit, pAction->un.portTrkAct.id, pAction->un.portTrkAct.act);
        case L2_MAC_LIMIT_FID:
            return dal_maple_l2_fidLearningCntAction_set(unit, pAction->un.fidAct.act);
        default:
            return RT_ERR_INPUT;
    }
}
    ...
    rtk_l2_portMoveAct_t        *pAction)
{
    ...
    switch(type)
    {
        case L2_PORT_MOVE_DYNAMIC:
            return dal_maple_l2_portLegalPortMoveAction_get(unit, pAction->un.dynAct.port, &pAction->un.dynAct.act);
        case L2_PORT_MOVE_STATIC:
            HWP_PORT_TRAVS(unit, port)
            {
                return dal_maple_l2_staticPortMoveAction_get(unit, port, &pAction->un.sttAct.act);
            }
        default:
            return RT_ERR_INPUT;
    }
    ...
    rtk_l2_portMoveAct_t        *pAction)
{
    ...
    {
        case L2_PORT_MOVE_DYNAMIC:
            return dal_maple_l2_portLegalPortMoveAction_set(unit, pAction->un.dynAct.port, pAction->un.dynAct.act);
        case L2_PORT_MOVE_STATIC:
            HWP_PORT_TRAVS_EXCEPT_CPU(unit, port)
            {
                if ((ret = dal_maple_l2_staticPortMoveAction_set(unit, port, pAction->un.sttAct.act)) != RT_ERR_OK)
                {
                    RT_ERR(ret, (MOD_DAL|MOD_L2), "");
                    return ret;
                }
