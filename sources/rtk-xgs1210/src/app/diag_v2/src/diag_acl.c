 ...
 *
 * $Revision: 96534 $
 * $Date: 2019-04-24 19:46:04 +0800 (Wed, 24 Apr 2019) $
 *
        ...
        char **field_name_ptr)
{
    ...
    diag_util_mprintf("index %u field %s\n", *index_ptr, *field_name_ptr);
    ...
    uint32_t *index_ptr)
{
    ...
    diag_util_printf("%s ", _diag_acl_phaseStr_get(phase));
    diag_util_mprintf("entry index %u is ", *index_ptr);
    ...
    uint32_t *index_ptr)
{
    ...
    diag_util_printf("%s ", _diag_acl_phaseStr_get(phase));
    diag_util_mprintf("entry index %u reverse state is ", *index_ptr);
    ...
    uint32_t *index_ptr)
{
    ...
    diag_util_printf("%s ", _diag_acl_phaseStr_get(phase));
    diag_util_mprintf("entry index %u aggregate 1 state is ", *index_ptr);
    ...
    uint32_t *index_ptr)
{
    ...
    diag_util_printf("%s ", _diag_acl_phaseStr_get(phase));
    diag_util_mprintf("entry index %u aggregate 2 state is ", *index_ptr);
    ...
    uint32_t *index_ptr)
{
    ...
    diag_util_mprintf("entry index %u Hit Status: %s\n", *index_ptr, (status == TRUE)?"True":"False");
    ...
    uint32_t  *index_ptr)
{
    ...
    diag_util_mprintf("VLAN id range check index %u:\n", *index_ptr);
    ...
    uint32_t  *index_ptr)
{
    ...
    diag_util_mprintf("Field selector range check index %u:\n", *index_ptr);
    ...
    uint32_t  *index_ptr)
{
    ...
    diag_util_mprintf("L4 port range check index %u:\n", *index_ptr);
    ...
    uint32_t  *index_ptr)
{
    ...
    diag_util_mprintf("Packet len range check index %u:\n", *index_ptr);
    ...
    uint32_t *index_ptr)
{
    ...
    diag_util_mprintf("Source port range check index %u:\n", *index_ptr);
    ...
    uint32_t *index_ptr)
{
    ...
    diag_util_mprintf("Destination port range check index %u:\n", *index_ptr);
    diag_util_lPortMask2str(port_list, &port_range.port_mask);
    diag_util_mprintf("\tconfigured ports: %s\n", port_list);
    ...
    uint32_t *index_ptr)
{
    ...
    diag_util_mprintf("Counter index %u: \n", *index_ptr);
