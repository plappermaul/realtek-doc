 ...
 */
cparser_result_t
cparser_cmd_pktgen_get_monitor_state(
    cparser_context_t *context)
{
    uint32  unit;
    uint32  master_view_unit;
    ...
    cfg.unit = unit;
    GETSOCKOPT(RTDRV_EXT_PKTGEN_MONITOR_STATE_GET, &cfg, rtdrv_ext_pktGenCfg_t, 1);

    diag_util_mprintf("\tPktgen monitor status : ");
    diag_util_mprintf("%s\n", text_state[cfg.enable]);
 ...
 */
cparser_result_t
cparser_cmd_pktgen_set_monitor_state_enable_disable(
    cparser_context_t *context)
{
    uint32  unit;
    uint32  master_view_unit;
    ...
    SETSOCKOPT(RTDRV_EXT_PKTGEN_MONITOR_STATE_SET, &cfg, rtdrv_ext_pktGenCfg_t, 1);

    return CPARSER_OK;
}   /* end of cparser_cmd_pktgen_set_state_enable_disable */


/* loopback test rx tx packet thread */
