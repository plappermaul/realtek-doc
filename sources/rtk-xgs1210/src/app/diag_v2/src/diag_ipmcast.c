 ...
 *
 * $Revision: 98414 $
 * $Date: 2019-07-05 14:02:05 +0800 (Fri, 05 Jul 2019) $
 *
 ...
 */
cparser_result_t
cparser_cmd_ipmcast_add_addr_vrf_id_vrf_id_sip_sip_dip_dip_vlan_vid_group_group_id_priority(
 ...
 */
cparser_result_t
cparser_cmd_ipmcast_add_addr_vrf_id_vrf_id_sip_sip_dip_dip_vlan_vid_group_group_id_l2_action_forward_trap_to_cpu_copy_to_cpu_drop_l3_action_forward_trap_to_cpu_copy_to_cpu_drop_rpf_fail_action_trap_to_cpu_drop_copy_to_cpu_assert_check_ttl_min_ttl_min_mtu_max_mtu_max_priority(
    cparser_context_t *context,
    uint32_t *vrf_id_ptr,
    uint32_t *sip_ptr,
    uint32_t *dip_ptr,
    ...
    uint32_t *priority_ptr)
{
    ...
    ipmcAddr.src_intf.vlan_id = *vid_ptr;
    ipmcAddr.group = *group_id_ptr;
    DIAG_IPMC_PARSE_IPMC_ADDR_ACT(14, ipmcAddr.l2_fwd_act);
    DIAG_IPMC_PARSE_IPMC_ADDR_ACT(16, ipmcAddr.l3_fwd_act);
    DIAG_IPMC_PARSE_IPMC_RPF_FAIL_ACT(18, ipmcAddr.l3_rpf_fail_act);
 ...
 */
cparser_result_t
cparser_cmd_ipmcast_add_addr_vrf_id_vrf_id_sip6_sip_dip6_dip_vlan_vid_group_group_id_priority(
    cparser_context_t *context,
    uint32_t *vrf_id_ptr,
    char **sip_ptr,
    char **dip_ptr,
 ...
 */
cparser_result_t
cparser_cmd_ipmcast_add_addr_vrf_id_vrf_id_sip6_sip_dip6_dip_vlan_vid_group_group_id_l2_action_forward_trap_to_cpu_copy_to_cpu_drop_l3_action_forward_trap_to_cpu_copy_to_cpu_drop_rpf_fail_action_trap_to_cpu_drop_copy_to_cpu_assert_check_ttl_min_ttl_min_mtu_max_mtu_max_priority(
    cparser_context_t *context,
    uint32_t *vrf_id_ptr,
    char **sip_ptr,
    char **dip_ptr,
 ...
 */
cparser_result_t
cparser_cmd_ipmcast_add_addr_vrf_id_vrf_id_sip_sip_dip_dip_intf_intf_id_group_group_id_priority(
    cparser_context_t *context,
    uint32_t *vrf_id_ptr,
    uint32_t *sip_ptr,
    uint32_t *dip_ptr,
 ...
 */
cparser_result_t
cparser_cmd_ipmcast_add_addr_vrf_id_vrf_id_sip_sip_dip_dip_intf_intf_id_group_group_id_l2_action_forward_trap_to_cpu_copy_to_cpu_drop_l3_action_forward_trap_to_cpu_copy_to_cpu_drop_rpf_fail_action_trap_to_cpu_drop_copy_to_cpu_assert_check_ttl_min_ttl_min_mtu_max_mtu_max_priority(
    cparser_context_t *context,
    uint32_t *vrf_id_ptr,
    uint32_t *sip_ptr,
    uint32_t *dip_ptr,
 ...
 */
cparser_result_t
cparser_cmd_ipmcast_add_addr_vrf_id_vrf_id_sip6_sip_dip6_dip_intf_intf_id_group_group_id_priority(
    cparser_context_t *context,
    uint32_t *vrf_id_ptr,
    char **sip_ptr,
    char **dip_ptr,
 ...
 */
cparser_result_t
cparser_cmd_ipmcast_add_addr_vrf_id_vrf_id_sip6_sip_dip6_dip_intf_intf_id_group_group_id_l2_action_forward_trap_to_cpu_copy_to_cpu_drop_l3_action_forward_trap_to_cpu_copy_to_cpu_drop_rpf_fail_action_trap_to_cpu_drop_copy_to_cpu_assert_check_ttl_min_ttl_min_mtu_max_mtu_max_priority(
    cparser_context_t *context,
    uint32_t *vrf_id_ptr,
    char **sip_ptr,
    char **dip_ptr,
