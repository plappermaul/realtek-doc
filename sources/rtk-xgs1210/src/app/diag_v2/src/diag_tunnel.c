 ...
 */
cparser_result_t
cparser_cmd_tunnel_set_decap_ip6_sip_fail_isatap_sip_fail_6to4_sip_fail_6to4_dip_fail_6rd_dip_fail_action_drop_trap_to_cpu_trap_to_master(
    cparser_context_t *context)
{
    uint32  unit;
    int32   ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_set_decap_ip6_sip_fail_isatap_sip_fail_6to4_sip_fail_6to4_dip_fail_6rd_dip_fail_action_drop_trap_to_cpu_trap_to_master */
#endif
 ...
 */
cparser_result_t
cparser_cmd_tunnel_get_decap_ip6_sip_fail_isatap_sip_fail_6to4_sip_fail_6to4_dip_fail_6rd_dip_fail_action(
    cparser_context_t *context)
{
    uint32  unit;
    int32   ret = RT_ERR_FAILED;
    ...
    return CPARSER_OK;
}   /* end of cparser_cmd_tunnel_get_decap_ip6_sip_fail_isatap_sip_fail_6to4_sip_fail_6to4_dip_fail_6rd_dip_fail_action */
#endif
