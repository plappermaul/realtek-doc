    ...
    rtk_flowctrl_pauseOnAction_t    *pAction)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portPauseOnAction_get(unit, port, pAction);
    ...
    rtk_flowctrl_pauseOnAction_t    action)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portPauseOnAction_set(unit, port, action);
...
rtk_flowctrl_portPauseOnAllowedPageNum_get(uint32 unit, rtk_port_t port, uint32 *pPageNum)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portPauseOnAllowedPageNum_get(unit, port, pPageNum);
...
rtk_flowctrl_portPauseOnAllowedPageNum_set(uint32 unit, rtk_port_t port, uint32 pageNum)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portPauseOnAllowedPageNum_set(unit, port, pageNum);
...
rtk_flowctrl_igrGuarEnable_get(uint32 unit, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrGuarEnable_get(unit, pEnable);
}
...
rtk_flowctrl_igrGuarEnable_set(uint32 unit, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrGuarEnable_set(unit, enable);
}
...
rtk_flowctrl_igrJumboSystemPauseThresh_get(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrJumboSystemPauseThresh_get(unit, pThresh);
}
...
rtk_flowctrl_igrJumboSystemPauseThresh_set(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrJumboSystemPauseThresh_set(unit, pThresh);
}
...
rtk_flowctrl_portIgrPortThreshGroupSel_get(uint32 unit, rtk_port_t port, uint32 *pGrp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portIgrPortThreshGroupSel_get(unit, port, pGrp_idx);
...
rtk_flowctrl_portIgrPortThreshGroupSel_set(uint32 unit, rtk_port_t port, uint32 grp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portIgrPortThreshGroupSel_set(unit, port, grp_idx);
...
rtk_flowctrl_igrJumboSystemCongestThresh_get(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrJumboSystemCongestThresh_get(unit, pThresh);
}
...
rtk_flowctrl_igrJumboSystemCongestThresh_set(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrJumboSystemCongestThresh_set(unit, pThresh);
}
...
rtk_flowctrl_jumboModeStatus_get(uint32 unit, uint32 *pStatus)
{
    ...
    return RT_MAPPER(unit)->flowctrl_jumboModeStatus_get(unit, pStatus);
}
...
rtk_flowctrl_jumboModeEnable_get(uint32 unit, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_jumboModeEnable_get(unit, pEnable);
}
...
rtk_flowctrl_jumboModeEnable_set(uint32 unit, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_jumboModeEnable_set(unit, enable);
}
...
rtk_flowctrl_jumboModeLength_get(uint32 unit, uint32 *pLength)
{
    ...
    return RT_MAPPER(unit)->flowctrl_jumboModeLength_get(unit, pLength);
}
...
rtk_flowctrl_jumboModeLength_set(uint32 unit, uint32 length)
{
    ...
    return RT_MAPPER(unit)->flowctrl_jumboModeLength_set(unit, length);
}
...
rtk_flowctrl_egrSystemUtilThresh_get(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrSystemUtilThresh_get(unit, pThresh);
}
...
rtk_flowctrl_egrSystemUtilThresh_set(uint32 unit, rtk_flowctrl_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_egrSystemUtilThresh_set(unit, pThresh);
}
...
rtk_flowctrl_portEgrDropRefCongestEnable_get(uint32 unit, rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portEgrDropRefCongestEnable_get(unit, port, pEnable);
...
rtk_flowctrl_portEgrDropRefCongestEnable_set(uint32 unit, rtk_port_t port, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portEgrDropRefCongestEnable_set(unit, port, enable);
...
rtk_flowctrl_portEgrDropThreshGroupSel_get(uint32 unit, rtk_port_t port, uint32 *pGrp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portEgrDropThreshGroupSel_get(unit, port, pGrp_idx);
...
rtk_flowctrl_portEgrDropThreshGroupSel_set(uint32 unit, rtk_port_t port, uint32 grp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portEgrDropThreshGroupSel_set(unit, port, grp_idx);
...
rtk_flowctrl_portEgrQueueDropForceEnable_get(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portEgrQueueDropForceEnable_get(unit, port, queue, pEnable);
...
rtk_flowctrl_portEgrQueueDropForceEnable_set(uint32 unit, rtk_port_t port, rtk_qid_t queue, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portEgrQueueDropForceEnable_set(unit, port, queue, enable);
...
rtk_flowctrl_igrQueueDropThresh_get(uint32 unit, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueueDropThresh_get(unit, queue, pThresh);
}
...
rtk_flowctrl_igrQueueDropThresh_set(uint32 unit, rtk_qid_t queue, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_igrQueueDropThresh_set(unit, queue, pThresh);
}
...
rtk_flowctrl_e2eCascadePortThresh_get(uint32 unit, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_e2eCascadePortThresh_get(unit, pThresh);
}   /* end of rtk_flowctrl_e2eCascadePortThresh_get */
...
rtk_flowctrl_e2eCascadePortThresh_set(uint32 unit, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_e2eCascadePortThresh_set(unit, pThresh);
}   /* end of rtk_flowctrl_e2eCascadePortThresh_set */
...
rtk_flowctrl_e2eRemotePortPauseThreshGroup_get(uint32 unit, uint32 grp_idx, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_e2eRemotePortPauseThreshGroup_get(unit, grp_idx, pThresh);
}   /* end of rtk_flowctrl_e2eRemotePortPauseThreshGroup_get */
...
rtk_flowctrl_e2eRemotePortPauseThreshGroup_set(uint32 unit, uint32 grp_idx, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_e2eRemotePortPauseThreshGroup_set(unit, grp_idx, pThresh);
}   /* end of rtk_flowctrl_e2eRemotePortPauseThreshGroup_set */
...
rtk_flowctrl_e2eRemotePortCongestThreshGroup_get(uint32 unit, uint32 grp_idx, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_e2eRemotePortCongestThreshGroup_get(unit, grp_idx, pThresh);
}   /* end of rtk_flowctrl_e2eRemotePortCongestThreshGroup_get */
...
rtk_flowctrl_e2eRemotePortCongestThreshGroup_set(uint32 unit, uint32 grp_idx, rtk_flowctrl_drop_thresh_t *pThresh)
{
    ...
    return RT_MAPPER(unit)->flowctrl_e2eRemotePortCongestThreshGroup_set(unit, grp_idx, pThresh);
}   /* end of rtk_flowctrl_e2eRemotePortCongestThreshGroup_set */
...
rtk_flowctrl_portE2eRemotePortThreshGroupSel_get(uint32 unit, rtk_port_t port, uint32 *pGrp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portE2eRemotePortThreshGroupSel_get(unit, port, pGrp_idx);
}   /* end of rtk_flowctrl_portE2eRemotePortThreshGroupSel_get */
...
rtk_flowctrl_portE2eRemotePortThreshGroupSel_set(uint32 unit, rtk_port_t port, uint32 grp_idx)
{
    ...
    return RT_MAPPER(unit)->flowctrl_portE2eRemotePortThreshGroupSel_set(unit, port, grp_idx);
}   /* end of rtk_flowctrl_portE2eRemotePortThreshGroupSel_set */
...
rtk_flowctrl_tagPauseEnable_get(uint32 unit, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_tagPauseEnable_get(unit, pEnable);
}   /* end of rtk_flowctrl_tagPauseEnable_get */
...
rtk_flowctrl_tagPauseEnable_set(uint32 unit, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_tagPauseEnable_set(unit, enable);
}   /* end of rtk_flowctrl_tagPauseEnable_set */
...
rtk_flowctrl_halfConsecutiveRetryEnable_get(uint32 unit, rtk_enable_t *pEnable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_halfConsecutiveRetryEnable_get(unit, pEnable);
}   /* end of rtk_flowctrl_halfConsecutiveRetryEnable_get */
...
rtk_flowctrl_halfConsecutiveRetryEnable_set(uint32 unit, rtk_enable_t enable)
{
    ...
    return RT_MAPPER(unit)->flowctrl_halfConsecutiveRetryEnable_set(unit, enable);
}   /* end of rtk_flowctrl_halfConsecutiveRetryEnable_set */
