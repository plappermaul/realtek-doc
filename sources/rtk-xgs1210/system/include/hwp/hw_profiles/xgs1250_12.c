 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the XGS1250_12 board
 *
 * Feature : XGS1250_12
 *
 */

 static hwp_swDescp_t xgs1250_12_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 1, .phy_idx = 1,        .smi = 1,        .phy_addr =  8,        .led_c = 1,        .led_f = 1,       .led_layout = SINGLE_SET,},
        { .mac_id = 25, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 2, .phy_idx = 2,        .smi = 2,        .phy_addr =  8,        .led_c = 1,        .led_f = 1,       .led_layout = SINGLE_SET,},
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_XGE,   .medi = HWP_COPPER, .sds_idx = 3, .phy_idx = 3,        .smi = 3,        .phy_addr =  8,        .led_c = 1,        .led_f = 1,       .led_layout = SINGLE_SET,},
    ...
    .led.descp = {
        ...
        .led_definition_set[1].led[0] = 0xA0B,          /* 10G, 5G, 2.5G link/act */
        .led_definition_set[1].led[1] = 0xA82,          /* 5G, 10/100 link/act */
        .led_definition_set[1].led[2] = 0xA28,          /* 2.5G, 1G link/act */
        .led_definition_set[1].led[3] = 0xA0B,          /* 10G, 5G, 2.5G link/act */
    ...
    .serdes.descp = {
        ...
        [1] = { .sds_id = 6, .mode = RTK_MII_USXGMII_10GSXGMII,  .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL },
        [2] = { .sds_id = 7, .mode = RTK_MII_USXGMII_10GSXGMII,  .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL },
        [3] = { .sds_id = 8, .mode = RTK_MII_USXGMII_10GSXGMII,  .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL },
    ...
    .phy.descp = {
        ...
        [1] = { .chip = RTK_PHYTYPE_CUST1,        .mac_id = 24, .phy_max = 1 },
        [2] = { .chip = RTK_PHYTYPE_CUST1,        .mac_id = 25, .phy_max = 1 },
        [3] = { .chip = RTK_PHYTYPE_CUST1,        .mac_id = 26, .phy_max = 1 },
        [4] = { .chip = HWP_END },
    },   /* .phy.descp */
 ...
 * hardware profile
 */
static hwp_hwProfile_t xgs1250_12 = {

    .identifier.name        = "XGS1250_12",
    .identifier.id          = HWP_XGS1250_12,
