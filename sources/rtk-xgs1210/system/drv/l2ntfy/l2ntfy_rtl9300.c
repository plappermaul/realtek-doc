 ...
 *
 * $Revision: 96769 $
 * $Date: 2019-05-10 10:34:04 +0800 (Fri, 10 May 2019) $
 *
...
{
    RT_INIT_CHK(l2ntfy_init[unit]);
    RT_PARAM_CHK((thresh > RTL9300_L2NTFY_BP_THR_MAX), RT_ERR_INPUT);
...
{
    RT_PARAM_CHK((num > RTL9300_L2NTFY_PKT_EVENT_MAX), RT_ERR_INPUT);
