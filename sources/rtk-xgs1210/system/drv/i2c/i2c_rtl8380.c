...
int32 r8380_i2c_init(uint32 unit)
{
...
int32 r8380_i2c_dev_init(uint32 unit, i2c_devConf_t *i2c_dev)
{
    int32     ret;
...
int32 r8380_i2c_read(uint32 unit, i2c_devConf_t *i2c_dev, uint32 reg_idex, uint8 *pBuff)
{
    int32    ret;
...
int32 r8380_i2c_write(uint32 unit, i2c_devConf_t *i2c_dev, uint32 reg_idex, uint8 *pBuff)
{
    int32    ret;
...
int32 r8380_i2c_type_set(uint32 unit, drv_i2c_devId_t i2c_dev_id, uint32 i2c_addrWidth, uint32 i2c_dataWidth, uint32 chipid, uint32 delay)
{
    int32    ret;
...
int32 r8380_i2c_type_get(uint32 unit, drv_i2c_devId_t i2c_dev_id, uint32 * i2c_addrWidth, uint32 * i2c_dataWidth, uint32 * pchipid, uint32 * pdelay)
{
    int32    ret;
