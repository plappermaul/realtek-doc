 ...
 *
 * $Revision: 95761 $
 * $Date: 2019-03-14 19:02:11 +0800 (Thu, 14 Mar 2019) $
 *
...
static uint32       nic_rx_success_cntr[8];
...
drv_nic_cntr_dump(uint32 unit)
{
    ...
    for (i =0 ;i<8;i++)
        osal_printf("Rx success counter%d : %0u \n", i, nic_rx_success_cntr[i]);
