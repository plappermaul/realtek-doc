...
/* Function Name:
 *      debug_mem_baseAddr_show
 * Description:
 *      Show sdk memory base addresses
 * Input:
 *      unit - unit id
 * Output:
 *      None
 ...
 */
int32
debug_mem_baseAddr_show(uint32 unit)
{
    osal_printf("\n");
    osal_printf("swcore_base: 0x%llX\n", (uint64)ioal_db[unit].swcore_base);
    osal_printf("soc_base:    0x%llX\n", (uint64)ioal_db[unit].soc_base);
    osal_printf("sram_base:   0x%llX\n", (uint64)ioal_db[unit].sram_base);

    return RT_ERR_OK;
} /* end of debug_mem_baseAddr_show */
