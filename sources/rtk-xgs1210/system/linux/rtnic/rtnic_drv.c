 ...
 *
 * $Revision: 85252 $
 * $Date: 2018-01-12 11:29:17 +0800 (Fri, 12 Jan 2018) $
 *
...
int32 rtnic_handler_register(rtnic_handler_t *pHandler)
{
    ...
    if (0 == ret)
    {
        ...
        if ((osal_thread_t)NULL == (pHandlerListNew->rxThreadId = osal_thread_create(pHandler->pName, 32768, threadPri, (void *)_rtnic_dequeue_thread, pHandlerListNew)))
        {
...
#if ((LINUX_VERSION_CODE > KERNEL_VERSION(2,6,19)) && (LINUX_VERSION_CODE < KERNEL_VERSION(3,6,0)))
