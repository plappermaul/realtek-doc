...
static struct mtd_partition rtk_nandboot_128M_parts[] = {
    { name: "LOADER",       offset: 0,          size: 0xc0000,   mask_flags:0},
...
rtk_spi_nand_profile (struct mtd_info *mtd)
{
    ...
    rtk_nand_ids(mtd);
    if(nand_scan(mtd, g_spiNand_chipNum)){
