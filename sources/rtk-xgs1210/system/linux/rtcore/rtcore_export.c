 ...
 *
 * $Revision: 98236 $
 * $Date: 2019-06-27 13:26:44 +0800 (Thu, 27 Jun 2019) $
 *
...
EXPORT_SYMBOL(debug_mem_baseAddr_show);
...
EXPORT_SYMBOL(phy_osal_memset);
EXPORT_SYMBOL(phy_osal_memcpy);
EXPORT_SYMBOL(phy_osal_alloc);
EXPORT_SYMBOL(phy_osal_free);
EXPORT_SYMBOL(phy_osal_time_usleep);
EXPORT_SYMBOL(phy_osal_time_mdelay);
EXPORT_SYMBOL(phy_osal_time_udelay);
EXPORT_SYMBOL(phy_osal_strcmp);
EXPORT_SYMBOL(phy_osal_sem_create);
EXPORT_SYMBOL(phy_osal_sem_take);
EXPORT_SYMBOL(phy_osal_sem_give);
EXPORT_SYMBOL(phy_osal_sem_destroy);
EXPORT_SYMBOL(phy_osal_thread_create);
...
EXPORT_SYMBOL(ioal_init_memRegion_set);
