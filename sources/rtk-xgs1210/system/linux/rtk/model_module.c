...
EXPORT_SYMBOL(rtk_longan_reg_num);
#if defined(CONFIG_SDK_DUMP_REG_WITH_NAME)
EXPORT_SYMBOL(rtk_longan_regName_list);
EXPORT_SYMBOL(rtk_longan_regField_name_list);
#endif
#endif
...
EXPORT_SYMBOL(rtk_mango_reg_num);
EXPORT_SYMBOL(rtk_mango_reg_list);
#if defined(CONFIG_SDK_DUMP_REG_WITH_NAME)
EXPORT_SYMBOL(rtk_mango_regName_list);
EXPORT_SYMBOL(rtk_mango_regField_name_list);
#endif
#endif
