 ...
 *
 */
#ifndef __NIC_RTL8251B_TYPEDEF_H__
#define __NIC_RTL8251B_TYPEDEF_H__
...
#define BOOLEAN         bool
#define BOOL            unsigned int//uint32_t
#define UINT32          unsigned int//uint32_t
#define UINT16         	unsigned short 
#define UINT8           char 
#define SLEEP_1MS		udelay(1000)
#define SLEEP_100MS 	mdelay(100)
//#define Sleep(_t)       udelay(_t*1000)//osal_time_udelay(_t*1000)
#define IN
#define OUT
...
typedef enum
{
    ...
    PHY_SERDES_MODE_5000BASEX,
    PHY_SERDES_MODE_USXGMII,
    PHY_SERDES_MODE_SFI_10GBASER,
    PHY_SERDES_MODE_5000BASER,
...
typedef enum
{
    PHY_SERDES_SPEED_USXGMII = 0,
    PHY_SERDES_SPEED_OTHER,
    PHY_SERDES_SPEED_SFI,
    PHY_SERDES_SPEED_5000BASEX,
    PHY_SERDES_SPEED_5000BASER,
    PHY_SERDES_SPEED_2500BASEX,
    PHY_SERDES_SPEED_HiSGMII,
    PHY_SERDES_SPEED_SGMII,
} PHY_SERDES_SPEED;
...
MmdPhyWrite(
    ...
    IN UINT16 addr,
    IN UINT16 data);
#endif /* __NIC_RTL8251B_TYPEDEF_H__ */
