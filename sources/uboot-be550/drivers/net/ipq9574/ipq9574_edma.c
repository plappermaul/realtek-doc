...
#ifdef CONFIG_TP_EXT_PHY_RTL8261B
extern int rtl8261_phy_init(struct phy_ops **ops, u32 phy_id);
#endif
...
#define RTL8251B_LAN_MDIO_NUM	0
#define RTL8251B_WAN_MDIO_NUM	3
#define RTL8251B_LAN_RST_GPIO	57
#define RTL8251B_WAN_RST_GPIO	36
...
{
	return rtl8251b_mdio_read(dev, (int)addr, data);
}

BOOLEAN
MmdPhyWrite( IN HANDLE hDevice, IN UINT16 dev, IN UINT16 addr, IN UINT16 data)
{
	return rtl8251b_mdio_write(dev, (int)addr, data);
}
...
#ifdef CONFIG_TP_EXT_PHY_RTL8251B
				case RTL8251B_PHY:
					rtl8251b_init(&ipq9574_edma_dev[i]->ops[phy_id], phy_addr);
					break;
#endif
#ifdef CONFIG_TP_EXT_PHY_RTL8261B
				case RTL8261B_PHY:
					printf("Loading RTL8261BE PHY_ID:%d... \n",phy_addr);
					rtl8261_phy_init(&ipq9574_edma_dev[i]->ops[phy_id], phy_addr);
					break;
#endif
				default:
